...
class build_ext(_build_ext.build_ext):
    def run(self):
        ...
        if build_java:
            ...
            ray_java_build_dir = os.path.abspath(
                os.path.join(root_dir, "build", "java"))
            ...
            jars_dir = os.path.join(current_dir, "ray", "jars")
            ...
            for jar, jar_path in jars.items():
                ...
                jar_files.append(os.path.join("./ray/jars", jar))
        ...
        files_to_include =\
            ray_files + pyarrow_files + pickle5_files + jar_files
