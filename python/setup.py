...
def pip_run(build_ext):
    ...
    if setup_spec.type == SetupType.RAY:
        ...
        internal_thirdparty_dir = os.path.join(ROOT_DIR, INTERNAL_THIRDPARTY_SUBDIR)
        setup_spec.files_to_include += walk_directory(internal_thirdparty_dir)
