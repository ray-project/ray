...
def test_cdi_spec_generate_is_vendor_agnostic():
    ...
    vendor module would call this the same way
    ray.experimental.sandbox._internal.cdi.get_spec does, just with its
    own kind/generate_fn. Never touches disk -- purely in-memory."""
