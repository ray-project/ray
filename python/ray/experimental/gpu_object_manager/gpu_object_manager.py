...
class GPUObjectManager:
    ...
    def trigger_out_of_band_tensor_transfer(
        ...
        If the sender and receiver actors are located on the same CUDA device, it uses CUDA IPC
        to share tensor storages directly between processes without round-tripping through the
        object store.
        """
        print("loc1")
