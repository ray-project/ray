...
from ray.util.collective.types import (
    Backend,
    HcclCommunicatorMetadata,
    HcclTransportMetadata,
)
...
class HcclTensorTransport(TensorTransportManager):
    ...
    def get_communicator_metadata(
        ...
        communicator_metadata = HcclCommunicatorMetadata(
    ...
    def recv_multiple_tensors(
        tensors,
        tensor_transport_metadata: HcclTransportMetadata,
        communicator_metadata: HcclCommunicatorMetadata,
    ):
        ...
        assert isinstance(
            tensor_transport_metadata, types.HcclTransportMetadata
        ), "metadata must be a HcclTransportMetadata object for HCCL transport"
        assert isinstance(
            communicator_metadata, types.HcclCommunicatorMetadata
        ), "metadata must be a HcclCommunicatorMetadata object for HCCL transport"
