...
class TensorFlow2Trainer(object):
    """Train a TensorFlow2 model using distributed TensorFlow2.

    Launches a set of actors which connect via distributed TensorFlow2 and
    ...
    def __init__(self,
        ...
        """Sets up the TensorFlow2 trainer.
        ...
        Args:
            ...
            backend (string): backend used by distributed TensorFlow2.
        """
