...
class TFRunner:
    ...
    def _fit_action(self, config):
        ...
        # callbacks = (callbacks or []) + [self.model.history]
        ...
        #     for (i, inps) in enumerate(self.train_dataset):
        #         if i > config["steps_per_epoch"]:
        #             break

        #         for c in callbacks:
        #             c.on_train_batch_begin(i, {
        #                 'batch': i,
        #                 'size': len(inps[0])
        #             })
        ...
        #                                                   args=(inps,))
        #         total_loss += self.strategy.reduce(tf.distribute.ReduceOp.SUM, per_replica_losses,
        #                                axis=None)

        #         # total_loss += train_step(inps)
        ...
        #             "batch": i,
        #         }
        #         progress_report.update(logs)
        #         for c in callbacks:
        #             c.on_train_batch_end(i, progress_report)
