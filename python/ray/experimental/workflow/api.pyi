...
@overload
def run(entry_workflow: Workflow[R], workflow_root_dir: Optional[str]) -> ObjectRef[R]: ...
@overload
def run(entry_workflow: Workflow[R], workflow_root_dir: Optional[str], workflow_id: Optional[str]) -> ObjectRef[R]: ...

@overload
def resume(workflow_id: str) -> ObjectRef: ...
@overload
def resume(workflow_id: str, workflow_root_dir: Optional[str]) -> ObjectRef: ...
