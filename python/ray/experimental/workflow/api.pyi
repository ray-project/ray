...
@overload
def run(entry_workflow: Workflow[R], storage_url: Optional[str]) -> ObjectRef[R]: ...
@overload
def run(entry_workflow: Workflow[R], storage_url: Optional[str], workflow_id: Optional[str]) -> ObjectRef[R]: ...

@overload
def resume(workflow_id: str) -> ObjectRef: ...
@overload
def resume(workflow_id: str, storage_url: Optional[str]) -> ObjectRef: ...
