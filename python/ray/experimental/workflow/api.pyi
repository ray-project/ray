...
@overload
def run(entry_workflow: Workflow[R], storage_or_url: Optional[Union[str, Storage]]) -> ObjectRef[R]: ...
@overload
def run(entry_workflow: Workflow[R], storage_or_url: Optional[Union[str, Storage]], workflow_id: Optional[str]) -> ObjectRef[R]: ...

@overload
def resume(workflow_id: str) -> ObjectRef: ...
@overload
def resume(workflow_id: str, storage_or_url: Optional[Union[str, Storage]]) -> ObjectRef: ...
