...
def placement_group(bundles: List[Dict[str, float]], strategy: str = "PACK",
    ...
    strategy: The strategy to create the placement group.
        ...
        PACK: Packs Bundles close together inside processes or nodes as tight as possible.
        SPREAD: Places Bundles across distinct nodes or processes as even as possible.
