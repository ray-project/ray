...
class RayDatasetHFIterable(datasets.iterable_dataset.ExamplesIterable):
    ...
    def __init__(self, dataset: TrainDatasetIterator) -> None:
...
def process_dataset_for_hf(dataset: TrainDatasetIterator) -> "IterableDataset":
...
def process_datasets(
    train_dataset: TrainDatasetIterator,
    eval_dataset: TrainDatasetIterator,
