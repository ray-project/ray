...
# Preemption handling: enable / disable, poll cadence, failure domain,
# and a test-only fake-drains file path.
PREEMPTION_HANDLING_ENABLED_ENV_VAR = "RAY_TRAIN_PREEMPTION_HANDLING_ENABLED"
PREEMPTION_POLL_INTERVAL_S_ENV_VAR = "RAY_TRAIN_PREEMPTION_POLL_INTERVAL_S"
PREEMPTION_FAILURE_DOMAIN_ENV_VAR = "RAY_TRAIN_PREEMPTION_FAILURE_DOMAIN"
PREEMPTION_FAKE_DRAINS_FILE_ENV_VAR = "RAY_TRAIN_PREEMPTION_FAKE_DRAINS_FILE"
PREEMPTION_FAKE_NODE_MAP_ENV_VAR = "RAY_TRAIN_PREEMPTION_FAKE_NODE_MAP"
PREEMPTION_DEFAULT_DEADLINE_S_ENV_VAR = "RAY_TRAIN_PREEMPTION_DEFAULT_DEADLINE_S"
...
ENV_VARS_TO_PROPAGATE = {
    ...
    PREEMPTION_FAILURE_DOMAIN_ENV_VAR,
    PREEMPTION_FAKE_DRAINS_FILE_ENV_VAR,
    PREEMPTION_FAKE_NODE_MAP_ENV_VAR,
    PREEMPTION_DEFAULT_DEADLINE_S_ENV_VAR,
}
