...
GET_ACTOR_TIMEOUT_S_ENV_VAR = "RAY_TRAIN_GET_ACTOR_TIMEOUT_S"
# `ray.util.state.api.get_actor` takes 10-50ms but we cannot pick lower than 2s
# due to a known core bug.
DEFAULT_GET_ACTOR_TIMEOUT_S: int = 2
...
CONTROLLERS_TO_POLL_PER_ITERATION_ENV_VAR = (
    "RAY_TRAIN_CONTROLLERS_TO_POLL_PER_ITERATION"
)
DEFAULT_CONTROLLERS_TO_POLL_PER_ITERATION: int = 5
