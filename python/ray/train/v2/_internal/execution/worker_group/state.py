...
class _WorkerGroupShutdownMixin:
    ...
    def _shutdown_placement_group(self, placement_group: PlacementGroup):
        remove_placement_group(placement_group)


@dataclass(frozen=True)
class WorkerGroupState(_WorkerGroupShutdownMixin):
...
class WorkerGroupStateBuilder(_WorkerGroupShutdownMixin):
    """Builder for WorkerGroupState.

    Example usage:
        ```python
        builder = WorkerGroupStateBuilder()
        builder.with_start_time(time_monotonic())
    ...
    def with_start_time(self, start_time: float) -> "WorkerGroupStateBuilder":
