...
from ray.train.v2._internal.execution.worker_group import WorkerGroupPollStatus, WorkerGroupResizeStatus
...
class WorkerGroupResizeFailurePolicy(abc.ABC):
    def __init__(self, failure_config: FailureConfig):
        self.failure_config = failure_config

    @abc.abstractmethod
    def make_decision(
        self, worker_group_resize_status: WorkerGroupResizeStatus
    ) -> FailureDecision:
        raise NotImplementedError
