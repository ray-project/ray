...
from ray.train.v2._internal.execution.local_running_utils import local_running_get_devices
import ray.train.torch
from ray._common.usage.usage_lib import TagKey, record_extra_usage_tag
from ray.train.torch.train_loop_utils import _WrappedDataLoader, get_devices as get_devices_v1
...
def get_devices() -> List[torch.device]:
    if ray.train.get_context().is_running_in_local_mode():
