...
def mock_s3_bucket_uri():
    ...
    Module-scoped to avoid the overhead of starting/stopping moto server
    for each test. The bucket name is unique per module, and individual
    tests write to unique experiment directories within the bucket.
    """
