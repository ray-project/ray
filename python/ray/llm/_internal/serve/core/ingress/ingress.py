    ...
    async def _get_response(
        ...
        *,
        ...
        if raw_request is not None:
            ...
            # Ensure the request_id generated by SetRequestIdMiddleware is forwarded
            # even when not present in the original headers.
            request_id = getattr(raw_request.state, "request_id", None)
            if request_id is not None:
                raw_request_headers["x-request-id"] = request_id
