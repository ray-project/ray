...
class SGLangSamplingParams(SamplingParams):
    """Sampling parameters specific to SGLang engine.
...
class SGLangGenerationRequest(GenerationRequest):
...
class SGLangEmbeddingRequest(GenerationRequest):
    model_config = ConfigDict(arbitrary_types_allowed=True)
