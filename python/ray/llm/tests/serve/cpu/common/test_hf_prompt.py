...
def test_prompt_format_on_string_message(prompt_format):
    messages = Prompt(prompt="This is a test message.")
    with pytest.raises(ValueError):
        prompt_format.generate_prompt(messages=messages)


def test_prompt_format_on_prompt_object(prompt_format):
    messages = Prompt(
        prompt=[
    ...
    formated_prompt = prompt_format.generate_prompt(messages=messages)
...
def test_prompt_format_on_list_of_messages(prompt_format):
    messages = [
        Message(role="system", content="You are a helpful assistant."),
        Message(
            role="user",
