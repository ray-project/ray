...
class TestGetDeploymentOptions:
    ...
    def test_get_serve_options_with_accelerator_type(self):
        ...
        assert env_vars["RAY_SERVE_USE_GRPC_BY_DEFAULT"] == "1"
    ...
    def test_serve_llm_replica_env_overrides_are_respected(self):
        llm_config = LLMConfig(
            model_loading_config=ModelLoadingConfig(model_id="test_model"),
            runtime_env={
                "env_vars": {
        ...
        assert env_vars["RAY_SERVE_USE_GRPC_BY_DEFAULT"] == "0"
