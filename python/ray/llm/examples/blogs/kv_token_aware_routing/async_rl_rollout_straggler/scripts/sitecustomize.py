"""Compatibility shims required by the pinned vLLM and Cutlass packages."""

from __future__ import annotations


def _install_vllm_compatibility() -> None:
    try:
        import cutlass.cute
    ...
    def select_tcpstore_port_with_zero_port(
    ...
    RayExecutorV2._select_tcpstore_port = staticmethod(
        select_tcpstore_port_with_zero_port
    )


_install_vllm_compatibility()
