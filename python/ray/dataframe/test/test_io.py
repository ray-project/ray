...
def test_from_parquet_small():
    ...
    ray_df = rpd.read_parquet(TEST_PARQUET_FILENAME)
...
def test_from_csv():
    ...
    ray_df = rpd.read_csv(TEST_CSV_FILENAME)
...
def test_from_json():
    ...
    ray_df = rpd.read_json(TEST_JSON_FILENAME)
...
def test_from_html():
    ...
    ray_df = rpd.read_html(TEST_HTML_FILENAME)
...
def test_from_excel():
    ...
    ray_df = rpd.read_excel(TEST_EXCEL_FILENAME)
...
def test_from_feather():
    ...
    ray_df = rpd.read_feather(TEST_FEATHER_FILENAME)
...
def test_from_hdf():
    ...
    ray_df = rpd.read_hdf(TEST_HDF_FILENAME, key='test')
...
def test_from_msgpack():
    ...
    ray_df = rpd.read_msgpack(TEST_MSGPACK_FILENAME)
...
def test_from_stata():
    ...
    ray_df = rpd.read_stata(TEST_STATA_FILENAME)
...
def test_from_pickle():
    ...
    ray_df = rpd.read_pickle(TEST_PICKLE_FILENAME)
...
def test_from_sql():
    ...
    ray_df = rpd.read_sql("select * from test", conn)
...
def test_from_sas():
    ...
    ray_df = rpd.read_sas(TEST_SAS_FILENAME)
...
def test_to_excel():
    ...
    ray_writer = pd.ExcelWriter(TEST_EXCEL_DF_FILENAME)
    pandas_writer = pd.ExcelWriter(TEST_EXCEL_PD_FILENAME)
...
def test_to_sql():
    ...
    TEST_SQL_PD_FILENAME = "test_pd.sql"

    ray_df.to_pickle(TEST_SQL_DF_FILENAME)
    pandas_df.to_pickle(TEST_SQL_PD_FILENAME)

    assert(test_files_eq(TEST_SQL_DF_FILENAME,
                         TEST_SQL_PD_FILENAME))

    teardown_test_file(TEST_SQL_DF_FILENAME)
    teardown_test_file(TEST_SQL_PD_FILENAME)
