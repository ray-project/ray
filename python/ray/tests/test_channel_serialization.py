...
def test_scalar_tensor(scalar_and_dtype):
    ...
    np_array, tensor_dtype, tensor_device_type = context.serialize_to_numpy(
        scalar_tensor
    )
    assert tensor_dtype == dtype
    deserialized_tensor = context.deserialize_from_numpy(
...
def test_non_scalar_tensor(tensor_shape_and_dtype):
    ...
    np_array, tensor_dtype, tensor_device_type = context.serialize_to_numpy(tensor)
    deserialized_tensor = context.deserialize_from_numpy(
