...
def test_pull_request_retry(ray_start_cluster_enabled):
...
def test_pull_bundles_admission_control(ray_start_cluster_enabled):
    cluster = ray_start_cluster_enabled
    object_size = int(6e6)
    num_objects = 10
    num_tasks = 10
...
def test_pull_bundles_pinning(ray_start_cluster_enabled):
    cluster = ray_start_cluster_enabled
