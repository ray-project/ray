...
def _get_ray_cr_config(min_replicas=0, max_replicas=0) -> Dict[str, Any]:
...
def _apply_ray_cr(min_replicas=0, max_replicas=0) -> None:
...
def testRoundRobinWithoutFault(self):
    ...
    _apply_ray_cr(min_replicas=5, max_replicas=5)
