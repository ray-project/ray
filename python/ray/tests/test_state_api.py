...
async def test_state_data_source_client_get_all_task_info():
    #  Setup
    ...
    assert filters_arg.HasField("actor_filter")
    assert ActorID(filters_arg.actor_filter.actor_id) == test_actor_id
    assert filters_arg.actor_filter.predicate == FilterPredicate.EQUAL

    assert filters_arg.HasField("job_filter")
    assert JobID(filters_arg.job_filter.job_id) == test_job_id
    assert filters_arg.job_filter.predicate == FilterPredicate.NOT_EQUAL

    assert filters_arg.HasField("name_filter")
    assert filters_arg.name_filter.name == test_task_name
    assert filters_arg.name_filter.predicate == FilterPredicate.EQUAL

    assert filters_arg.HasField("state_filter")
    assert filters_arg.state_filter.state == test_state
    assert filters_arg.state_filter.predicate == FilterPredicate.EQUAL
