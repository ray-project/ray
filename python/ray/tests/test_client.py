...
def test_get_list(ray_start_regular_shared):
    with ray_start_client_server() as ray:
        ...
        get_count = 0
        get_stub = ray._private.worker.server.GetObject
        ...
        ray._private.worker.server.GetObject = get
...
def test_basic_log_stream(ray_start_regular_shared):
    with ray_start_client_server() as ray:
        ...
        ray._private.worker.log_client.log = test_log
        ray._private.worker.log_client.set_logstream_level(logging.DEBUG)
...
def test_stdout_log_stream(ray_start_regular_shared):
    with ray_start_client_server() as ray:
        ...
        ray._private.worker.log_client.stdstream = test_log
