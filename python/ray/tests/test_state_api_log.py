...
async def test_logs_manager_list_logs(logs_manager):
    ...
    logs_client.get_all_registered_runtime_env_agent_ids = MagicMock()
    logs_client.get_all_registered_runtime_env_agent_ids.return_value = ["1", "2"]
    ...
    logs_client.get_all_registered_runtime_env_agent_ids.assert_called()
...
async def test_logs_manager_resolve_file(logs_manager):
    ...
    logs_client = logs_manager.data_source_client
    logs_client.get_all_registered_runtime_env_agent_ids = MagicMock()
    logs_client.get_all_registered_runtime_env_agent_ids.return_value = [node_id.hex()]
