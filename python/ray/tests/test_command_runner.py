...
from ray.autoscaler.command_runner import SSHCommandRunner, _with_environment_variables, DockerCommandRunner
...
def test_environment_variable_encoder_strings():
    env_vars={
        "var1":"quote between this \" and this",
        "var2":"123"
    }
...
def test_ssh_command_runner():
    ...
    expected = [
        ...
        "-i", "8265.pem", "-o", "StrictHostKeyChecking=no",
        ...
        "-o", "ControlPath=/tmp/ray_ssh_534b44a19b/06b2d4b91b/%C",
        "-o", "ControlPersist=10s",
        "-o", "ConnectTimeout=120s",
        "ray@1.2.3.4", "bash", "--login", "-c", "-i",
        """'true && source ~/.bashrc && export OMP_NUM_THREADS=1 PYTHONWARNINGS=ignore && export var1='"'"'quote between this " and this'"'"';export var2=123;echo helloo'"""
    ]
...
def test_docker_command_runner():
    ...
    cmd = """'true && source ~/.bashrc && export OMP_NUM_THREADS=1 PYTHONWARNINGS=ignore && docker exec -it  container /bin/bash -c '"'"'bash --login -c -i '"'"'"'"'"'"'"'"'true && source ~/.bashrc && export OMP_NUM_THREADS=1 PYTHONWARNINGS=ignore && export var1='"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'quote between this " and this'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"'"';export var2=123;echo hello'"'"'"'"'"'"'"'"''"'"' '"""
