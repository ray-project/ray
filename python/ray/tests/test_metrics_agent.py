...
_AUTOSCALER_METRICS = [
    "ray_autoscaler_config_validation_exceptions",
    "ray_autoscaler_node_launch_exceptions",
    "ray_autoscaler_pending_nodes",
    "ray_autoscaler_reset_exceptions",
    "ray_autoscaler_running_workers",
    "ray_autoscaler_started_nodes",
    "ray_autoscaler_stopped_nodes",
    "ray_autoscaler_update_loop_exceptions",
    "ray_autoscaler_worker_create_node_time",
    "ray_autoscaler_worker_update_time",
    "ray_autoscaler_updating_nodes",
    "ray_autoscaler_successful_updates",
    "ray_autoscaler_failed_updates",
    "ray_autoscaler_failed_create_nodes",
    "ray_autoscaler_recovering_nodes",
    "ray_autoscaler_successful_recoveries",
    "ray_autoscaler_failed_recoveries",
    "ray_autoscaler_drain_node_exceptions",
    "ray_autoscaler_update_time",
    "ray_autoscaler_cluster_resources",
    "ray_autoscaler_pending_resources",
]
