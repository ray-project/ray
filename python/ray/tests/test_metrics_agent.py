...
_METRICS = [
    ...
    "ray_object_manager_chunks_received_count",
    "ray_pull_manager_bytes_usage",
    "ray_pull_manager_requested_bundles",
    "ray_pull_manager_requests",
    "ray_pull_manager_active_bundles",
    "ray_pull_manager_retries_count",
    "ray_push_manager_in_flight_push_count",
    "ray_push_manager_chunks_count",
    "ray_scheduler_failed_worker_startup_count",
    "ray_scheduler_tasks_count",
    "ray_scheduler_pending_tasks_count",
    "ray_spill_manager_objects_count",
