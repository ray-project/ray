...
_METRICS = [
    ...
    "ray_local_object_manager_objects_count",
    "ray_local_object_manager_objects_bytes",
    "ray_local_object_manager_request_total",
    # "ray_local_object_manager_throughput_mb",
