...
def test_actor_working_dir_overrides_driver_working_dir(start_cluster):
    ...
    with tempfile.TemporaryDirectory() as driver_dir, tempfile.TemporaryDirectory() as actor_dir:
