...
def test_kv_basic(ray_start_regular, monkeypatch):
    ...
    time.sleep(2)
    # reset the counter
    ray._private._utils._CALLED_FREQ.clear()
    ...
    assert ray._private._utils._CALLED_FREQ["internal_kv_get"] == 4
    assert ray._private._utils._CALLED_FREQ["internal_kv_put"] == 5
    ...
    assert ray._private._utils._CALLED_FREQ["internal_kv_multi_get"] == 4
