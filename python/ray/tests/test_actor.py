...
def test_actor_deletion_with_gpus(shutdown_only):
    ray.init(
        num_cpus=1, num_gpus=1, object_store_memory=int(100 * 1024 * 1024))
...
def test_actors_and_tasks_with_gpus_version_two(shutdown_only):
    ...
    ray.init(
        num_cpus=10, num_gpus=10, object_store_memory=int(100 * 1024 * 1024))
...
def setup_queue_actor():
    ray.init(num_cpus=1, object_store_memory=int(100 * 1024 * 1024))
