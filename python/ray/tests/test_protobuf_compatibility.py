...
def test_protobuf_compatibility(shutdown_only):
    ...
    assert "4.21.1" == ray.get(load_ray_tune.options(runtime_env=protobuf_4_21_1).remote())
    assert "3.20.0" == ray.get(load_ray_tune.options(runtime_env=protobuf_3_20_0).remote())
