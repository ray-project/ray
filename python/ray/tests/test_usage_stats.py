...
def test_usage_lib_get_cluster_status_to_report(enable_v2, shutdown_only, reset_usage_stats):
    ray.init(num_cpus=3, num_gpus=1, object_store_memory=2**30, _system_config={"enable_autoscaler_v2": enable_v2})
