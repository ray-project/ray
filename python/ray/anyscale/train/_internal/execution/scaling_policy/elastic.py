...
class ElasticScalingPolicy(ScalingPolicy):
    ...
    def _get_resize_decision(self) -> ScalingDecision:
    ...
    def make_decision_for_running_worker_group(
        ...
        if (
            time_monotonic() - latest_consideration_time
    ...
    def on_controller_run_start(self):
        ...
        self.autoscaling_requester.request(
            bundles=(
                [self.scaling_config._resources_per_worker_not_none]
