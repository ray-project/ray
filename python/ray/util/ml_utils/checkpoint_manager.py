...
class _HeapCheckpointWrapper:
    def __init__(self, priority: Any, tracked_checkpoint: TrackedCheckpoint):
...
class CheckpointManager:
    ...
    def __init__(
        ...
        self._best_persisted_checkpoint: Optional[TrackedCheckpoint] = None
    ...
    def _replace_latest_persisted_checkpoint(
        self, persisted_checkpoint: TrackedCheckpoint
    ):
    ...
    def _get_checkpoint_score(
        self, checkpoint: TrackedCheckpoint
    ...
    def _delete_persisted_checkpoint(self, persisted_checkpoint: TrackedCheckpoint):
