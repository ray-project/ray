    ...
    Args:
        ...
        *args: Positional arguments broadcast to every task invocation.
        ...
        tpu_slice: An existing :class:`SlicePlacementGroup` or
            ...
            the slice is used directly and ``run_on_slice`` does **not**
            create, modify, or tear down any placement groups. When ``None``
            (default), a new slice is reserved internally and its head
            placement groups are released once the worker placement group
            becomes ready.
