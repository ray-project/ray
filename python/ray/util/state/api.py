...
def get_log(
    ...
    Args:
        ...
        task_id: Id of the task if getting logs generated by a task. If the task is an
            actor task from a concurrent actor (e.g. Actor has max_concurrency > 1), it's
            the logs return might contain logs from other tasks of the same actor.
