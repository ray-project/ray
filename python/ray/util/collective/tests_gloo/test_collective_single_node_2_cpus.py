...
def test_init_two_actors(ray_start_single_node_2_npus, group_name):
    world_size = 2
...
def test_init_multiple_groups(ray_start_single_node_2_npus):
    world_size = 2
    num_groups = 10
...
def test_get_rank(ray_start_single_node_2_npus):
    world_size = 2
...
def test_get_world_size(ray_start_single_node_2_npus):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_availability(ray_start_single_node_2_npus):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_is_group_initialized(ray_start_single_node_2_npus):
    world_size = 2
    actors, _ = get_actors_group(world_size)
    # check group is_init
...
def test_destroy_group(ray_start_single_node_2_npus):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_allreduce_different_name(ray_start_single_node_2_npus, group_name):
    world_size = 2
...
def test_allreduce_different_array_size(ray_start_single_node_2_npus,
                                        array_size):
    world_size = 2
    actors, _ = get_actors_group(world_size)
    ray.wait([
...
def test_allreduce_destroy(ray_start_single_node_2_npus,
                           backend="nccl",
                           group_name="default"):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_allreduce_multiple_group(ray_start_single_node_2_npus,
                                  backend="nccl",
                                  num_groups=5):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_allreduce_different_op(ray_start_single_node_2_npus):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_allreduce_different_dtype(ray_start_single_node_2_npus, dtype):
    world_size = 2
    actors, _ = get_actors_group(world_size)
...
def test_allreduce_torch_numpy(ray_start_single_node_2_npus):
    # import torch
    world_size = 2
    actors, _ = get_actors_group(world_size)
