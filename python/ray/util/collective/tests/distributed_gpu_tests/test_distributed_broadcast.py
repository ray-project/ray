...
def test_broadcast_different_name(
    ray_start_distributed_2_nodes_4_accs, group_name, src_rank
):
    world_size = 4
...
def test_broadcast_different_array_size(
    ray_start_distributed_2_nodes_4_accs, array_size, src_rank
):
    world_size = 4
...
def test_broadcast_torch_cupy(ray_start_distributed_2_nodes_4_accs, src_rank):
    import torch
...
def test_broadcast_invalid_rank(ray_start_distributed_2_nodes_4_accs, src_rank=3):
    world_size = 2
    actors, _ = create_collective_workers(world_size)
