...
def test_reducescatter_different_dtype(ray_start_distributed_2_nodes_4_accs, dtype):
    world_size = 4
    actors, _ = create_collective_workers(world_size)
...
def test_reducescatter_torch_cupy(ray_start_distributed_2_nodes_4_accs):
    world_size = 4
    shape = [10, 10]
    actors, _ = create_collective_workers(world_size)
