...
void reduce_wrapper(const std::shared_ptr<gloo::Context> &context,
  ...
  case glooDataType_t::glooInt8:
    reduce<int8_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooUint8:
    reduce<uint8_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooInt32:
    reduce<int32_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooUint32:
    reduce<uint32_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooInt64:
    reduce<int64_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooUint64:
    reduce<uint64_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooFloat16:
    reduce<gloo::float16>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooFloat32:
    reduce<float_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  case glooDataType_t::glooFloat64:
    reduce<double_t>(context, sendbuf, recvbuf, size, reduceop, root);
    break;
  default:
