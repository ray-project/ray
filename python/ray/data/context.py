...
DEFAULT_RAISE_ORIGINAL_EXCEPTION = env_bool("RAY_DATA_RAISE_ORIGINAL_EXCEPTION", False)
...
class DataContext:
    ...
    Args:
        ...
        raise_original_exception: Whether to raise the original exception encountered
            in user-defined functions instead of wrapping it in a `UserCodeException`.
    ...
    raise_original_exception: bool = DEFAULT_RAISE_ORIGINAL_EXCEPTION
