...
DEFAULT_DOWNSTREAM_CAPACITY_BACKPRESSURE_RATIO: Optional[float] = (
    env_float("RAY_DATA_DOWNSTREAM_CAPACITY_BACKPRESSURE_RATIO", 10.0)
    if os.environ.get("RAY_DATA_DOWNSTREAM_CAPACITY_BACKPRESSURE_RATIO")
    else None
)
