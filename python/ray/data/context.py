...
class DataContext:
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        if (
            ...
            warnings.warn(
                "`retried_io_errors` using substring matching will be deprecated in a future version. Please ensure that you use valid regex patterns for `retried_io_errors`",
                DeprecationWarning,
            )
