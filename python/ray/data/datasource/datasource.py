...
class Datasource:
    ...
    Datasource instances must be serializable, since :meth:`~ray.data.Datasource.create_reader` and
...
class Reader:
    ...
    For example, it is useful for :class:`~ray.data.Dataset` s to know the
