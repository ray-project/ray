...
class TestFormatHintSystem:
    ...
    def test_all_file_based_formats(self):
        ...
        file_formats = [
            "parquet", "parquet_bulk", "csv", "json", "text",
            "images", "audio", "video", "numpy", "avro",
            "tfrecords", "html", "webdataset", "lance", "binary"
        ]
...
class TestSourceDetection:
    ...
    def test_hdfs_detection(self):
        ...
        sources = SourceDetector.detect_from_paths(["hdfs://namenode:9000/data.parquet"])
...
class TestReaderRegistry:
    ...
    def test_all_27_readers_accessible(self):
        ...
        all_formats = [
            ...
            "tfrecords", "html", "webdataset", "lance", "binary",
            # Lakehouse (4)
            "delta", "delta_sharing", "hudi", "iceberg",
            # Database (6)
            "sql", "bigquery", "mongo", "clickhouse", "snowflake",
            # Databricks (2)
