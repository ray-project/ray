...
class TestActorPool:
    ...
    def test_pending_actor_killed(self, ray_start_regular_shared):
    ...
    def test_idle_actor_killed(self, ray_start_regular_shared):
    ...
    def test_active_actor_not_killed(self, ray_start_regular_shared):
    ...
    def test_future_idle_actors_killed(self, ray_start_regular_shared):
