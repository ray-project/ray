...
class Dataset(Generic[T]):
    ...
    def repeat(self, times: Optional[int] = None) -> "DatasetPipeline[T]":
        ...
        class Iterator:
            def __init__(self, blocks, created_by_pipeline):
                self._blocks = blocks
                self._i = 0
                self._created_by_pipeline = created_by_pipeline
        ...
        class Iterable:
            ...
            def __iter__(self):
                return Iterator(self._blocks, self._created_by_pipeline)

        pipe = DatasetPipeline(
            Iterable(blocks, self._created_by_pipeline),
            False,
    ...
    def window(
        ...
        *,
        ...
        class Iterator:
            def __init__(self, splits, epoch, created_by_pipeline):
        ...
        class Iterable:
            def __init__(self, blocks, epoch, created_by_pipeline):
                if bytes_per_window:
    ...
    def _split(
        ...
        for b, m in it:
            ...
            if count >= index:
                ...
                if self._lazy and self._created_by_pipeline:
