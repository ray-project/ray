...
c18da597e0bb1c1aecc97c77a73fed1849057fa4/torch/nn/modules/utils.py
    ...
    Returns:
        dict: A new state dict with the specified prefix removed from all keys
        that started with the prefix. Keys that don't start with the prefix
        remain unchanged. If no keys start with the prefix, returns a copy
        of the original state dict.
    """
    copied = False
