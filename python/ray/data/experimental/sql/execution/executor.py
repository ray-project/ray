...
from ray.data.experimental.sql.execution.analyzers import (
    AggregateAnalyzer,
    ProjectionAnalyzer,
)
from ray.data.experimental.sql.execution.handlers import (
    FilterHandler,
    JoinHandler,
    LimitHandler,
    OrderHandler,
...
class QueryExecutor:
    ...
    def _execute_simple_query(self, ast: exp.Select) -> Dataset:
        ...
        # Note: Avoid expensive empty checks that materialize dataset
        # Let pipeline execute naturally - empty datasets are handled correctly by Ray Data
    ...
    def _execute_group_by_query(
        ...
        # Note: Skip empty check to avoid materializing dataset
        # Ray Data handles empty datasets correctly in groupby operations
    ...
    def _execute_aggregate_query(
        ...
        # Note: Skip empty check to avoid materializing dataset
        # Ray Data aggregate operations handle empty datasets correctly
