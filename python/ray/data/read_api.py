...
def read_clickhouse(
    *,
    ...
    Examples:
        ...
        ...     filters="age > 18 AND status = 'active'",
    ...
    Args:
        ...
        filters: Optional SQL filters clause string that will be used in the WHERE statement
            (e.g., "label = 2 AND text IS NOT NULL"). These filters must be valid for use in
