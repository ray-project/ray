...
class Concatenator(SerializablePreprocessorBase):
    ...
    :class:`~ray.data._internal.blocks.tensor_extensions.pandas.TensorDtype`. Only columns
    ...
    :class:`~ray.data._internal.blocks.tensor_extensions.pandas.TensorArrayElement` objects of
    ...
    Examples:
        ...
        :py:class:`~ray.data._internal.blocks.tensor_extensions.pandas.TensorDtype`.
