...
class LazyBlockList(BlockList):
    ...
    def __init__(
        self,
        tasks: List[ReadTask],
        read_operator_name: Optional[str] = None,
        ...
        *,
        ...
        Args:
            ...
            read_operator_name: An optional name for the read operator, derived from the
        ...
        """
        self._tasks = tasks
        self._read_operator_name = read_operator_name
    ...
    def copy(self) -> "LazyBlockList":
        return LazyBlockList(
            self._tasks.copy(),
            read_operator_name=self._read_operator_name,
