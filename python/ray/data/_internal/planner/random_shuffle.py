...
def generate_random_shuffle_fn(
    ...
    def fn(
        ...
        _ray_remote_args = ray_remote_args
        if map_transform_fn:
            ...
            _ray_remote_args = ctx.upstream_map_ray_remote_args
        ...
        return scheduler.execute(
            ...
            map_ray_remote_args=_ray_remote_args,
            reduce_ray_remote_args=_ray_remote_args,
        )
