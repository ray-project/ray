...
from ray.data._internal.batcher import BlockIteratorInterface
...
def blocks_to_batches(
    ...
    block_iterator: BlockIteratorInterface,
) -> Iterator[Batch]:
    ...
    Args:
        ...
        block_iterator: A block iterator, which is a subclass of `BlockIteratorInterface`.

    Returns:
        An iterator over batches.
    """

    yield from block_iterator.iter_batches(block_iter)
