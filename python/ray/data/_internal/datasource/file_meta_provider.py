...
from ray.data._internal.datasource.partitioning import Partitioning, PathPartitionFilter
from ray.data._internal.datasource.path_util import _has_file_extension
...
class BaseFileMetadataProvider(FileMetadataProvider):
    ...
    def expand_paths(
        ...
        Args:
            ...
            partitioning: Optional partitioning scheme for path-based partitions.
...
def _expand_paths(
    ...
    from ray.data._internal.datasource.path_util import _is_http_url, _unwrap_protocol
...
def _expand_directory(
    ...
    Args:
        ...
        exclude_prefixes: The file relative path prefixes that should be
            ...
            "." and "_".
        ignore_missing_path: If True, allows the directory to be missing.
