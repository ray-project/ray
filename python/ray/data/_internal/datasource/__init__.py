...
# HuggingFaceDatasource is lazy-imported via __getattr__ to avoid loading
# transformers/datasets on every "import ray.data" (see design in ray.data.datasource/__init__.py).
