...
from ray.data._internal.datasource.filename_provider import (
    FilenameProvider,
        ...
        *,
        ...
        Args:
            ...
            file_format: The file extension. If specified, files are written with this
                extension.
            mode: SaveMode for handling existing output paths (e.g. append, overwrite).
        """
...
class BlockBasedFileDatasink(_FileDatasink):
    ...
    def __init__(
        ...
        **file_datasink_kwargs: Any,
        ...
        Args:
            path: The folder to write files to.
            min_rows_per_file: Optional target rows per output file.
            **file_datasink_kwargs: Forwarded to the base file datasink (e.g.
                filesystem, filename_provider, file_format, mode).
        """
