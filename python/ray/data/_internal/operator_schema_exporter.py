...
class OperatorSchema:
    """Represents an Ray Data operator schema
...
def get_operator_schema_exporter() -> "OperatorSchemaExporter":
...
class OperatorSchemaExporter(ABC):
    ...
    def create_if_enabled(cls) -> Optional["OperatorSchemaExporter"]:
        """Create an schema exporter instance if the export functionality is enabled.

        Returns:
            An schema exporter instance if enabled, none otherwise.
        """
        pass
