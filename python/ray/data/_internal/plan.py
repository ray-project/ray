    ...
    def fuse(self, prev: Stage):
        ...
        def block_fn(
            ...
            **fn_kwargs,
            ...
            blocks = block_fn1(
                blocks, ctx, metrics_collector, *prev_fn_args, **prev_fn_kwargs
            )
            return block_fn2(
                blocks, ctx, metrics_collector, *self_fn_args, **self_fn_kwargs
            )
    ...
    def fuse(self, prev: Stage):
        ...
        if self.block_udf is None:
            ...
            def block_udf(
                ...
                yield from self_block_udf(blocks, ctx, metrics_collector)
...
def _adapt_for_multiple_blocks(
    ...
    def wrapper(
        ...
        **kwargs,
        ...
        for block in blocks:
            yield from fn(block, ctx, metrics_collector, *args, **kwargs)
