...
class _StatsActor:
    ...
    def __init__(self, max_stats=1000):
        ...
        self.num_task_outputs_generated = Gauge(
            "data_num_task_outputs_generated",
            description="Number of output blocks generated by tasks.",
            tag_keys=op_tags_keys,
        )
        self.bytes_task_outputs_generated = Gauge(
            "data_bytes_task_outputs_generated",
            description="Total size in bytes of output blocks generated by tasks.",
            tag_keys=op_tags_keys,
        )
        ...
        self.num_outputs_taken = Gauge(
            "data_num_outputs_taken",
            description=(
                "Number of output blocks that are already taken "
                "by downstream operators."
            ),
            tag_keys=op_tags_keys,
        )
        self.bytes_outputs_taken = Gauge(
            "data_bytes_outputs_taken",
            description=(
                "Size in bytes of output blocks that are already taken "
                "by downstream operators."
            ),
            tag_keys=op_tags_keys,
        )
        self.num_outputs_of_finished_tasks = Gauge(
            "data_num_outputs_of_finished_tasks",
            description=(
                "Number of generated output blocks that are from " "finished tasks."
            ),
            tag_keys=op_tags_keys,
        )
        self.bytes_outputs_of_finished_tasks = Gauge(
            "data_bytes_outputs_of_finished_tasks",
            description=(
                "Size in bytes of generated output blocks that are "
                "from finished tasks."
            ),
            tag_keys=op_tags_keys,
        )
    ...
    def update_execution_metrics(
        ...
        for stats, operator_tag in zip(op_metrics, operator_tags):
            ...
            self.num_task_outputs_generated.set(
                stats.get("num_task_outputs_generated", 0),
                tags,
            )
            self.bytes_task_outputs_generated.set(
                stats.get("bytes_task_outputs_generated", 0),
                tags,
            )
            self.rows_task_outputs_generated.set(
                stats.get("rows_task_outputs_generated", 0),
                tags,
            )
            self.num_outputs_taken.set(
                stats.get("num_outputs_taken", 0),
                tags,
            )
            self.bytes_outputs_taken.set(
                stats.get("bytes_outputs_taken", 0),
                tags,
            )
            self.num_outputs_of_finished_tasks.set(
                stats.get("num_outputs_of_finished_tasks", 0),
                tags,
            )
            self.bytes_outputs_of_finished_tasks.set(
                stats.get("bytes_outputs_of_finished_tasks", 0),
                tags,
            )
    ...
    def clear_execution_metrics(self, dataset_tag: str, operator_tags: List[str]):
        for operator_tag in operator_tags:
            ...
            self.num_task_outputs_generated.set(0, tags)
            self.bytes_task_outputs_generated.set(0, tags)
            self.rows_task_outputs_generated.set(0, tags)
            self.num_outputs_taken.set(0, tags)
            self.bytes_outputs_taken.set(0, tags)
