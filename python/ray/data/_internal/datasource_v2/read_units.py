"""Read units: the pieces of an input split a reader scans on their own.

Today a read unit is a Parquet row group, or a whole file when the manifest
carries no row-group breakdown. The reader reports each batch's unit through
:class:`~ray.data._internal.datasource_v2.readers.synthesized_columns.BatchOrigin`,
