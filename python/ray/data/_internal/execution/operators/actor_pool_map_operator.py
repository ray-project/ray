...
class ActorPoolMapOperator(MapOperator):
    ...
    def __init__(
        ...
        self._autoscaling_policy = AutoscalingPolicy(autoscaling_config)
    ...
    def progress_str(self) -> str:
        return (
            f"{self._actor_pool.num_total_actors()}/"
            f"{self._autoscaling_policy.max_workers} actors"
        )
...
class AutoscalingPolicy:
    ...
    def should_scale_up(self, num_total_workers: int, num_running_workers: int) -> bool:
        ...
        return (
            ...
            # pool to requesting 120% of the cluster's available resources.
