...
class _ActorPool(AutoscalingActorPool):
    ...
    def __init__(
        ...
        *,
        ...
        self._actor_resource_usage: Dict[ray.actor.ActorHandle, ExecutionResources] = {}
        self._actor_is_pending: Dict[ray.actor.ActorHandle, bool] = {}
    ...
    def _set_actor_is_pending(
        self, actor: ray.actor.ActorHandle, is_pending: bool
    ) -> None:
    ...
    def _remove_actor_usage(self, actor: ray.actor.ActorHandle) -> None:
