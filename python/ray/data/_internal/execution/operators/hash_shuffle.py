...
class HashShufflingOperatorBase(PhysicalOperator, HashShuffleProgressBarMixin):
    ...
    def __init__(
        ...
        *,
        ...
        print(f"estimated_input_blocks: {estimated_input_blocks}")
        print(f"num_partitions: {num_partitions}")
        print(
            f"data_context.default_hash_shuffle_parallelism: {data_context.default_hash_shuffle_parallelism}"
        )
    ...
    def _get_aggregator_num_cpus(
        ...
        #
        print("--------------------------------")
        print(f"total_available_cluster_resources: {total_available_cluster_resources}")
        print(
            f"total_available_cluster_resources.cpu: {total_available_cluster_resources.cpu}"
        )
        print(f"num_aggregators: {num_aggregators}")
        print(
            f"estimated_aggregator_memory_required: {estimated_aggregator_memory_required}"
        )
