...
class HashShufflingOperatorBase(PhysicalOperator, HashShuffleProgressBarMixin):
    ...
    def __init__(
        ...
        *,
        ...
        #   - Estimated target number of blocks generated by the input op
        #   - Default configured hash-shuffle parallelism (200)
        target_num_partitions: int = (
            num_partitions or
            input_ops[0]._logical_operators[0].estimated_num_outputs() or
            data_context.default_hash_shuffle_parallelism
        )
