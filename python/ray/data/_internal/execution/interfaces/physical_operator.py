    ...
    def on_data_ready(self, max_bytes_to_read: Optional[int]) -> int:
        ...
        while max_bytes_to_read is None or bytes_read < max_bytes_to_read:
            try:
                ...
                self._task_done_callback(None, None)
                break
            ...
            try:
                ...
                try:
                    ...
                    self._task_done_callback(ex, None)
                    raise ex from None
...
class PhysicalOperator(Operator):
    ...
    def __init__(
        ...
        self._metrics = OpRuntimeMetrics.create(self)
    ...
    def notify_in_task_submission_backpressure(self, in_backpressure: bool, reason: str) -> None:
        ...
        if (
            ...
            self._metrics.on_toggle_task_submission_backpressure(
    ...
    def notify_in_task_output_backpressure(
        ...
        if (
            ...
            self._metrics.on_toggle_task_output_backpressure(in_backpressure, reason)
            self._in_task_output_backpressure = in_backpressure
