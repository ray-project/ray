...
This is the engine behind the threaded scheduling mode
(``ThreadedMetadataFetcher``). The synchronous (master-identical) mode uses
``InlineMetadataFetcher`` instead and never constructs a prefetcher. See
``metadata_fetcher.py``.
"""
