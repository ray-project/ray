...
class ResourceManager:
    ...
    def block_ref_counter(self) -> BlockRefCounter:
        """Return the block reference counter for this executor."""
        return self._block_ref_counter

    def _estimate_object_store_memory_usage(self, op: "PhysicalOperator") -> int:
        ...
        # Blocks being generated by running tasks but not yet yielded.
    ...
    def update_usages(self):
        ...
        for op, _ in reversed(self._topology.items()):
            ...
            used_object_store = self._estimate_object_store_memory_usage(op)
