        ...
        *,
        ...
        Args:
            ...
            shuffle: Whether to randomly shuffle the data using a local in-memory
                ...
                This is a light-weight alternative to the global
                `.random_shuffle_each_window()` operation; this shuffle will be less
                random but will be faster and less resource-intensive.
