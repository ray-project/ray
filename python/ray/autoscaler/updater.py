...
class NodeUpdater(object):
    ...
    def run(self):
        ...
        self.log.info("NodeUpdater: Applied config {} to node {}".format(
    ...
    def do_update(self):
        ...
        while time.time() < deadline and \
            ...
            self.log.info("NodeUpdater: Waiting for IP of {}...".format(
                self.node_id))
            self.ssh_ip = self.get_node_ip()
        ...
        for remote_path, local_path in self.file_mounts.items():
            self.log.info("NodeUpdater: Syncing {} to {}...".format(
