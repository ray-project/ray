...
from ray.autoscaler.v2.sdk import _autoscaler_state_service_stub, request_cluster_resources
...
def assert_cluster_resource_constraints(reply: GetClusterResourceStateReply, expected: List[dict]):
    """
    ...
    min_bundles = sorted(min_bundles, key=lambda bundle: "".join(bundle.resources_bundle.keys()))
