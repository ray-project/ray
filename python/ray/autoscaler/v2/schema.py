...
class IPPRStatus:
    ...
    Attributes:
        ...
        resizing_status: Lower-cased status from pod conditions for IPPR, e.g.
            "inprogress", "deferred", "infeasible", "error"; None indicates no
            active resize and is treated as finished.
        resizing_message: Message from the pod condition describing the resize
    ...
    resizing_status: Optional[str] = None
    resizing_message: Optional[str] = None
    ...
    def queue_resize_request(
        ...
        if updated:
            ...
            self.resizing_status = "new"
            self.resizing_message = None
        return updated
    ...
    def has_resize_request_to_send(self) -> bool:
        ...
        """
        return self.raylet_id and self.resizing_status == "new"
    ...
    def is_pod_resized_finished(self) -> bool:
        ...
        We treat ``resizing_status is None`` as finished. After K8s completes a
        resize and the Raylet has been synchronized, the provider clears
        ``resizing_at`` and leaves ``resizing_status`` as None.
        """
        return self.resizing_status is None
    ...
    def need_sync_with_raylet(self) -> bool:
        ...
        - Kubernetes has finished applying the resize (``resizing_status`` is None).
        ...
        return (
            ...
            and self.resizing_status is None
    ...
    def can_resize_up(self) -> bool:
        ...
        return (
            ...
            and self.is_pod_resized_finished()
            and (
