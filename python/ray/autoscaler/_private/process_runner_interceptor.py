...
class ProcessRunnerInterceptor:
    ...
    An instance of the ProcessRunnerInterceptor class conforms the the subset of the
    `subprocess` module necessary to act as a process runner. It implemented by
    overriding the default stdout/err streams for the process runner.
