...
class LoadMetrics:
    ...
    def update(self,
        ...
        dynamic_resources_copy = self.dynamic_resources_by_ip[ip].copy()
        for resource in self.static_resources_by_ip[ip].items():
            dynamic_resources_copy.setdefault(resource, 0.0)
        self.dynamic_resources_by_ip[ip] = dynamic_resources_copy
