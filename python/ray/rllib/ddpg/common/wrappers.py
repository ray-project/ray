...
class EpisodicLifeEnv(gym.Wrapper):
    def __init__(self, env=None):
        ...
        over. Done by DeepMind for the DDPG and co. since it helps value
        estimation.
        """
...
class LazyFrames(object):
    def __init__(self, frames):
        ...
        be huge for DDPG's 1M frames replay buffers.
...
def wrap_ddpg(registry, env, options):
    """Apply a common set of wrappers for DDPG."""
