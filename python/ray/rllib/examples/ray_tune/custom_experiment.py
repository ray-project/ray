...
https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/evaluation/custom_evaluation.py).  # noqa
...
https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithm/custom_training_step_on_and_off_policy_combined.py  # noqa
