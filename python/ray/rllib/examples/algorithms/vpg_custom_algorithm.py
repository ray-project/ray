...
https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/classes/vpg.py

The Learner class the algorithm uses by default (if the user doesn't specify a custom
Learner):
https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/learners/classes/vpg_torch_learner.py  # noqa

And the RLModule class the algorithm uses by default (if the user doesn't specify a
custom RLModule):
https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/classes/vpg_torch_rlm.py  # noqa
