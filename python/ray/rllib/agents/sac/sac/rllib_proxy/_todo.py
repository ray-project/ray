"""
Ray imports and classes in this file are present in rllib v 0.6.6 and rllib v 0.8.1.
I haven't verified yet if the functionality / interface of these classes have changed
though.
"""
