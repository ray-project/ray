...
DEFAULT_CONFIG = with_common_config({
    # === Twin Delayed SAC (TD3) and Soft Actor-Critic (SAC) tricks ===
    ...
    # scaled by exploration_fraction. Original SAC and TD3 papers do not
    ...
    # valid values: "ou" (time-correlated, like original SAC paper),
