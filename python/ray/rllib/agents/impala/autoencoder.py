...
class AutoEncoder(Model):
    def _build_layers_v2(self, input_dict, num_outputs, options):
        ...
        self.encoder= slim.conv2d(inputs, encoder_params[0], encoder_params[1], encoder_params[2], activation_fn = tf.nn.relu)
        self.decoder = slim.conv2d(self.encoder, encoder_params[0], encoder_params[1], encoder_params[2], activation_fn = None)
