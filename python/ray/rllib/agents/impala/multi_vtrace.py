...
def from_logits(behaviour_policy, target_policy, actions,
...
def get_rhos(behaviour_action_log_probs, target_action_log_probs):
    """With the selected policy values (logits or probs) subclasses compute the rhos for calculating the vtrace."""
    log_rhos = [t - b for t,
