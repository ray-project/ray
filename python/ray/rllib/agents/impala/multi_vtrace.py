...
VTraceFromLogitsReturns = collections.namedtuple(
    ...
    ['vs', 'pg_advantages', 'rhos',
     'behaviour_action_policy', 'target_action_policy'])

VTraceReturns = collections.namedtuple('VTraceReturns', 'vs pg_advantages')


def get_vtrace(behaviour_policy, target_policy, actions,
    ...
    with tf.name_scope(name, values=[behaviour_policy, target_policy, actions,
        ...
        vtrace_returns = _from_importance_weights(rhos=rhos, discounts=discounts, rewards=rewards,
...
def select_policy_values_using_actions(policy_logits, actions):
    """
    See also:
        >>> AbstractVtrace.select_policy_values_using_actions
...
def _from_importance_weights(rhos, discounts, rewards, values, bootstrap_value,
                             clip_rho_threshold=1.0, clip_pg_rho_threshold=1.0,
    ...
    with tf.name_scope(name, values=[rhos, discounts, rewards, values, bootstrap_value]):
        if clip_rho_threshold is not None:
        ...
        tf.summary.scalar('num_of_clipped_rhos',
