...
def get_cloud_from_metadata_requests() -> str:
    ...
    # Check Azure FIRST before AWS since they share the same IP address (169.254.169.254)
    # and AWS's generic endpoint might return non-404 errors from Azure IMDS
    AZURE_METADATA_URL = (
