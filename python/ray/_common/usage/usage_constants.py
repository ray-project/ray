...
# Keys for cluster lifecycle tracking in GCS internal KV
CLUSTER_FIRST_SEEN_TIMESTAMP_KEY = b"CLUSTER_FIRST_SEEN_TIMESTAMP"
CLUSTER_RESTART_COUNT_KEY = b"CLUSTER_RESTART_COUNT"
