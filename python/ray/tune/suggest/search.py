...
class VariantAlgorithm(SearchAlgorithm):
    ...
    Attributes:
        PASS (str): Status string for `try_suggest` if VariantAlgorithm
    ...
    def try_suggest(self):
        ...
        Returns:
            dict|PASS: Partial configuration for a trial, if possible.
                Else, will return VariantAlgorithm.PASS.
        ...
        Example:
            ...
            >>> parameters_2 == VariantAlgorithm.PASS
            >>> suggester.on_trial_complete(trial_id, result)
            >>> parameters_2, trial_id2 = suggester.try_suggest()
            >>> not(parameters_2 == VariantAlgorithm.PASS)
        """
        return {}, None
