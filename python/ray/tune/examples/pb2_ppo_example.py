...
if __name__ == "__main__":
    ...
    parser.add_argument("--net", type=str, default="32_32") # may be important to use a larger network for bigger tasks
    parser.add_argument("--filename", type=str, default="")
    parser.add_argument("--method", type=str, default="pb2") # ['pbt', 'pb2']
    parser.add_argument("--save_csv", type=bool, default=False) # ['pbt', 'pb2']
