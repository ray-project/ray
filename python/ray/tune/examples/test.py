    ...
    run_experiments({
        "hyperband_test": {
            ...
            "config": {
                ...
                "a" * 50: lambda spec: np.random.randint(10, 60123412),
                "b" * 50: lambda spec: np.random.uniform(0.1, 1.0),
                "c" * 50: lambda spec: np.random.randint(10, 60123412),
                "d" * 50: lambda spec: np.random.uniform(0.1, 1.0)
