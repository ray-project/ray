...
class RayTrialExecutor(TrialExecutor):
    ...
    def __init__(self,
        ...
        self._last_nontrivial_wait = timeit.default_timer()
    ...
    def get_next_available_trial(self):
        ...
        wait_time = timeit.default_timer() - start
        if wait_time > NONTRIVIAL_WAIT_TIME_THRESHOLD_S:
            self._last_nontrivial_wait = timeit.default_timer()
        if timeit.default_timer() - self._last_nontrivial_wait > BOTTLENECK_WARN_PERIOD_S:
            logger.warning(
    ...
    def _update_avail_resources(self, num_retries=5):
        ...
        self._avail_resources = Resources(
            ...
            custom_resources=custom_resources)
        self._last_resource_refresh = timeit.default_timer()
    ...
    def has_resources(self, resources):
        ...
        """
        if timeit.default_timer() - self._last_resource_refresh > self._refresh_period:
            self._update_avail_resources()
