...
def test_get_time_str():
    ...
    assert _get_time_str(base, base) == ("2023-03-27 00:00:00", "00.00s")
    assert _get_time_str(base, base + 15) == ("2023-03-27 00:00:15", "15.00s")
    assert _get_time_str(base, base + 60) == ("2023-03-27 00:01:00", "1min, 00.00s")
    assert _get_time_str(base, base + 65) == ("2023-03-27 00:01:05", "1min, 05.00s")
