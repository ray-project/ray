...
from backend.server.telemetry import dict_propagator
from backend.server.telemetry.util import use_context
...
def _hydrate_span_args(class_: _nameable, method: _nameable) -> Attributes:
    ...
    # actor_id = (
    #     runtime_context.get("actor_id").hex()
...
def _span_producer_name(class_: _nameable, method: _nameable) -> str:
    args = _hydrate_span_args(class_, method)
...
def _span_consumer_name(class_: _nameable, method: _nameable) -> str:
    args = _hydrate_span_args(class_, method)
    assert args is not None
    name = args["ray.function"]
