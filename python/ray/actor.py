    ...
    def _remote(self,
        ...
        if worker.mode == ray.LOCAL_MODE:
            ...
            [actor_cursor] = worker.submit_task(
                ...
                max_actor_reconstructions=meta.max_reconstructions,
                num_return_vals=1,
                resources=resources,
        ...
        actor_handle = ActorHandle(
            actor_id, meta.modified_class.__module__, meta.class_name,
            actor_cursor, meta.actor_method_names, meta.method_decorators,
            meta.method_signatures, meta.actor_method_num_return_vals,
