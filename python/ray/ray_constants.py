...
# If a user does not specify a port to start the primary Redis on,
# we attempt to start the service running at this port by default.
DEFAULT_REDIS_PORT = 67670
