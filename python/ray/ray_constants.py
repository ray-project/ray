...
CPU_INSTRUCTION_SETS_DEFAULT_REQUIRED_LIST = ""

# Environment variable for importing the user's required instruction set
CPU_INSTRUCTION_SETS_REQUIRED_ENV_VAR = "CPU_INSTRUCTION_SET"
