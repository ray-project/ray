...
WORKER_PROCESS_TYPE_SPILL_WORKER_PREFIX = "ray::SpillWorker"
WORKER_PROCESS_TYPE_RESTORE_WORKER_PREFIX = "ray::RestoreWorker"
WORKER_PROCESS_TYPE_SPILL_WORKER_IDLE = (
    f"{WORKER_PROCESS_TYPE_SPILL_WORKER_PREFIX}::IDLE")
WORKER_PROCESS_TYPE_RESTORE_WORKER_IDLE = (
    f"{WORKER_PROCESS_TYPE_RESTORE_WORKER_PREFIX}::IDLE")
WORKER_PROCESS_TYPE_SPILL_WORKER = (
    f"{WORKER_PROCESS_TYPE_SPILL_WORKER_PREFIX}::spill")
WORKER_PROCESS_TYPE_RESTORE_WORKER = (
    f"{WORKER_PROCESS_TYPE_RESTORE_WORKER_PREFIX}::restore")
