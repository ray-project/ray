...
WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_NAME = "DumpCheckpointWorker"
WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_NAME = "LoadCheckpointWorker"
...
WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_IDLE = (
    f"ray::IDLE_{WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_NAME}"
)
WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_IDLE = (
    f"ray::IDLE_{WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_NAME}"
)
...
WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER = (
    f"ray::DUMP_CHECKPOINT_{WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_NAME}"
)
WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER = (
    f"ray::LOAD_CHECKPOINT_{WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_NAME}"
)
...
WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_DELETE = (
    f"ray::DELETE_{WORKER_PROCESS_TYPE_DUMP_CHECKPOINT_WORKER_NAME}"
)
WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_DELETE = (
    f"ray::DELETE_{WORKER_PROCESS_TYPE_LOAD_CHECKPOINT_WORKER_NAME}"
)
