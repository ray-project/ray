...
def test_cluster_crash_before_checkpoint(workflow_start_regular_shared_serve):
    """If the cluster crashed before the event was checkpointed,
    after the cluster restarted and the workflow resumed,
    the new event message is processed by the workflow.
    """
