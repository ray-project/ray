        ...
        while len(unready_ids) > 0:
            ...
            for i in range(0, len(object_ids_to_fetch),
                ...
                if not self.use_raylet:
                    ...
                    # fetch. We divide the fetch into smaller fetches so as to
                    # not block the manager for a prolonged period of time in a
                    # single call. This is only necessary for legacy ray since
