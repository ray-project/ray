...
class Driver(object):
    ...
    def connect(self, mode, use_raylet):
        """This function partially setup the worker.
        It will not initialize components.

        Args:
            mode: Worker's mode.
            use_raylet (bool): Use raylet or not.
        """
        ...
        # the correct driver.
        if mode != WORKER_MODE:
            self.task_driver_id = ray.ObjectID(self.worker_id)
...
def register_custom_serializer(cls,
    ...
    serialization_context = worker.object_store_client.serialization_context
    serialization_context.register_custom_serializer(
        cls,
