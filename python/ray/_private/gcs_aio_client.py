...
class NewGcsAioClient:
    def __init__(
        ...
        self.raw_get_all_actor_info = self.inner.async_raw_get_all_actor_info
        self.raw_get_task_events = self.inner.async_raw_get_task_events
        self.raw_get_all_placement_group = self.inner.async_raw_get_all_placement_group
        self.raw_get_all_node_info = self.inner.async_raw_get_all_node_info
        self.raw_get_all_worker_info = self.inner.async_raw_get_all_worker_info
