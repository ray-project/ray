...
# in memory (see ray.experimental.sandbox._internal.cdi.get_spec /
# cdi_lib.CDISpec.generate) — so it must not be generous: `nvidia-ctk cdi
# generate` only enumerates local driver/device state, no network I/O, and
# normally completes in well under a second. This bounds a hung/misbehaving
