...
def remote(
    *args, **kwargs
    ...
    Args:
        *args: The arguments passed to the remote function.
        **kwargs: Additional arguments passed to the remote function.
            ...
            fallback_strategy: [Experimental] If specified, expresses soft constraints
