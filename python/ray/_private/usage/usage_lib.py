...
def generate_report_data(cluster_metadata: dict) -> UsageStatsToReport:
...
def generate_write_data(
    ...
    Params:
        ...
        report_error(str): The error message if report fails.
        total_report_success(int): The total number of successful report
            for the lifetime of the cluster.
        total_report_failed(int): The total number of failed report
            for the lifetime of the cluster.
    ...
    data = UsageStatsToWrite(
        ...
        report_success=report_error is None,
        report_error=report_error,
        total_report_success=total_report_success,
        total_report_failed=total_report_failed,
    )
    return data
