...
class WorkingDirManager:
    ...
    def get_project_package_name(self, working_dir: str, py_modules: List[str],
        ...
        .. code-block:: python
            >>> import any_module
            >>> self.get_project_package_name("/working_dir", [any_module])
    ...
    def _store_package_in_gcs(self, gcs_key: str, data: bytes) -> int:
    ...
    def rewrite_runtime_env_uris(self, job_config: JobConfig) -> None:
    ...
    def setup_working_dir(self, runtime_env: dict,
        ...
        context.working_dir = self.ensure_runtime_env_setup(runtime_env["uris"])
