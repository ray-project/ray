...
DISABLE_COLOR_LOG = os.getenv("BYTED_RAY_DISABLE_COLOR_LOG", None) == "true"
RUNTIME_ENV_CONDA_PY_VERSIONS = [(3, 6), (3, 7), (3, 8), (3, 9), (3, 10)]

# BYTEDANCE INTERNAL
RAY_ENABLE_DRIVER_ERR_LOG_FILE_ENVIRONMENT_VARIABLE = (
    "BYTED_RAY_ENABLE_DRIVER_ERR_LOG_FILE"
)
# BYTEDANCE INTERNAL
