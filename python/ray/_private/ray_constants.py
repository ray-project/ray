...
# NIXL memory pool configuration
RAY_NIXL_MEMORY_POOL_ENABLED = env_bool("RAY_NIXL_MEMORY_POOL_ENABLED", False)
RAY_NIXL_CPU_MEMORY_POOL_SIZE = env_integer(
    "RAY_NIXL_CPU_MEMORY_POOL_SIZE", 1024 * 1024 * 1024
)
RAY_NIXL_GPU_MEMORY_POOL_SIZE = env_integer(
    "RAY_NIXL_GPU_MEMORY_POOL_SIZE", 1024 * 1024 * 1024
)
