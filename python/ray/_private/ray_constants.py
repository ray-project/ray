...
# Node-level cache of the cluster ID (hex). Set by the node for the processes
# it spawns so they don't each fetch the cluster ID from the GCS on connect.
RAY_CLUSTER_ID_ENVIRONMENT_VARIABLE = "RAY_CLUSTER_ID"
