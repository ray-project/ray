...
class RayParams:
    ...
    Attributes:
        ...
        dashboard_agent_listen_port: The port for dashboard agents to listen on
            for HTTP requests.
            Defaults to 52365.
        dashboard_head_grpc_port: The port for the dashboard head process to listen
            for gRPC on.
            Defaults to zero (Random available port used.)
    ...
    def __init__(
        ...
        self.dashboard_head_grpc_port = dashboard_head_grpc_port
    ...
    def update_pre_selected_port(self):
        ...
        pre_selected_ports = {
            ...
            "dashboard_head_grpc": wrap_port(self.dashboard_head_grpc_port),
