...
class TestDashboardHeadModuleFiltering(unittest.TestCase):
    """Integration test for DashboardHead module filtering via environment variable."""
    ...
    def test_dashboard_head_no_filtering_when_env_var_not_set(self):
    ...
    def test_dashboard_head_empty_env_var(self):
