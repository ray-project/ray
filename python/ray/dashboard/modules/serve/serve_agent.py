...
# DEPRECATED: This class is deprecated and will be removed soon. Currently, it's
# implementation duplicates a lot with the ServeHead class.
# We should not add new features to this class.
