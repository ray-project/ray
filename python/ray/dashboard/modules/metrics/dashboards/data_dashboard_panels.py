...
DATA_GRAFANA_PANELS = [
    ...
    Panel(
        id=49,
        title="Bytes Generated / Output Block",
        ...
        targets=[
            Target(
                ...
                legend="Bytes Generated / Output Block: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
        stack=False,
    ...
    Panel(
        ...
        targets=[
            Target(
                ...
                legend="Num Output Blocks / Task: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
        stack=False,
