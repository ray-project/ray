...
DATA_GRAFANA_PANELS = [
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_output_bytes{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_output_rows{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_num_inputs_received{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_bytes_inputs_received{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_num_task_inputs_processed{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_bytes_task_inputs_processed{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_bytes_inputs_of_submitted_tasks{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_num_task_outputs_generated{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        description="Bytes of output blocks generated by tasks per second.",
        unit="bytes/sec",
        targets=[
            Target(
                expr="sum(rate(ray_data_bytes_task_outputs_generated{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_rows_task_outputs_generated{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_num_outputs_taken{{{global_filters}}}[30s])) by (dataset, operator)",
    ...
    Panel(
        ...
        targets=[
            Target(
                expr="sum(rate(ray_data_bytes_outputs_taken{{{global_filters}}}[30s])) by (dataset, operator)",
