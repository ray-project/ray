...
class TestRayEventsPublisherBase:
    ...
    def test_publish_with_retries_failure_then_success(self, mock_publisher, base_kwargs):
    ...
    def test_publish_with_retries_max_retries_exceeded(self, mock_publisher, base_kwargs):
...
class TestGCSPublisher:
    ...
    def test_publish_success_via_worker(self, mock_create_data, gcs_publisher, base_kwargs, gcs_stub):
...
class TestExternalPublisher:
    ...
    def test_publish_empty_batch_via_worker(self, external_publisher, base_kwargs, http_session):
    ...
    def test_publish_success_via_worker(self, mock_msg_to_json, mock_json_loads, external_publisher, http_session, base_kwargs):
    ...
    @patch('json.loads')
    @patch('ray.dashboard.modules.aggregator.ray_events_publisher.MessageToJson')
    def test_publish_http_error_via_worker(self, mock_msg_to_json, mock_json_loads, external_publisher, http_session, base_kwargs):
