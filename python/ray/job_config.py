...
class JobConfig:
    ...
    Attributes:
        ...
        code_search_path (str[]): A list of directories or jar files separated
            by colon that specify the search path for user code. This will be
            used as `CLASSPATH` in Java and `PYTHONPATH` in Python.
    """
