            ...
            if core_worker.current_actor_is_asyncio():
                ...
                if inspect.isasyncgenfunction(function.method):
                    ...
                    return core_worker.run_async_func_or_coro_in_event_loop(
                        ...
                        name_of_concurrency_group_to_execute, True, actor,
            ...
            with core_worker.profile_event(b"task:execute"):
                ...
                try:
                    ...
                    if is_streaming_generator:
                        ...
                        is_generator = inspect.isgenerator(outputs)
                        ...
                        if is_async_gen:
                            # Instead of directly passing the async generator,
                            ...
                            async def run_async_gen_and_store_to_queue(outputs, queue):
                                while True:
                                    try:
                            ...
                            core_worker.run_async_func_or_coro_in_event_loop(
                                run_async_gen_and_store_to_queue(outputs, queue),
                                function_descriptor,
                                name_of_concurrency_group_to_execute,
                                False)
...
cdef class CoreWorker:
    ...
    def run_async_func_or_coro_in_event_loop(
        ...
        Args:
            ...
            blocking: if True, it blocks until the coroutine finishes and
                return the result. If False, it will return future immediately.
        ...
        if blocking:
            ...
            # Although this future is GC'ed, the scheduled
            # coroutine is not canceled.
            return future
