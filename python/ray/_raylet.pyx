...
cdef class OldGcsClient:
    ...
    @_auto_reconnect
    def get_all_job_info(self, job_or_submission_id: str = None, timeout=None) -> Dict[JobID, JobTableData]:
        ...
        with nogil:
            check_status(self.inner.get().GetAllJobInfo(c_job_or_submission_id, timeout_ms, c_job_infos))
