    ...
    def remote(self, *args, **kwargs):
        ...
        Args:
            request_data(dict, Any): If it's a dictionary, the data will be
                ...
                deployment directly, unmodified. Otherwise, the data will be
