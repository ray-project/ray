...
class ServeController:
    ...
    def deploy_apps(
        ...
        for app_config in applications:
            ...
            logger.info(f"Starting deploy_serve_application task for application {app_config.name}.")
    ...
    try:
        ...
        for options in deployment_override_options:
            ...
            if "ray_actor_options" in options:
                ...
                # Otherwise, get options from application code (and default to {} if code
