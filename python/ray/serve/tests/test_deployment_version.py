...
def test_deployment_config_basic():
    v1 = DeploymentVersion("1", InternalDeploymentConfig(user_config="1"), {})
    v2 = DeploymentVersion("1", InternalDeploymentConfig(user_config="1"), {})
    v3 = DeploymentVersion("1", InternalDeploymentConfig(user_config="2"), {})
...
def test_user_config_hashable():
    v1 = DeploymentVersion("1", InternalDeploymentConfig(user_config=("1", "2")), {})
    v2 = DeploymentVersion("1", InternalDeploymentConfig(user_config=("1", "2")), {})
    v3 = DeploymentVersion("1", InternalDeploymentConfig(user_config=("1", "3")), {})
...
def test_user_config_nested():
    v1 = DeploymentVersion(
        "1", InternalDeploymentConfig(user_config=[{"1": "2"}, {"1": "2"}]), {}
    )
    v2 = DeploymentVersion(
        "1", InternalDeploymentConfig(user_config=[{"1": "2"}, {"1": "2"}]), {}
    )
    v3 = DeploymentVersion(
        "1", InternalDeploymentConfig(user_config=[{"1": "2"}, {"1": "3"}]), {}
    )
...
def test_requires_actor_reconfigure():
    ...
    # reconfigure method
    v1 = DeploymentVersion("1", InternalDeploymentConfig(user_config=1), {})
    v2 = DeploymentVersion("1", InternalDeploymentConfig(user_config=2), {})
...
def test_hash_consistent_across_processes(serve_instance):
    ...
    def get_version():
        return DeploymentVersion(
            "1",
            InternalDeploymentConfig(user_config=([{"1": "2"}, {"1": "2"}],)),
            {},
        )
