...
class TestMultiplexBatchingIntegration:
    ...
    async def test_multiplex_with_batching_different_models(self, start_serve_with_context):
...
class TestMultiplexBatchingAPI:
    ...
    async def test_serve_multiplexed_decorator_with_batching(self, start_serve_with_context):
...
if __name__ == "__main__":
    ...
    pytest.main([
        # __file__ + "::TestMultiplexBatchingIntegration::test_basic_batching_integration",
        # __file__ + "::TestMultiplexBatchingIntegration::test_multiplex_with_batching_different_models", 
        # __file__ + "::TestMultiplexBatchingIntegration::test_batching_timeout_behavior",
        # __file__ + "::TestMultiplexBatchingIntegration::test_max_batch_size_enforcement",
        # __file__ + "::TestMultiplexBatchingIntegration::test_model_eviction_with_batching",
        # __file__ + "::TestMultiplexBatchingIntegration::test_batching_disabled_fallback",
        __file__ + "::TestMultiplexBatchingIntegration::test_concurrent_models_with_batching",
        __file__ + "::TestMultiplexBatchingAPI::test_serve_multiplexed_decorator_with_batching",
        __file__ + "::TestEndToEndMultiplexBatching::test_multiplexed_deployment_with_batching",
        "-v"
    ])
