...
def test_application_autoscaling_policy(serve_instance_with_two_signal, policy):
    ...
    verify_scaling_decisions(signal_A, signal_B)


def verify_scaling_decisions(signal_A, signal_B):
