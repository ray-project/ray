...
@pytest.mark.skipif(sys.platform == "win32", reason="Flaky on Windows")
def test_multiplexed_disallowed_with_haproxy(metrics_start_shutdown):
    """Multiplexed deployments cannot run with HAProxy mode.

    Use test_multiplexed_metrics in test_metrics.py for multiplex metrics coverage.
    """
