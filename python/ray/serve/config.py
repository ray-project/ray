...
class DeploymentConfig(BaseModel):
    ...
    graceful_shutdown_timeout_s: NonNegativeFloat = DEFAULT_GRACEFUL_SHUTDOWN_TIMEOUT_S  # noqa: E501
    graceful_shutdown_wait_loop_s: NonNegativeFloat = DEFAULT_GRACEFUL_SHUTDOWN_WAIT_LOOP_S  # noqa: E501
