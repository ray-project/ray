...
RAY_SERVE_HAPROXY_BUFSIZE = get_env_int("RAY_SERVE_HAPROXY_BUFSIZE", 1024 * 16) # 16KB
RAY_SERVE_HAPROXY_H2_MAX_FRAME_SIZE = get_env_int("RAY_SERVE_HAPROXY_H2_MAX_FRAME_SIZE", 1024 * 16) # 16KB
RAY_SERVE_HAPROXY_H2_BE_INITIAL_WINDOW_SIZE = get_env_int("RAY_SERVE_HAPROXY_H2_BE_INITIAL_WINDOW_SIZE", 1024 * 64) # 64KB
RAY_SERVE_HAPROXY_H2_BE_MAX_CONCURRENT_STREAMS = get_env_int("RAY_SERVE_HAPROXY_H2_BE_MAX_CONCURRENT_STREAMS", 100)
RAY_SERVE_HAPROXY_H2_FE_INITIAL_WINDOW_SIZE = get_env_int("RAY_SERVE_HAPROXY_H2_FE_INITIAL_WINDOW_SIZE", 1024 * 64) # 64KB
RAY_SERVE_HAPROXY_H2_FE_MAX_CONCURRENT_STREAMS = get_env_int("RAY_SERVE_HAPROXY_H2_FE_MAX_CONCURRENT_STREAMS", 100)
