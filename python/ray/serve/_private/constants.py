...
# Emit per-request metrics from the ingress-request-router data path, including
# router failures and fallbacks. Off by default.
...
# Bound by the proxy actor before HAProxy starts when HAProxy metrics are enabled.
