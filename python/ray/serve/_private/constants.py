...
if RAY_SERVE_THROUGHPUT_OPTIMIZED:
    RAY_SERVE_RUN_USER_CODE_IN_SEPARATE_THREAD = get_env_bool("RAY_SERVE_RUN_USER_CODE_IN_SEPARATE_THREAD", "0")
    RAY_SERVE_REQUEST_PATH_LOG_BUFFER_SIZE = get_env_int("RAY_SERVE_REQUEST_PATH_LOG_BUFFER_SIZE", 1000)
    RAY_SERVE_RUN_ROUTER_IN_SEPARATE_LOOP = get_env_bool("RAY_SERVE_RUN_ROUTER_IN_SEPARATE_LOOP", "0")
