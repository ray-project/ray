...
from ray.serve._private.benchmarks.streaming._grpc import test_server_pb2 as backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2
...
class GRPCTestServer(object):
    ...
    def Unary(request,
              ...
              timeout=None,
              metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GRPCTestServer/Unary',
    ...
    def ClientStreaming(request_iterator,
                        ...
                        timeout=None,
                        metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/GRPCTestServer/ClientStreaming',
                                              backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Request.SerializeToString,
                                              backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Response.FromString,
                                              options, channel_credentials,
                                              insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ServerStreaming(request,
                        ...
                        timeout=None,
                        metadata=None):
        return grpc.experimental.unary_stream(request, target, '/GRPCTestServer/ServerStreaming',
                                              backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Request.SerializeToString,
                                              backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Response.FromString,
                                              options, channel_credentials,
                                              insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BidiStreaming(request_iterator,
                      ...
                      timeout=None,
                      metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/GRPCTestServer/BidiStreaming',
                                               backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Request.SerializeToString,
                                               backend_dot_server_dot_common_dot_clients_dot_grpc_dot_proto_dot_test__server__pb2.Response.FromString,
                                               options, channel_credentials,
                                               insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
