...
def build_app(
    ...
    *,
    ...
    # Check if the application has ingress bypass enabled.
    # When enabled, the ingress deployment becomes the router for Lua routing.
    router_deployment_name = None
    if getattr(app, "_ingress_bypass", False):
