...
class TokenAwarePow2ReplicaRouter(LocalityMixin, MultiplexMixin, RequestRouter):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if tree_actor is None:
            ...
            self._tree_actor = TokenPrefixTreeActor.options(
                name="LlmTokenPrefixTreeActor", get_if_exists=True, lifetime="detached"
            ).remote()
        else:
