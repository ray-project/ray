...
def _device_context_manager():
    ...
    if (
        AccleratorRuntime.is_acclerator_communicator_available(device) is not None
        and AccleratorRuntime.get().is_available()
    ):
        ...
        return AccleratorRuntime.get().get_device_context(device)
    return nullcontext()
