...
#include <jni.h>
/* Header for class org_ray_streaming_runtime_queue_impl_QueueConsumerImpl */

#ifndef _Included_org_ray_streaming_runtime_queue_impl_QueueConsumerImpl
#define _Included_org_ray_streaming_runtime_queue_impl_QueueConsumerImpl
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_ray_streaming_runtime_queue_impl_QueueConsumerImpl
