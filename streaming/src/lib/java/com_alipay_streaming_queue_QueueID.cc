...
JNIEXPORT jlong JNICALL Java_org_ray_streaming_queue_QueueID_createNativeID(
...
JNIEXPORT void JNICALL Java_org_ray_streaming_queue_QueueID_destroyNativeID(
