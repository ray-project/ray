...
#include <jni.h>
/* Header for class org_ray_streaming_queue_impl_StreamingQueueLinkImpl */

#ifndef _Included_org_ray_streaming_queue_impl_StreamingQueueLinkImpl
#define _Included_org_ray_streaming_queue_impl_StreamingQueueLinkImpl
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_org_ray_streaming_queue_impl_StreamingQueueLinkImpl_newMessageHandler
 ...
 * Signature: (J[B)V
 */
JNIEXPORT void JNICALL Java_org_ray_streaming_queue_impl_StreamingQueueLinkImpl_onQueueTransfer
 ...
 * Signature: (J[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_ray_streaming_queue_impl_StreamingQueueLinkImpl_onQueueTransferSync
  (JNIEnv *, jobject, jlong, jbyteArray);
