...
class ExecutionEdge:
    def __init__(self, execution_edge_pb, language):
        self.source_execution_vertex_id = execution_edge_pb.source_execution_vertex_id
        self.target_execution_vertex_id = execution_edge_pb.target_execution_vertex_id
...
class ExecutionVertex:
    ...
    def __init__(self, execution_vertex_pb):
        ...
        self.execution_job_vertex_id = execution_vertex_pb.execution_job_vertex_id
        self.execution_job_vertex_name = execution_vertex_pb.execution_job_vertex_name
        ...
        if execution_vertex_pb.language == Language.PYTHON:
            ...
            if execution_vertex_pb.chained:
                ...
                self.stream_operator = operator.load_chained_operator(operator_bytes)
            else:
        ...
        if execution_vertex_pb.worker_actor:
            self.worker_actor = ray.actor.ActorHandle._deserialization_helper(
                execution_vertex_pb.worker_actor
            )
...
class ExecutionVertexContext:
    ...
    def get_source_actor_by_execution_vertex_id(self, execution_vertex_id):
        ...
        raise Exception("Vertex {} does not exist!".format(execution_vertex_id))
