...
class Worker:
    ...
    def init_writer(self, output_channel, reader_actor):
        ...
        ChannelInitialParameters.set_python_reader_function_descriptor(reader_async_func, reader_sync_func);
    ...
    def init_reader(self, input_channel, writer_actor):
        ...
        ChannelInitialParameters.set_python_writer_function_descriptor(writer_async_func, writer_sync_func);
