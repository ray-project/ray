...
#
# This script uses 'wanda', Ray's container image builder, to orchestrate
# Docker builds with caching. Wanda is run via 'uvx' to ensure the correct
# version is used (the wheel is cached after first download).
set -euo pipefail

WANDA_SPEC="ci/docker/ray-wheel.wanda.yaml"
# WANDA_WHEEL="https://github.com/ray-project/rayci/releases/latest/download/wanda_bin-0.1.0-py3-none-macosx_15_0_arm64.whl"
WANDA_WHEEL="/Users/andrew/devel/rayci-publish-uv/_release/wanda_bin-0.27.0-py3-none-macosx_12_0_arm64.whl"
