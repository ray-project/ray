...
LLVM_VERSION=12.0.1
FILE_NAME="clang+llvm-${LLVM_VERSION}-x86_64-linux-gnu-ubuntu-16.04.tar.xz"

# Starting LLVM 14
# FILE_NAME="clang+llvm-${LLVM_VERSION}-x86_64-linux-gnu-ubuntu-18.04.tar.xz "

if [ "$HOSTTYPE" = "aarch64" ]; then
  FILE_NAME="clang+llvm-${LLVM_VERSION}-aarch64-linux-gnu.tar.xz "
fi

LLVM_URL="https://github.com/llvm/llvm-project/releases/download/llvmorg-${LLVM_VERSION}/${FILE_NAME}"
