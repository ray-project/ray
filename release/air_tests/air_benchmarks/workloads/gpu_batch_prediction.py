...
def main(data_directory: str, data_format: str):
    ...
    ds = ds.map_batches(
        ...
        compute=ActorPoolStrategy(size=int(ray.cluster_resources()["GPU"])), num_gpus=1, 
