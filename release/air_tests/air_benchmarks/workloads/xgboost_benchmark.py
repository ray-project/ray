...
from ray.train.xgboost import XGBoostTrainer, load_checkpoint, to_air_checkpoint, XGBoostPredictor
...
def run_xgboost_training():
    ds = data.read_parquet("s3://air-example-data-2/100G-xgboost-data.parquet/")  # silver tier
    params = {
