...
class AwsVmClusterManager(ClusterManager):
    ...
    def start_cluster(self, timeout: float):
        ...
        self.port_forward_proc = subprocess.Popen(['ray', 'dashboard', 'cluster_launcher_config_aws.yaml'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
        import time
