...
class MinimalSessionManagerTest(unittest.TestCase):
    ...
    def testClusterName(self):
        ...
        cluster_manager = self.cls(
            test=Test({"name": "test", "cluster": {"byod": {}}}),
            project_id=UNIT_TEST_PROJECT_ID,
            smoke_test=False,
            sdk=sdk,
        )
    ...
    def testSetClusterEnv(self):
        ...
        self.assertEqual(
            ...
            "029272617770_dkr_ecr_us-west-2_amazonaws_com_anyscale_ray_123456-py38-cpu"
            "__env__44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a",
        )
