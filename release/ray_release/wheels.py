...
def get_ray_wheels_url_from_local_wheel(ray_wheels: str) -> Optional[str]:
    ...
    "ubuntu_2022_01_01_23:59:99/ray-2.5.0-cp37-cp37m-manylinux_x86_64.whl"
...
def parse_commit_from_wheel_url(url: str) -> str:
    ...
    # https://s3-us-west-2.amazonaws.com/ray-wheels/master/0e0c15065507f01e8bfe78e49b0d0de063f81164/ray-2.5.0-cp37-cp37m-manylinux2014_x86_64.whl  # noqa
    regex = r"/([0-9a-f]{40})/"
