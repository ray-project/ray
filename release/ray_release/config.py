...
ALLOWED_BYOD_TYPES = ["gpu", "gpu-cu130", "cpu", "cu123", "llm-cu128", "torch-cu128"]
...
def validate_byod_type(byod_type: str, python_version: str) -> None:
    ...
    if byod_type == "llm-cu128" and python_version != "3.14":
        raise Exception("LLM cu128 BYOD tests must use Python 3.14")
    if byod_type in ["torch-cu128"] and python_version != "3.14":
        raise Exception(f"{byod_type} BYOD tests must use Python 3.14")
