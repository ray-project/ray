...
def get_prop_raw_image_paths(num_workers, target_worker_gb):
    ...
    class_ids = [
        ...
        "n02134084", "n02134418", "n02137549", "n02138441"
    ]
    TARGET_NUM_DIRS = min(math.ceil(target_worker_gb * num_workers * 1024 / mb_per_file), len(class_ids))
    file_paths = [
        f"{img_s3_root}/{class_id}/" for class_id in class_ids[:TARGET_NUM_DIRS]
    ]
    return file_paths
