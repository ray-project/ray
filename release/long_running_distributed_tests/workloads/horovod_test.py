...
from release.long_running_distributed_tests.utils import JsonCallback
...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        fail_fast=True,
        callbacks=[JsonCallback(output_json_file=os.environ.get(
        "TEST_OUTPUT_JSON", "/tmp/horovod_test.json"))] if not
        args.smoke_test else None)
