...
if python rllib/examples/attention_net.py --as-test --stop-reward=20; then SUCCESS=0; fi
if python rllib/examples/attention_net.py --framework=torch --as-test --stop-reward=20; then SUCCESS=0; fi
