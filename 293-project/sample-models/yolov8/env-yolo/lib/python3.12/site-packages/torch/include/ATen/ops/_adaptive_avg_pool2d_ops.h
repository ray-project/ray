...
struct TORCH_API _adaptive_avg_pool2d {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "_adaptive_avg_pool2d(Tensor self, SymInt[2] output_size) -> Tensor")
...
struct TORCH_API _adaptive_avg_pool2d_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "_adaptive_avg_pool2d.out(Tensor self, SymInt[2] output_size, *, Tensor(a!) out) -> Tensor(a!)")
