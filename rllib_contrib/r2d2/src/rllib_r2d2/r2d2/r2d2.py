...
from rllib_r2d2.r2d2.r2d2_tf_policy import R2D2TFPolicy
from rllib_r2d2.r2d2.r2d2_torch_policy import R2D2TorchPolicy
...
class R2D2Config(DQNConfig):
    ...
    Example:
        >>> from rllib_r2d2.r2d2.r2d2 import R2D2Config
        >>> config = R2D2Config()
