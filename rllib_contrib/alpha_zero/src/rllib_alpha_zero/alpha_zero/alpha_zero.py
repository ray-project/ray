...
from rllib_alpha_zero.alpha_zero.mcts import MCTS
from rllib_alpha_zero.alpha_zero.ranked_rewards import get_r2_env_wrapper
...
class AlphaZeroConfig(AlgorithmConfig):
    ...
    Example:
        >>> from rllib_alpha_zero.alpha_zero import AlphaZeroConfig
