...
#fi
"$PYTHON_EXECUTABLE" -m pip install -q \
        --target="$ROOT_DIR/python/ray/pyarrow_files" /Users/chaokunyang/ant/Development/DevProjects/alibaba/archive/pyarrow-0.14.0.RAY-cp36-cp36m-macosx_10_6_intel.whl
