...
class TFPolicy(Policy):
    ...
    def __init__(self,
        ...
        Args:
            ...
            loss_inputs (Dict[str, TensorType]): A (name, placeholder) tuple
                for each loss input argument. Each placeholder name must
    ...
    def _initialize_loss(self,
                         loss: TensorType,
                         loss_inputs: Dict[str, TensorType]) -> None:
        ...
        Args:
            ...
            loss_inputs (Dict[str, TensorType]): The dict mapping names (str)
                to tf.placeholders needed for calculating the loss.
        """
