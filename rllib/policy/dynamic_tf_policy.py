    ...
    def __init__(self,
        ...
        Arguments:
            ...
            dist_class_and_inputs_fn (Optional[callable]): A callable,
                returning a tuple of action_dist_class and
                distribution_inputs. If None, a default class is used and
                distribution inputs will be generated by a model call.
        ...
        log_likelihood = self.dist_class(
            dist_inputs, self.model).logp(action_input)
