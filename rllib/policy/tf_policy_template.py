...
def build_tf_policy(name: str,
    ...
    Args:
        ...
        apply_gradients_fn (Optional[Callable[[Policy,
            ...
            gradients op given policy, tf-optimizer, and grads_and_vars.
        ...
        make_model (Optional[Callable[[Policy, gym.spaces.Space,
            ...
            specified, a default ModelV2 object will be created.
        ...
        action_distribution_fn (Optional[Callable[[Policy, ModelV2, TensorType,
            ...
            outputs (or an empty list if not applicable).
