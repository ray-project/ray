...
def build_tf_policy(
    ...
    Args:
        ...
        extra_learn_fetches_fn (Optional[Callable[[Policy], \
            ...
            instead.
        validate_spaces (Optional[Callable[[Policy, gym.Space, \
            gym.Space, TrainerConfigDict], None]]):
        ...
        after_init (Optional[Callable[[Policy, gym.Space, gym.Space, \
            TrainerConfigDict], None]]):
            Optional callable to run at the end of
        ...
        action_distribution_fn (Optional[Callable[[Policy, ModelV2, \
            TensorType, TensorType, TensorType], Tuple[TensorType, type, \
            List[TensorType]]]]):
            Optional callable
