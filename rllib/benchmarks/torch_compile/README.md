...
To run the benchmark script, you need a ray cluster comprised of at least 129 CPUs (2x64 + 1) and 2 ACCs. If this is not accessible to you, you can change the number of sampling workers and batch size to make the requirements smaller.
