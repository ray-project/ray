...
class TestCQL(unittest.TestCase):
    ...
    def test_cql_offline_learning_pendulum(self):
        ...
        data_file_pend = "/Users/sven/Dropbox/Projects/anyscale_projects/wildlife_studios/cql_issue/dataset_sample_short.json"
        ...
        import numpy as np
        tune.register_env("my_env", lambda cfg: RandomEnv({
