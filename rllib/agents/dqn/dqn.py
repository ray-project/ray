...
DEFAULT_CONFIG = with_common_config({
    ...
    # Whether to use a distribution of epsilons across workers for
    # exploration.
...
def validate_config(config):
    """
    Checks and updates the config based on settings. Rewrites sample_batch_size
...
def add_trainer_metrics(trainer, result):
    ...
    result.update(
        ...
        info=dict({
            "exploration_state": trainer.cur_exp_states,
