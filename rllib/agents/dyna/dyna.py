...
def dyna_execution_plan(workers: WorkerSet, config: dict):
    ...
    # TODO: (michael) LearnerThread should probably be the (main policy) MAML
    #  learner.
...
DYNATrainer = build_trainer(
    name="DYNA",
    default_policy=None,
    get_policy_class=ray.rllib.agents.dyna.dyna_torch_policy.DYNATorchPolicy),
    default_config=DEFAULT_CONFIG,
    validate_config=validate_config,
    execution_plan=dyna_execution_plan
)
