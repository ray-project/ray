...
def get_dist_class_and_distribution_parameters(
    ...
    return SquashedGaussian if config["normalize_actions"] else DiagGaussian, \
        distribution_parameters


def build_action_output(policy, model, input_dict, obs_space, action_space,
                        explore, config, timestep):
    dist_class, dist_parameters = get_dist_class_and_distribution_parameters(
        policy, model, input_dict, obs_space, action_space, config)
