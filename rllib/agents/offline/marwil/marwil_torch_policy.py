from ray.rllib.agents.offline.marwil.marwil_tf_policy import \
...
import ray.rllib.agents.offline.marwil.marwil as MARWIL
...
MARWILTorchPolicy = build_policy_class(
    ...
    framework="torch",
    loss_fn=marwil_loss,
    get_default_config=lambda: MARWIL.DEFAULT_CONFIG,
    stats_fn=stats,
