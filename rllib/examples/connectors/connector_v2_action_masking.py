...
from ray.rllib.connectors.module_to_env.action_masking import ActionMasking
from ray.rllib.env.multi_agent_env_runner import MultiAgentEnvRunner
from ray.rllib.env.single_agent_env_runner import SingleAgentEnvRunner
from ray.rllib.examples.env.cartpole_with_action_masking import (
...
if __name__ == "__main__":
    ...
    if args.num_agents > 0:
        register_env(
            "env",
            lambda cfg: MultiAgentCartPoleWithDictObservationSpace(
                config=dict(cfg, **{"num_agents": args.num_agents})
            ),
        )
    else:
    ...
    config = (
        ...
        .environment("env", env_config=allowed_actions_config)
        ...
        .rollouts(
            module_to_env_connector=lambda env: ActionMasking(
