...
def custom_eval_function(
    ...
    for i in range(3):
        ...
        # collected metrics.
        episodes, metrics_all_env_runners = eval_workers.foreach_worker(
    ...
    env_steps = sum(eps.env_steps() for eps in episodes)
    agent_steps = sum(eps.agent_steps() for eps in episodes)
