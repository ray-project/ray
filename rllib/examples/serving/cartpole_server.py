...
if __name__ == "__main__":
    ...
    connector_config = {
        # The server doesn't need an env.
        # Allow spaces to be determined by user.
        "env": None,
        "observation_space": gym.spaces.Box(float("-inf"), float("inf"), (4, )),
        "action_space": gym.spaces.Discrete(2),
        # Use the connector server to generate experiences.
        "input": (
            lambda ioctx: PolicyServerInput(ioctx, SERVER_ADDRESS, SERVER_PORT + ioctx.worker_index - 1) if ioctx.worker_index > 0 else None
        ),
