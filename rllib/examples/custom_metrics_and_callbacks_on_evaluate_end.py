"""Example of using RLlib's on_evaluate_end callback.
...
class MyCallbacks(DefaultCallbacks):
    ...
    def on_evaluate_end(self, *, trainer: "Trainer", result: dict, **kwargs):
        # you can mutate the result dict to add new fields to return
        evaluation_pole_angles = result["evaluation"]["hist_stats"]["pole_angles"]
        result["evaluation"]["evaluation_pole_angle_mean"] = np.mean(evaluation_pole_angles)
...
if __name__ == "__main__":
    ...
    # Verify evaluation-related custom metrics are there.
    assert "evaluation_pole_angle_mean" in trials[0].last_result['evaluation']
    print("Evaluation pole_angle_mean: {}".format(trials[0].last_result['evaluation']['evaluation_pole_angle_mean']))
