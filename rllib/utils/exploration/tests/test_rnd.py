...
class TestRND(unittest.TestCase):
    """Sanity tests for RND exploration implementation."""
    ...
    def test_rnd_normalized_intrinsic_rewards(self):
        """Test RND with normalized intrinsic rewards.
    ...
    def test_rnd_metrics(self):
        """Test the RNDMetricsCallbacks.

        Uses all frameworks for testing.
        """

        # Build a PPOConfig object and add the NovelD metrics callbacks.
        config = self.create_ppo_test_config().callbacks(RNDMetricsCallbacks)
