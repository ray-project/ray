...
class TestMultiAgentEpisode(unittest.TestCase):
    ...
    def test_init(self):
        ...
        check(episode._hanging_actions, {"a0": 0})
        check(episode._hanging_rewards, {"a0": 0.1})
        check(episode._hanging_extra_model_outputs, {"a0": {}})
        ...
        check(episode._hanging_actions, {"a0": 2})
        check(episode._hanging_rewards, {"a0": 0.3})
        check(episode._hanging_extra_model_outputs, {"a0": {}})
    ...
    def test_add_env_step(self):
        ...
        for agent_id in ["agent_1", "agent_5"]:
            self.assertTrue(agent_id not in episode._hanging_actions)
            self.assertTrue(agent_id not in episode._hanging_rewards)
            self.assertTrue(agent_id not in episode._hanging_extra_model_outputs)
        ...
        self.assertTrue(episode._hanging_actions["agent_4"] is not None)
        # Assert that the reward buffers of agents 3 and 5 are at 1.0.
        check(episode._hanging_rewards["agent_3"], 2.2)
        check(episode._hanging_rewards["agent_5"], 1.0)
    ...
    def test_cut(self):
        ...
        check(episode_2._hanging_actions, {})
        check(episode_2.agent_episodes["a0"].actions.lookback, 0)
    ...
    def test_slice(self):
        ...
        check(slice_._hanging_actions["a0"], 6)
    ...
    def test_get_return(self):
        ...
        # `get_return()`.
        buffered_rewards = sum(episode._hanging_rewards.values())
        self.assertTrue(
    ...
    def _mock_multi_agent_records_from_env(
        ...
        # actions.
            ...
            obs = {
                ...
                if episode._hanging_actions[agent_id]
            }
