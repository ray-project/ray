...
class RolloutSaver:
    ...
    def __init__(self, outfile=None, use_shelve=False, write_update_file=False, target_steps=None, target_episodes=None):
...
def run(args, parser):
    ...
    with RolloutSaver(args.out, args.use_shelve, write_update_file=args.track_progress, target_steps=args.steps, target_episodes=args.episodes) as saver:
