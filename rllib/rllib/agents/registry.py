...
def _import_pg():
    from ..agents import pg
    return pg.PGTrainer


def _import_impala():
    from ..agents import impala
    return impala.ImpalaTrainer


def _import_marwil():
    from ..agents import marwil
...
def get_agent_class(alg):
    ...
    try:
        ...
        from ..agents.mock import _agent_import_failed
...
def _get_agent_class(alg):
    if alg in ALGORITHMS:
        ...
        from ..agents.mock import _MockTrainer
        return _MockTrainer
    elif alg == "__sigmoid_fake_data":
        from ..agents.mock import _SigmoidFakeData
        return _SigmoidFakeData
    elif alg == "__parameter_tuning":
        from ..agents.mock import _ParameterTuningTrainer
