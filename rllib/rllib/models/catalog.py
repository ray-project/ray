...
from ..models.extra_spaces import Simplex
from ..models.torch.torch_action_dist import (TorchCategorical,
                                                      TorchDiagGaussian)
from ..models.tf.tf_action_dist import (
    Categorical, MultiCategorical, Deterministic, DiagGaussian,
    MultiActionDistribution, Dirichlet)
from ..models.preprocessors import get_preprocessor
from ..models.tf.fcnet_v1 import FullyConnectedNetwork
from ..models.tf.lstm_v1 import LSTM
from ..models.tf.modelv1_compat import make_v1_wrapper
from ..models.tf.tf_modelv2 import TFModelV2
from ..models.tf.visionnet_v1 import VisionNetwork
from ..models.modelv2 import ModelV2
from ..utils import try_import_tf
from ..utils.annotations import DeveloperAPI, PublicAPI
...
MODEL_DEFAULTS = {
    ...
    # For control envs, documented in ..models.Model
    "free_log_std": False,
...
class ModelCatalog(object):
    ...
    def _get_default_torch_model_v2(obs_space, action_space, num_outputs,
                                    model_config, name):
        from ..models.torch.fcnet import (FullyConnectedNetwork as
                                                  PyTorchFCNet)
        from ..models.torch.visionnet import (VisionNetwork as
                                                      PyTorchVisionNet)
