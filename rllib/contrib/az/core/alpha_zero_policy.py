...
class AlphaZeroPolicy(TorchPolicy):
    ...
    def __init__(self, observation_space, action_space, model, loss, action_distribution_class, mcts_creator,
                 env_creator, **kwargs):
        super().__init__(observation_space, action_space, model, loss, action_distribution_class)
        # we maintain an env copy in the policy that is used during mcts simulations
    ...
    def compute_actions(self, obs_batch, state_batches=None, prev_action_batch=None,
        ...
        with torch.no_grad():
            ...
            for i, episode in enumerate(episodes):
                ...
                # run monte carlo simulations to compute the actions and record the tree
    ...
    def postprocess_trajectory(self, sample_batch, other_agent_batches=None, episode=None):
        ...
        # final episode reward corresponds to the value (if not discounted) for all transitions in episode
