...
class Learner:
    ...
    def update(
        ...
        *,
        ...
        #TEST: Used new stack + EnvRunner w/o connectors (master), which is learning CartPole-v1
        # to store n episodes returned by that master's EnvRunners
        # - load episodes here and replace `episodes` with these ones
        # - load train_batch generated by master branch (in `training_step` right before
        #   learner_group.update call)
        # - load module weights
