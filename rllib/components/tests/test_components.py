...
class TestComponents(unittest.TestCase):
    ...
    def test_dummy_component(self):
        ...
        # Try to create a Component from a class w/o default constructor.
        # Expect None.
        test = AbstractDummyComponent.from_config({"framework": "torch"})
        check(test, None)

        # Create a Component via python API (config dict).
        component = Component.from_config(dict(
            type=DummyComponent,
        ...
        component = Component.from_config("dummy_config.json")
        ...
        component = Component.from_config("dummy_config.yml")
