...
class TorchModelV2(ModelV2):
    ...
    def __init__(
        ...
        # Dict to store per multi-acc tower stats into.
        # In PyTorch multi-ACC, we use a single TorchPolicy and copy
        # it's Model(s) n times (1 copy for each ACC). When computing the loss
