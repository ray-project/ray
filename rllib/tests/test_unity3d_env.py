...
class TestUnity3DEnv(unittest.TestCase):
    def test_port_editor(self, mock_unity3d):
        """Test if the environment uses the editor port when no environment file is provided"""
    ...
    def test_port_app(self, mock_unity3d):
        """Test if the environment uses the correct port when the environment file is provided"""
    ...
    def test_ports_multi_app(self, mock_unity3d):
        """Test if the base_port + worker_id is different for each environment"""
        _ = Unity3DEnv(file_name="app", port=None)
    ...
    def test_custom_port_app(self, mock_unity3d):
        """Test if the base_port + worker_id is different for each environment when using custom ports"""
