...
from ray.rllib.examples.env.matrix_sequential_social_dilemma import IteratedPrisonersDilemma, IteratedChicken, \
...
def test_reset():
    max_steps = 20
    env_class_all = [
        IteratedPrisonersDilemma, IteratedChicken, IteratedStagHunt,
        IteratedBoS
    ]
