...
def simulate_vt_calculation(vfps, rewards, terminateds, truncateds, gamma, lambda_):
    ...
    pipe = LearnerConnectorPipeline(connectors=[AddOneTsToEpisodesAndTruncate(), AddColumnsFromEpisodesToTrainBatch(), BatchIndividualItems()])
    batch = pipe(
        episodes=episodes,
        batch={},
        rl_module=None,
...
class TestPPO(unittest.TestCase):
    ...
    def test_value_computation(self):
        correct = [0.9405, 1., None,     0.9405, 1., None]
        ...
        correct = [0.9405, 1., None, 0.9405, 1.9405, None]
