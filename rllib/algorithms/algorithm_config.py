...
class AlgorithmConfig:
    ...
    def __init__(self, algo_class=None):
        ...
        # Define the default RLlib Algorithm class that this
        # AlgorithmConfig will be applied to.
        ...
        *,
        ...
        Args:
            ...
            custom_evaluation_function: Customize the evaluation method. This must be a
                function of signature (algorithm: Algorithm, eval_workers: WorkerSet) ->
