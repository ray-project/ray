        ...
        **kwargs,
        ...
        Args:
            ...
            advantage_type: The way we reduce q values to v_t values
                ...
                .. math:: A(s_t, a_t) = Q(s_t, a_t) - \max_{a^j} Q(s_t, a^j)
