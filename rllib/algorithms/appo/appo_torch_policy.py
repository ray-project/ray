...
class APPOTorchPolicy(
    ...
    def __init__(self, observation_space, action_space, config):
        ...
        self.torch_timers = defaultdict(_Timer)
    ...
    def loss(
        ...
        with self.torch_timers["total"]:
            ...
            with self.torch_timers["model_forward"]:
                model_out, _ = model(train_batch)

            with self.torch_timers["after_model_forward"]:
            ...
            with self.torch_timers["value_function"]:
                values = model.value_function()

            with self.torch_timers["after_value_function"]:
            ...
            if self.config["vtrace"]:
                with self.torch_timers["v_trace_pre"]:
                    logger.debug(
                ...
                with self.torch_timers["vtrace_post"]:
                ...
                with self.torch_timers["no_vtrace"]:
            ...
            with self.torch_timers["loss_adds"]:
