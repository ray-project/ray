...
def rllib_contrib_warning(algo_str):
    if log_once(f"{algo_str}_contrib"):
        logging.getLogger(__name__).warning(
            ...
            "Ray 2.8, but from Ray 2.9 on, all `rllib_contrib` algorithms will no longer "
            "be part of the core repo, and will therefore have to be installed "
            "separately with pinned dependencies for e.g. ray[rllib] and other packages! "
            "See "
