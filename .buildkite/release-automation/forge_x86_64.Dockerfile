...
apt-get update
apt-get upgrade -y
apt-get install -y curl zip unzip clang-14 git
...
uv pip install --python /usr/local/bin/python --system --break-system-packages pip==25.2 cffi==1.16.0 pyyaml==6.0.3
