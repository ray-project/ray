...
which curl
wget -q https://github.com/rprichard/winpty/releases/download/0.4.3/winpty-0.4.3-cygwin-2.8.0-x64.tar.gz -O /c/tmp/winpty/winpty.tar.gz
...
/c/tmp/winpty/winpty-0.4.3-cygwin-2.8.0-x64/bin/winpty.exe docker run -it --rm --env RAY_VERSION --env RAY_COMMIT rayproject/win-verifier
