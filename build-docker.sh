...
REQUIREMENTS_FILE_BASE_DEPS="python/deplocks/base_deps/ray_base_deps_py${PYTHON_VERSION}.lock"
cp "${REQUIREMENTS_FILE_BASE_DEPS}" "${RAY_DEPS_BUILD_DIR}/${REQUIREMENTS_FILE_BASE_DEPS}"
