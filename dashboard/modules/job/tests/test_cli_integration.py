...
def test_resources(shutdown_only):
    ...
    stdout, _ = _run_cmd(
        ...
        "--entrypoint-num-gpus=1 --entrypoint-memory=64 --entrypoint-resources='{"
        '"Custom": 1}\' -- echo hello',
    )
    assert "hello" in stdout
