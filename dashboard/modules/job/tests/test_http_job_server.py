...
from ray.dashboard.modules.job.data_types import (
    JobSubmitRequest, JobSubmitResponse, JobStatusRequest,
    JobStatusResponse, JobLogsRequest, JobLogsResponse, JobSpec)
...
def test_submit_job(disable_aiohttp_cache, enable_test_module,
    ...
    resp = requests.post(
        f"{webui_url}/submit", json=submit_request.dict())
