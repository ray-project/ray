...
class JobDetails(BaseModel):
    ...
    type: str = Field(
        ..., description='The type of job. Either "submission" or "driver"'
    )
    ...
    id: Optional[str] = Field(
        None,
        description="The primary id of a job. The job_id will be the primary id in the "
        "long term. For backwards compatibility reasons, submission type jobs use "
        "submission ids as the primary id.",
    )
    job_id: Optional[str] = Field(
        None,
        description="The job id. An id that is created for every driver that is "
