...
DATA_GRAFANA_PANELS = [
    ...
    Panel(
        id=37,
        title="Reserved Memory for Operator",
        description="Byte size of memory reserved for this operator by the reservation op resource allocator",
        unit="bytes",
        targets=[
            Target(
                expr="sum(ray_data_reserved_memory{{{global_filters}}}) by (dataset, operator)",
                legend="Bytes Size: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
    ...
    Panel(
        id=38,
        title="Reserved Memory for Operator Outputs",
        description="Byte size of memory reserved specifically for the output queue for this operator",
        unit="bytes",
        targets=[
            Target(
                expr="sum(ray_data_reserved_memory_for_outputs{{{global_filters}}}) by (dataset, operator)",
                legend="Bytes Size: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
    ...
    Panel(
        id=39,
        title="Budgeted Memory for Operator",
        description="Byte size of memory reserved specifically for the output queue for this operator",
        unit="bytes",
        targets=[
            Target(
                expr="sum(ray_data_budgeted_memory{{{global_filters}}}) by (dataset, operator)",
                legend="Bytes Size: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
    ...
    Panel(
        id=40,
        title="Total Shared Memory",
        description="Byte size of the entire shared memory across all operators.",
        unit="bytes",
        targets=[
            Target(
                expr="sum(ray_data_total_shared_memory{{{global_filters}}}) by (dataset, operator)",
                legend="Bytes Size: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
    ...
    Panel(
        id=41,
        title="Total Memory Usage for Operator",
        description="Byte size of memory usage for this operator.",
        unit="bytes",
        targets=[
            Target(
                expr="sum(ray_data_total_memory_usage{{{global_filters}}}) by (dataset, operator)",
                legend="Bytes Size: {{dataset}}, {{operator}}",
            )
        ],
        fill=0,
