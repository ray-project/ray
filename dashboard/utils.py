...
def get_all_modules(module_type):
    ...
    for module_loader, name, ispkg in pkgutil.walk_packages(
        ...
        if dashboard_consts.ENABLE_HEAD_RAYLETLESS and name == "ray.dashboard.modules.job.job_head":
            continue
        if not dashboard_consts.ENABLE_HEAD_RAYLETLESS and name == "ray.dashboard.modules.job.rayletless_job_head":
            continue
        try:
