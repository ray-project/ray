...
describe('sortActors', () => {
    ...
    it.each([
      ['sorts actors by state when states are different', 'DEAD', 'ALIVE', [actor2, actor1]],
      ['sorts actors by startTime when states are equal and start times are different', 'ALIVE', 'ALIVE', [actor1, actor2]]
