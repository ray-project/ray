...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        url = "https://github.com/protocolbuffers/protobuf/archive/6b5d8db01fe47478e8d400f550e797e6230d464e.tar.gz",
        patches = [
    ...
    auto_http_archive(
        ...
        # https://github.com/grpc/grpc/blob/v1.60.0/bazel/grpc_deps.bzl
