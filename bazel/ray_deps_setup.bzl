...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        # https://github.com/grpc/grpc/blob/v1.64.0/bazel/grpc_deps.bzl
        ...
        url = "https://github.com/google/boringssl/archive/5a2bca2124800f2861263959b72bc35cdf18949b.tar.gz",
    )
