...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        # https://github.com/grpc/grpc/blob/v1.65.0/bazel/grpc_deps.bzl
        ...
        url = "https://github.com/google/boringssl/archive/b8a2bffc598f230484ff48a247526a9820facfc2.tar.gz",
    )
