...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        url = "https://github.com/protocolbuffers/protobuf/archive/2434ef2adf0c74149b9d547ac5fb545a1ff8b6b5.tar.gz",
        patches = [
    ...
    auto_http_archive(
        ...
        # https://github.com/grpc/grpc/blob/v1.63.0/bazel/grpc_deps.bzl
        ...
        url = "https://github.com/google/boringssl/archive/e14d29f68c2d1b02e06f10c83b9b8ea4d061f8df.tar.gz",
    )
