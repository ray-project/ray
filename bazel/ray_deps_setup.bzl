...
def ray_deps_setup():
    ...
    auto_http_archive(
        ...
        url = "https://github.com/grpc/grpc/archive/refs/tags/v1.62.0.tar.gz",
    ...
    auto_http_archive(
        ...
        # https://github.com/grpc/grpc/blob/v1.62.0/bazel/grpc_deps.bzl
        ...
        url = "https://github.com/google/boringssl/archive/ae72a4514c7afd150596b0a80947f3ca9b8363b5.tar.gz",
    )
