...
load("@com_github_stackb_rules_protobuf//cpp:deps.bzl", "cpp_grpc_compile")
load("@com_github_stackb_rules_protobuf//python:deps.bzl", "python_grpc_compile")
load("@com_github_stackb_rules_protobuf//java:deps.bzl", "java_grpc_compile")
