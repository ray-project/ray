...
/// Wait for the given objects until timeout expires or num_return objects are found.
///
/// \param conn The connection information.
...
/// \return A pair with the first element containing the object ids that were found,
