...
class MockNodeManager : public NodeManager {
 public:
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(void,
              HandlePrepareVirtualCluster,
              (rpc::PrepareVirtualClusterRequest request,
               rpc::PrepareVirtualClusterReply *reply,
               rpc::SendReplyCallback send_reply_callback),
              (override));
  MOCK_METHOD(void,
              HandleCommitVirtualCluster,
              (rpc::CommitVirtualClusterRequest request,
               rpc::CommitVirtualClusterReply *reply,
               rpc::SendReplyCallback send_reply_callback),
              (override));
  MOCK_METHOD(void,
              HandleReturnVirtualCluster,
              (rpc::ReturnVirtualClusterRequest request,
               rpc::ReturnVirtualClusterReply *reply,
               rpc::SendReplyCallback send_reply_callback),
              (override));
  MOCK_METHOD(void,
              HandleReleaseUnusedVirtualClusters,
