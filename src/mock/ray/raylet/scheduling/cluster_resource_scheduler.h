...
class MockClusterResourceScheduler : public ClusterResourceScheduler {
 public:
  ...
  MOCK_METHOD(void, UpdateResourceCapacity, (const std::string &node_name, const std::string &resource_name, double resource_total), (override));
  MOCK_METHOD(void, DeleteResource, (const std::string &node_name, const std::string &resource_name), (override));
