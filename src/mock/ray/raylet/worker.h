...
class MockWorkerInterface : public WorkerInterface {
 public:
  ...
  MOCK_METHOD(void, Connect, (std::shared_ptr<rpc::CoreWorkerClientInterface> rpc_client), (override));
  ...
  MOCK_METHOD(const std::unordered_set<TaskID>&, GetBlockedTaskIds, (), (const, override));
  ...
  MOCK_METHOD(void, AcquireTaskCpuResources, (const ResourceIdSet &cpu_resources), (override));
  ...
  MOCK_METHOD(void, SetAllocatedInstances, (const std::shared_ptr<TaskResourceInstances> &allocated_instances), (override));
  MOCK_METHOD(std::shared_ptr<TaskResourceInstances>, GetAllocatedInstances, (), (override));
  MOCK_METHOD(void, ClearAllocatedInstances, (), (override));
  MOCK_METHOD(void, SetLifetimeAllocatedInstances, (const std::shared_ptr<TaskResourceInstances> &allocated_instances), (override));
  MOCK_METHOD(std::shared_ptr<TaskResourceInstances>, GetLifetimeAllocatedInstances, (), (override));
