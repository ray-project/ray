...
class MockCoreWorkerClientInterface : public ray::pubsub::MockSubscriberClientInterface,
 ...
 public:
  ...
  MOCK_METHOD(
      void,
      KillActor,
      (const KillActorRequest &request, const ClientCallback<KillActorReply> &callback),
      (override));
  MOCK_METHOD(
      void,
      CancelTask,
      (const CancelTaskRequest &request, const ClientCallback<CancelTaskReply> &callback),
      (override));
  MOCK_METHOD(
      void,
      RemoteCancelTask,
  ...
  MOCK_METHOD(
      void,
      LocalGC,
      (const LocalGCRequest &request, const ClientCallback<LocalGCReply> &callback),
      (override));
  MOCK_METHOD(
      void,
      SpillObjects,
