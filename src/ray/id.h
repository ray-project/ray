...
/// Compute the object ID of a signal generated by the task.
///
/// \param task_id The task ID of the task that generated the signal.
/// \param signal_index Index of this signal associated with the task.
/// \return The computed signal ID.
