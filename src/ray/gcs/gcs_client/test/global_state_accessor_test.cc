...
TEST_P(GlobalStateAccessorTest, TestGetAllResourceUsage) {
  ...
  gcs_server_->GetMutableAutoscalerStateManager().UpdateResourceLoadAndUsage(*resources1);
  ...
  gcs_server_->GetMutableAutoscalerStateManager().UpdateResourceLoadAndUsage(*heartbeat2);
