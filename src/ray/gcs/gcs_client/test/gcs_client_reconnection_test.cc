      ...
      R"(
{
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, /*timeout_ms=*/0, [&p0](auto status, auto) {
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVGet(
      "", "A", /*timeout_ms=*/0, [&p1](auto status, auto p) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p1.set_value(*p);
      }));
      ...
      R"(
{
  ...
  auto f1 = p1.get_future();
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, /*timeout_ms=*/0, [&p1](auto status, auto) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p1.set_value();
      }));
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, /*timeout_ms=*/0, [](auto, auto) {}));
      ...
      R"(
{
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, /*timeout_ms=*/0, [](auto status, auto) {}));
      ...
      R"(
{
  ...
  bool added = false;
  ASSERT_TRUE(
      client->InternalKV().Put("", "A", "B", false, /*timeout_ms=*/0, added).ok());
  ASSERT_TRUE(added);

  ShutdownGCS();

  std::vector<std::string> values;
  ASSERT_TRUE(client->InternalKV().Keys("", "A", /*timeout_ms=*/0, values).IsTimedOut());
  ASSERT_TRUE(values.empty());
  StartGCS();
  ASSERT_TRUE(client->InternalKV().Keys("", "A", /*timeout_ms=*/0, values).ok());
