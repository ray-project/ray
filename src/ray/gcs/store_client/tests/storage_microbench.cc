...
int main(int argc, char **argv) {
  ...
  // numbers look ~100x faster than they would on real ext4. Operators
  // running this benchmark should point --db-dir at the same storage
  // class as their production GCS PVC.
  std::string db_dir =
