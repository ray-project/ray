...
// Smoke test for the RocksDB Bazel integration. The smallest possible
// exercise of the new dependency: open a RocksDB at a temp path, put
// one key, read it back, verify the value. Exists to prove that
// librocksdb.a links into a Ray-built binary, basic Open/Put/Get work
// end-to-end, and the build is clean under sanitizer configs. The full
// StoreClient surface is exercised by `rocksdb_store_client_test` and
// `rocksdb_parity_test`.
