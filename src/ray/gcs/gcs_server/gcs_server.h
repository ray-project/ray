...
class GcsServer {
 public:
  ...
  static constexpr int kMaxStatsInitRetries = 10;
  static constexpr int kStatsInitRetryDelayMs = 2000;
 ...
 private:
  ...
  /// Initializes Ray metrics infrastructure for GCS server asynchronously. This is
  /// a helper function for InitStats.
  void InitStatsAsync(instrumented_io_context &main_service,
