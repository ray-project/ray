...
int main(int argc, char *argv[]) {
  ...
  gcs_server_config.grpc_based_resource_broadcast = RayConfig::instance().grpc_based_resource_broadcast();
  RAY_LOG(ERROR) << "in main, broadcast: " << gcs_server_config.grpc_based_resource_broadcast;
