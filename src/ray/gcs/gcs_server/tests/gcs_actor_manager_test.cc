        ...
        R"(
{
  "maximum_gcs_destroyed_actor_cached_count": 10
    ...
    gcs_actor_manager_ = std::make_unique<gcs::GcsActorManager>(
        ...
        *worker_client_pool_,
        ...
        fake_gcs_actor_by_state_counter_);
  ...
  ray::observability::FakeMetric fake_gcs_actor_by_state_counter_;
};
...
TEST_F(GcsActorManagerTest, TestActorStateMetrics) {
  ...
  auto gcs_actor_tag_to_value = fake_gcs_actor_by_state_counter_.GetTagToValue();
  ...
  auto tag_to_value = fake_actor_by_state_counter_.GetTagToValue();
