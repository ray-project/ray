...
void GcsActorManager::RecordMetrics() const {
  gcs_actor_by_state_counter_.Record(registered_actors_.size(),
                                     {{"State"sv, "Registered"}});
  gcs_actor_by_state_counter_.Record(created_actors_.size(), {{"State"sv, "Created"}});
  gcs_actor_by_state_counter_.Record(destroyed_actors_.size(),
                                     {{"State"sv, "Destroyed"}});
  gcs_actor_by_state_counter_.Record(unresolved_actors_.size(),
                                     {{"State"sv, "Unresolved"}});
  gcs_actor_by_state_counter_.Record(GetPendingActorsCount(), {{"State"sv, "Pending"}});
