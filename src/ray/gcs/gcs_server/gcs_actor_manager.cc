...
void GcsActor::WriteActorExportEvent() const {
  std::shared_ptr<rpc::ExportActorData> export_actor_data_ptr = std::make_shared<rpc::ExportActorData>();
  ...
  export_actor_data_ptr->set_serialized_runtime_env(actor_table_data_.serialized_runtime_env());
  ...
  export_actor_data_ptr->mutable_required_resources()->insert(actor_table_data_.required_resources().begin(),
