...
typedef std::function<void(const Status &, const rpc::RequestResourceReserveReply &)>
    ReserveResourceCallback;
...
//                         ReserveResourceCallback>>
  ...
  void CancelResourceReserve(BundleSpecification bundle_spec,
 ...
 protected:
  ...
  /// The queue which is used to store the whole ReserveResourceFromNode
  std::deque<std::tuple<BundleSpecification, std::shared_ptr<rpc::GcsNodeInfo>,
                        ReserveResourceCallback>>
