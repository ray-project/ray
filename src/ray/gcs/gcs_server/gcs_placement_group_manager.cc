...
GcsPlacementGroupManager::GcsPlacementGroupManager(
  ...
  placement_group_state_counter_->SetOnChangeCallback(
      [this](const rpc::PlacementGroupTableData::PlacementGroupState key) mutable {
        ...
        placement_group_counter_.Record(
            num_pg,
...
void GcsPlacementGroupManager::RecordMetrics() const {
  placement_group_counter_.Record(pending_placement_groups_.size(),
                                  {{"State"sv, "Pending"}});
  placement_group_counter_.Record(registered_placement_groups_.size(),
                                  {{"State"sv, "Registered"}});
  placement_group_counter_.Record(infeasible_placement_groups_.size(),
                                  {{"State"sv, "Infeasible"}});
