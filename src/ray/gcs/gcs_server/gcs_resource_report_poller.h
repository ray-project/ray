...
class GcsResourceReportPoller {
 ...
 private:
  ...
  // A global lock for internal operations. This lock is shared between the main thread and polling thread, so we should be mindful about how long we hold it.
  absl::Mutex mutex_;
