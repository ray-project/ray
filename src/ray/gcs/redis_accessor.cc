...
Status RedisNodeResourceInfoAccessor::AsyncReportResourceUsage(
    const std::shared_ptr<rpc::ResourcesData> &data_ptr, const StatusCallback &callback) {
  return Status::Invalid("Not implemented");
}

void RedisNodeResourceInfoAccessor::AsyncReReportResourceUsage() {}

Status RedisNodeResourceInfoAccessor::AsyncSubscribeBatchedResourceUsage(
