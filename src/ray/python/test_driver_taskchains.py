...
def TEST_submit_task_chains(num_chains, tasks_per_chain):
    ...
    for chain_num in range(num_chains):
        ...
        for i in range(tasks_per_chain):
            task_returns = submit_task_withdep(driver, last_task_returns)
...
if __name__ == '__main__':
    ...
    task_placement_map = TEST_submit_task_chains(num_chains=num_chains, tasks_per_chain=tasks_per_chain)
    ...
    for chain_num in range(len(task_placement_map)):
        task_placement_list = driver.get(task_placement_map[chain_num], timeout_ms=1000)
