...
bazel build "//:redis_gcs_client_test" "//:redis_actor_state_accessor_test"  "//:subscription_executor_test" "//:asio_test" "//:libray_redis_module.so"
...
./bazel-bin/redis_actor_state_accessor_test
