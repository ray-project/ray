...
class GcsClientContext {
  ...
  */
  virtual rpc::ObservabilityPubSubRpcClient &GetObservabilityPubSubRpcClient() = 0;
  ...
  */
  virtual void SetObservabilityPubSubRpcClient(
      std::shared_ptr<rpc::ObservabilityPubSubRpcClient> client) = 0;
  /**
