      ...
      R"(
{
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, gcs::ClientUtils::GetGcsTimeoutMs(), [&p0](auto status, auto) {
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVGet(
      "", "A", gcs::ClientUtils::GetGcsTimeoutMs(), [&p1](auto status, auto p) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p1.set_value(*p);
      }));
      ...
      R"(
{
  ...
  auto f1 = p1.get_future();
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, gcs::ClientUtils::GetGcsTimeoutMs(), [&p1](auto status, auto) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p1.set_value();
      }));
  ...
  auto f2 = p2.get_future();
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, gcs::ClientUtils::GetGcsTimeoutMs(), [&p2](auto status, auto) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p2.set_value();
      }));
      ...
      R"(
{
  ...
  RAY_UNUSED(client->InternalKV().AsyncInternalKVPut(
      "", "A", "B", false, gcs::ClientUtils::GetGcsTimeoutMs(), [&p4](auto status, auto) {
        ASSERT_TRUE(status.ok()) << status.ToString();
        p4.set_value();
      }));
      ...
      R"(
{
  ...
  auto client = CreateGCSClient();
  bool added = false;
  ASSERT_TRUE(client->InternalKV()
                  .Put("", "A", "B", false, gcs::ClientUtils::GetGcsTimeoutMs(), added)
                  .ok());
  ASSERT_TRUE(added);
  ...
  ASSERT_TRUE(client->InternalKV()
                  .Keys("", "A", gcs::ClientUtils::GetGcsTimeoutMs(), values)
                  .IsTimedOut());
