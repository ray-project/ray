...
/// Implementation of ErrorInfoAccessorInterface.
class ErrorInfoAccessor : public ErrorInfoAccessorInterface {
 public:
  ErrorInfoAccessor() = default;
  explicit ErrorInfoAccessor(GcsClientContext *context);
  ...
  virtual void AsyncReportJobError(rpc::ErrorTableData data) override;
