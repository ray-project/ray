...
/// Interface for TaskInfo operations.
class TaskInfoAccessorInterface {
 public:
  virtual ~TaskInfoAccessorInterface() = default;
  ...
  virtual void AsyncGetTaskEvents(const MultiItemCallback<rpc::TaskEvents> &callback) = 0;
};
