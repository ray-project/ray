...
class TaskManager : public TaskFinisherInterface, public TaskResubmissionInterface {
 public:
  TaskManager(std::shared_ptr<CoreWorkerMemoryStore> in_memory_store,
              ...
              const rpc::Address &address, RetryTaskCallback retry_task_callback,
 ...
 private:
  ...
  std::vector<ObjectID> PutIntoStore(const ObjectID &object_id, bool transferred,
                                     bool is_plasma, NodeID pinned_node,
                                     size_t object_size, const std::string &data,
