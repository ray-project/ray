...
class TaskManager : public TaskManagerInterface {
 ...
 private:
  ...
  /// Set the task retry number to 0. If mark_task_canceled is true, mark the task as
  // canceled.
  void MarkTaskNoRetryInternal(const TaskID &task_id, bool mark_task_canceled)
      ABSL_LOCKS_EXCLUDED(mu_);
