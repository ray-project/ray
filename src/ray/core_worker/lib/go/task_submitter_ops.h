...
#ifndef RAY_CORE_WORKER_LIB_GO_TASK_SUBMITTER_OPS_H_
#define RAY_CORE_WORKER_LIB_GO_TASK_SUBMITTER_OPS_H_
...
#endif  // RAY_CORE_WORKER_LIB_GO_TASK_SUBMITTER_OPS_H_
