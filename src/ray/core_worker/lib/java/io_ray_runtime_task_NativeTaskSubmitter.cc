...
inline const RayFunction &
ToRayFunction(JNIEnv *env, jobject functionDescriptor, jint hash) {
  ...
  fd_vector.emplace_back(
      env->NewGlobalRef(functionDescriptor),
...
inline std::unordered_map<std::string, double> ToResources(
    JNIEnv *env,
...
inline ActorCreationOptions ToActorCreationOptions(
    JNIEnv *env,
  ...
  if (actorCreationOptions) {
    ...
    jobject java_concurrency_groups_field = env->GetObjectField(
        actorCreationOptions,
        java_actor_creation_options_concurrency_groups);
    ...
    JavaListToNativeVector<ray::ConcurrencyGroup>(
        ...
        [](JNIEnv *env, jobject java_concurrency_group_impl) {
          ...
          jobject java_func_descriptors = env->CallObjectMethod(
...
inline PlacementGroupCreationOptions ToPlacementGroupCreationOptions(
    JNIEnv *env,
    jobject placementGroupCreationOptions) {
  ...
  JavaListToNativeVector<std::unordered_map<std::string, double>>(
      ...
      java_bundles,
      &bundles,
      [](JNIEnv *env, jobject java_bundle) {
        return JavaMapToNativeMap<std::string, double>(
            env,
            java_bundle,
            [](JNIEnv *env, jobject java_key) {
  ...
  return PlacementGroupCreationOptions(
      name,
