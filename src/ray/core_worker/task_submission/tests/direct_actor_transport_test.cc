...
>>>>>>> ae94ff496a308c52100cd99b1857836b739498e0
  ...
  TEST_F(DirectTaskTransportTest, ActorCreationOk) {
    ...
    gcs_client->mock_actor_accessor->async_create_actor_callback_(
        Status::OK(), rpc::CreateActorReply());
  }
  ...
  TEST_F(DirectTaskTransportTest, ActorCreationFail) {
    ...
    actor_task_submitter->SubmitActorCreationTask(creation_task_spec);
    gcs_client->mock_actor_accessor->async_create_actor_callback_(
        Status::IOError(""), rpc::CreateActorReply());
  }
