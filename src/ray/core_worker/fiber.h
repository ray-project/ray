...
class FiberState {
 ...
 private:
  // The fiber stack size. 256 KiB.
  // Note that the default fiber stack size is 128 KiB. In the CI environment, this is not
  // large enough and thus it causes sefaults. See
  // https://github.com/ray-project/ray/pull/44292.
