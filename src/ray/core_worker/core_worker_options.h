...
struct CoreWorkerOptions {
  ...
  CoreWorkerOptions()
      : store_socket(""),
        ...
        clean_up_gpu_object_callback(nullptr),
  ...
  /// Callback to clean up GPU object from the in-actor object store.
  std::function<void(const ObjectID &)> clean_up_gpu_object_callback;
