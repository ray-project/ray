...
Status CoreWorkerPlasmaStoreProvider::Put(
...
Status CoreWorkerPlasmaStoreProvider::Create(
...
Status UnblockIfNeeded(
    const std::shared_ptr<raylet::RayletClient> &client,
...
Status CoreWorkerPlasmaStoreProvider::Contains(
    const ObjectID &object_id,
    bool *has_object) {
