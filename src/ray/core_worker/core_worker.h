...
class CoreWorker : public std::enable_shared_from_this<CoreWorker> {
 public:
  ...
  CoreWorker(
      ...
      instrumented_io_context &object_free_rpc_service,
      ...
      boost::thread &object_free_rpc_thread,
 ...
 private:
  ...
  /// Dedicated event loop for FreeObjectOnNodes gRPC calls.
  ...
  /// Dedicated thread for FreeObjectOnNodes gRPC calls.
