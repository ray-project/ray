...
TEST(OrderedActorTaskExecutionQueueTest, TestTaskEvents) {
  ...
  queue.Add(0, -1, TaskToExecute(fn_ok, fn_rej, task_spec_without_dependency));
  ...
  queue.Add(1, -1, TaskToExecute(fn_ok, fn_rej, task_spec_with_dependency));
  waiter.Complete(0);
...
TEST(OrderedActorTaskExecutionQueueTest, TestInOrder) {
  ...
  queue.Add(0, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(1, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(2, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(3, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
  io_service.run();
...
TEST(OrderedActorTaskExecutionQueueTest, ShutdownCancelsQueuedAndWaitsForRunning) {
  ...
  queue.Add(0, -1, TaskToExecute(fn_ok_blocking, fn_rej, ts));
...
TEST(OrderedActorTaskExecutionQueueTest, TestWaitForObjects) {
  ...
  queue.Add(0, -1, TaskToExecute(fn_ok, fn_rej, task_spec_without_dependency));
  queue.Add(1, -1, TaskToExecute(fn_ok, fn_rej, task_spec_with_dependency));
  queue.Add(2, -1, TaskToExecute(fn_ok, fn_rej, task_spec_with_dependency));
  queue.Add(3, -1, TaskToExecute(fn_ok, fn_rej, task_spec_with_dependency));
...
TEST(OrderedActorTaskExecutionQueueTest, TestSeqWaitTimeout) {
  ...
  queue.Add(4, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(5, -1, TaskToExecute(fn_ok, fn_rej, task_spec));
...
TEST(OrderedActorTaskExecutionQueueTest, TestSkipAlreadyProcessedByClient) {
  ...
  TaskSpecification task_spec;
  task_spec.GetMutableMessage().set_type(TaskType::ACTOR_TASK);
  queue.Add(2, 2, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(3, 2, TaskToExecute(fn_ok, fn_rej, task_spec));
  queue.Add(1, 2, TaskToExecute(fn_ok, fn_rej, task_spec));
  io_service.run();
...
TEST(OrderedActorTaskExecutionQueueTest, TestRetryInOrderOrderedActorTaskExecutionQueue) {
  ...
  queue.Add(0, -1, TaskToExecute(fn_ok, fn_rej, task_spec_0));
  auto task_spec_1 = CreateActorTaskSpec(1);
  queue.Add(1, -1, TaskToExecute(fn_ok, fn_rej, task_spec_1));
  auto task_spec_2_retry = CreateActorTaskSpec(3, /*is_retry=*/true);
  queue.Add(3, -1, TaskToExecute(fn_ok, fn_rej, task_spec_2_retry));
  auto task_spec_4 = CreateActorTaskSpec(4);
  queue.Add(4, 2, TaskToExecute(fn_ok, fn_rej, task_spec_4));
  auto task_spec_5_retry = CreateActorTaskSpec(6, /*is_retry=*/true, /*dependency=*/true);
  queue.Add(6, -1, TaskToExecute(fn_ok, fn_rej, task_spec_5_retry));
...
TEST(UnorderedActorTaskExecutionQueueTest, TestSameTaskMultipleAttempts) {
  ...
  queue.Add(-1, -1, TaskToExecute(fn_ok_1, fn_rej, task_spec_1));
  ...
  queue.Add(-1, -1, TaskToExecute(fn_ok_2, fn_rej, task_spec_2));
  io_service.poll();
...
TEST(UnorderedActorTaskExecutionQueueTest, TestSameTaskMultipleAttemptsCancellation) {
  ...
  task_spec_1.GetMutableMessage().set_task_id(task_id.Binary());
  task_spec_1.GetMutableMessage().set_attempt_number(1);
  queue.Add(-1, -1, TaskToExecute(fn_ok_1, fn_rej_1, task_spec_1));
  attempt_1_start_promise.get_future().wait();
  ...
  task_spec_2.GetMutableMessage().set_task_id(task_id.Binary());
  task_spec_2.GetMutableMessage().set_attempt_number(2);
  queue.Add(-1, -1, TaskToExecute(fn_ok_2, fn_rej_2, task_spec_2));
  ...
  queue.Add(-1, -1, TaskToExecute(fn_ok_4, fn_rej_4, task_spec_4));
  ...
  queue.Add(-1, -1, TaskToExecute(fn_ok_3, fn_rej_3, task_spec_3));
