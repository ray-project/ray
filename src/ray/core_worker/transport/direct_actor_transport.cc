...
void InboundRequest::Accept() { accept_callback_(); }

void InboundRequest::Cancel() { reject_callback_(); }
...
DependencyWaiterImpl::DependencyWaiterImpl(raylet::RayletClient &local_raylet_client)
...
bool BoundedExecutor::ThreadsAvailable() EXCLUSIVE_LOCKS_REQUIRED(mu_) {
