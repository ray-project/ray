...
Status CoreWorkerObjectInterface::Get(const std::vector<ObjectID> &ids,
  ...
  // TODO: implement fetch or reconstruct logic.
  return store_provider_layer_.Get(
...
Status CoreWorkerObjectInterface::Wait(const std::vector<ObjectID> &object_ids,
  ...
  return store_provider_layer_.GetStoreProvider(StoreProviderType::PLASMA)->Wait(
...
Status CoreWorkerObjectInterface::Delete(const std::vector<ObjectID> &object_ids,
  ...
  return store_provider_layer_.GetStoreProvider(StoreProviderType::PLASMA)->->Delete(object_ids, local_only,
