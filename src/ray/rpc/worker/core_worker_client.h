...
class CoreWorkerClient : public std::enable_shared_from_this<CoreWorkerClient>,
 ...
 public:
  ...
  RPC_CLIENT_METHOD(CoreWorkerService, AssignTask, grpc_client_)

  RPC_CLIENT_METHOD(CoreWorkerService, DirectActorCallArgWaitComplete, grpc_client_)

  RPC_CLIENT_METHOD(CoreWorkerService, GetObjectStatus, grpc_client_)

  RPC_CLIENT_METHOD(CoreWorkerService, KillActor, grpc_client_)

  RPC_CLIENT_METHOD(CoreWorkerService, GetCoreWorkerStats, grpc_client_)
