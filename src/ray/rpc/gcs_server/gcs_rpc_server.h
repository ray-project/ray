...
class JobInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleMarkJobFinished(
      const MarkJobFinishedRequest &request,
      MarkJobFinishedReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllJobInfo(
      const GetAllJobInfoRequest &request,
  ...
  virtual void HandleReportJobError(
      const ReportJobErrorRequest &request,
      ReportJobErrorReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetNextJobID(
      const GetNextJobIDRequest &request,
...
class ActorInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleRegisterActor(
      const RegisterActorRequest &request,
      RegisterActorReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleCreateActor(
      const CreateActorRequest &request,
      CreateActorReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetActorInfo(
      const GetActorInfoRequest &request,
      GetActorInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetNamedActorInfo(
      const GetNamedActorInfoRequest &request,
      GetNamedActorInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleListNamedActors(
      const rpc::ListNamedActorsRequest &request,
      rpc::ListNamedActorsReply *reply,
      rpc::SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllActorInfo(
      const GetAllActorInfoRequest &request,
      GetAllActorInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleKillActorViaGcs(
      const KillActorViaGcsRequest &request,
...
class NodeInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleRegisterNode(
      const RegisterNodeRequest &request,
      RegisterNodeReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleDrainNode(
      const DrainNodeRequest &request,
      DrainNodeReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllNodeInfo(
      const GetAllNodeInfoRequest &request,
      GetAllNodeInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetInternalConfig(
      const GetInternalConfigRequest &request,
...
class NodeResourceInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleGetResources(
      const GetResourcesRequest &request,
      GetResourcesReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleUpdateResources(
      const UpdateResourcesRequest &request,
      UpdateResourcesReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleDeleteResources(
      const DeleteResourcesRequest &request,
  ...
  virtual void HandleReportResourceUsage(
      const ReportResourceUsageRequest &request,
      ReportResourceUsageReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllResourceUsage(
      const GetAllResourceUsageRequest &request,
...
class NodeResourceInfoGrpcService : public GrpcService {
 public:
  ...
  ///
  /// \param[in] handler The service handler that actually handle the requests.
  explicit NodeResourceInfoGrpcService(
      instrumented_io_context &io_service,
...
class HeartbeatInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleReportHeartbeat(
      const ReportHeartbeatRequest &request,
      ReportHeartbeatReply *reply,
      SendReplyCallback send_reply_callback) = 0;
  virtual void HandleCheckAlive(
      const CheckAliveRequest &request,
...
class HeartbeatInfoGrpcService : public GrpcService {
 public:
  ...
  ///
  /// \param[in] handler The service handler that actually handle the requests.
  explicit HeartbeatInfoGrpcService(
      instrumented_io_context &io_service,
...
class StatsGcsServiceHandler {
 public:
  ...
  virtual void HandleAddProfileData(
      const AddProfileDataRequest &request,
      AddProfileDataReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllProfileInfo(
      const GetAllProfileInfoRequest &request,
...
class WorkerInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleReportWorkerFailure(
      const ReportWorkerFailureRequest &request,
      ReportWorkerFailureReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetWorkerInfo(
      const GetWorkerInfoRequest &request,
      GetWorkerInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGetAllWorkerInfo(
      const GetAllWorkerInfoRequest &request,
      GetAllWorkerInfoReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleAddWorkerInfo(
      const AddWorkerInfoRequest &request,
...
class WorkerInfoGrpcService : public GrpcService {
 public:
  ...
  ///
  /// \param[in] handler The service handler that actually handle the requests.
  explicit WorkerInfoGrpcService(
      instrumented_io_context &io_service,
...
class PlacementGroupInfoGcsServiceHandler {
 public:
  ...
  virtual void HandleGetNamedPlacementGroup(
      const GetNamedPlacementGroupRequest &request,
...
class PlacementGroupInfoGrpcService : public GrpcService {
 public:
  ...
  ///
  /// \param[in] handler The service handler that actually handle the requests.
  explicit PlacementGroupInfoGrpcService(
      instrumented_io_context &io_service,
...
class InternalKVGcsServiceHandler {
 public:
  ...
  virtual void HandleInternalKVKeys(
      const InternalKVKeysRequest &request,
      InternalKVKeysReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleInternalKVGet(
      const InternalKVGetRequest &request,
      InternalKVGetReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleInternalKVPut(
      const InternalKVPutRequest &request,
      InternalKVPutReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleInternalKVDel(
      const InternalKVDelRequest &request,
      InternalKVDelReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleInternalKVExists(
      const InternalKVExistsRequest &request,
...
class InternalKVGrpcService : public GrpcService {
 public:
  explicit InternalKVGrpcService(
      instrumented_io_context &io_service,
...
class InternalPubSubGcsServiceHandler {
 public:
  ...
  virtual void HandleGcsPublish(
      const GcsPublishRequest &request,
      GcsPublishReply *reply,
      SendReplyCallback send_reply_callback) = 0;

  virtual void HandleGcsSubscriberPoll(
      const GcsSubscriberPollRequest &request,
