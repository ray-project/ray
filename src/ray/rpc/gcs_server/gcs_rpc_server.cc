...
TaskInfoGcsServiceHandler::~TaskInfoGcsServiceHandler() = default;
StatsGcsServiceHandler::~StatsGcsServiceHandler() = default;
WorkerInfoGcsServiceHandler::~WorkerInfoGcsServiceHandler() = default;
ActorInfoGcsServiceHandler::~ActorInfoGcsServiceHandler() = default;
ErrorInfoGcsServiceHandler::~ErrorInfoGcsServiceHandler() = default;
JobInfoGcsServiceHandler::~JobInfoGcsServiceHandler() = default;
NodeInfoGcsServiceHandler::~NodeInfoGcsServiceHandler() = default;
ObjectInfoGcsServiceHandler::~ObjectInfoGcsServiceHandler() = default;
