...
class ServerCallImpl : public ServerCall {
 ...
 private:
  ...
  mutable ray::stats::Histogram grpc_server_req_process_time_ms_metric_{
      GetGrpcServerReqProcessTimeMsMetric()};
  mutable ray::stats::Count grpc_server_req_new_metric_{GetGrpcServerReqNewMetric()};
  mutable ray::stats::Count grpc_server_req_handling_metric_{
      GetGrpcServerReqHandlingMetric()};
  mutable ray::stats::Count grpc_server_req_finished_metric_{
      GetGrpcServerReqFinishedMetric()};
  mutable ray::stats::Count grpc_server_req_succeeded_metric_{
      GetGrpcServerReqSucceededMetric()};
  mutable ray::stats::Count grpc_server_req_failed_metric_{
