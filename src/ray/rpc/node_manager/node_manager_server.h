...
#define RAY_NODE_MANAGER_RPC_HANDLERS                             \
  ...
  RPC_SERVICE_HANDLER(NodeManagerService, ReleaseUnusedPlacementGroups)
...
class NodeManagerServiceHandler {
 public:
  ...
  virtual void HandleReleaseUnusedPlacementGroups(
      const ReleaseUnusedPlacementGroupsRequest &request,
      ReleaseUnusedPlacementGroupsReply *reply,
      SendReplyCallback send_reply_callback) = 0;
};
