...
void GrpcServer::Run() {
  ...
  builder.AddChannelArgument(GRPC_ARG_MAX_SEND_MESSAGE_LENGTH, kMaxGrpcMessageSize);
  builder.AddChannelArgument(GRPC_ARG_MAX_RECEIVE_MESSAGE_LENGTH, kMaxGrpcMessageSize);
