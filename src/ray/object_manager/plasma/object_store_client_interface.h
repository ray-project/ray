...
class ObjectStoreClientInterface : public std::enable_shared_from_this<ObjectStoreClientInterface> {
 public:
  virtual ~ObjectStoreClientInterface(){};

  /// Tell Store that the client no longer needs the object. This should be
  ...
  /// Get some objects from the Store. This function will block until the
  ...
  /// Connect to the store. Return the resulting connection.
  ///
  ...
  ///        connect to the manager. If this is "", then this
  ///        function will not connect to a manager.
  ///        Note that manager is no longer supported, this function
  ...
  /// \return The return status.
  virtual Status Authenticate(const std::string& user,
