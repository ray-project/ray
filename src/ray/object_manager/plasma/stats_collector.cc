...
void ObjectStatsCollector::RecordMetrics() const {
  ray::stats::STATS_plasma_local_spillable_objects.Record(num_objects_spillable_);
  ray::stats::STATS_plasma_local_spillable_objects_bytes.Record(num_bytes_spillable_);
  ray::stats::STATS_plasma_local_unsealed_objects.Record(num_objects_unsealed_);
  ray::stats::STATS_plasma_local_unsealed_objects_bytes.Record(num_bytes_unsealed_);
  ray::stats::STATS_plasma_local_in_use_objects.Record(num_objects_in_use_);
  ray::stats::STATS_plasma_local_in_use_objects_bytes.Record(num_bytes_in_use_);
  ray::stats::STATS_plasma_local_evictable_objects.Record(num_objects_evictable_);
  ray::stats::STATS_plasma_local_evictable_objects_bytes.Record(num_bytes_evictable_);

  ray::stats::STATS_plasma_local_objects.Record(num_objects_created_by_worker_,
                                                "Primary");
  ray::stats::STATS_plasma_local_objects_bytes.Record(num_bytes_created_by_worker_,
                                                      "Primary");
  ray::stats::STATS_plasma_local_objects.Record(num_objects_restored_, "Restored");
  ray::stats::STATS_plasma_local_objects_bytes.Record(num_bytes_restored_, "Restored");
  ray::stats::STATS_plasma_local_objects.Record(num_objects_received_, "Transferred");
  ray::stats::STATS_plasma_local_objects_bytes.Record(num_bytes_received_, "Transferred");
  ray::stats::STATS_plasma_local_objects.Record(num_objects_errored_, "ErrorObject");
  ray::stats::STATS_plasma_local_objects_bytes.Record(num_bytes_errored_, "ErrorObject");
}
