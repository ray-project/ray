...
class PullManager {
 ...
 private:
  ...
  mutable ray::stats::Gauge pull_manager_usage_bytes_{
      GetPullManagerUsageBytesGaugeMetric()};
  mutable ray::stats::Gauge pull_manager_requested_bundles_{
      GetPullManagerRequestedBundlesGaugeMetric()};
  mutable ray::stats::Gauge pull_manager_requests_{GetPullManagerRequestsGaugeMetric()};
  mutable ray::stats::Gauge pull_manager_active_bundles_{
      GetPullManagerActiveBundlesGaugeMetric()};
  mutable ray::stats::Gauge pull_manager_retries_total_{
      GetPullManagerRetriesTotalGaugeMetric()};
  mutable ray::stats::Gauge pull_manager_num_object_pins_{
      GetPullManagerNumObjectPinsGaugeMetric()};
  mutable ray::stats::Histogram pull_manager_object_request_time_ms_{
