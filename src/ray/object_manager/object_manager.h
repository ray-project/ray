...
class ObjectManager : public ObjectManagerInterface,
 ...
 public:
  ...
  uint64_t Pull(const std::vector<rpc::ObjectReference> &object_refs, BundlePriority prio)
      override;
