...
void ArrowFlightStore::PutFromIPC(const std::string &, const std::string &) {
  no_arrow();
}
ObjectTransferInfo ArrowFlightStore::PutFromIPCAndGetTransferInfo(const std::string &,
                                                                  const std::string &) {
  no_arrow();
  return {};
}
std::string ArrowFlightStore::GetLocalAsIPC(const std::string &) {
  no_arrow();
  return "";
}
std::string ArrowFlightStore::FetchAsIPC(const std::string &, const std::string &) {
  no_arrow();
  return "";
}
std::string ArrowFlightStore::FetchViaVMAsIPC(const std::string &,
                                              const std::string &,
                                              int64_t) {
  no_arrow();
  return "";
