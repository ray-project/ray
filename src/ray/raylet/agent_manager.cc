...
void AgentManager::CreateRuntimeEnv(const JobID &job_id,
  ...
  if (runtime_env_agent_client_ == nullptr) {
    ...
    delay_executor_(
        [this, job_id, serialized_runtime_env, serialized_allocated_resource_instances, callback] {
          CreateRuntimeEnv(job_id, serialized_runtime_env, serialized_allocated_resource_instances, callback);
        },
  ...
  request.set_serialized_allocated_resource_instances(serialized_allocated_resource_instances);
  runtime_env_agent_client_->CreateRuntimeEnv(
      request, [this, job_id, serialized_runtime_env, serialized_allocated_resource_instances, callback](
