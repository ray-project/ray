...
DEFINE_int32(num_initial_python_workers_for_first_job, 0, "Number of initial Python workers for the first job.");
...
int main(int argc, char *argv[]) {
  ...
  const int num_initial_python_workers_for_first_job = static_cast<int>(FLAGS_num_initial_python_workers_for_first_job);
  ...
  RAY_CHECK_OK(gcs_client->Nodes().AsyncGetInternalConfig(
      [&](::ray::Status status,
        ...
        node_manager_config.num_initial_python_workers_for_first_job = num_initial_python_workers_for_first_job;
