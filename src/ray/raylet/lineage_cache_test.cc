...
TEST_F(LineageCacheTest, TestEviction) {
  ...
  auto uncommitted_lineage = lineage_cache_.GetUncommittedLineage(last_task_id, node_id);
  ...
  uncommitted_lineage = lineage_cache_.GetUncommittedLineage(last_task_id, node_id);
