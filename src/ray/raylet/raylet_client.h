...
class ObjectPinningInterface {
 public:
  ...
  virtual ~ObjectPinningInterface(){};
};
...
class RayletClient : public ObjectPinningInterface, public WorkerLeaseInterface, public DependencyWaiterInterface {
 public:
  /// Connect to the raylet.
  ///
