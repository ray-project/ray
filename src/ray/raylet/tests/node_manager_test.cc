...
// TEST_F(NodeManagerTest, AsyncGetSkipsGetForWorkerWithoutLease) {
//   // Verifies AsyncGet drops stale GETs for workers whose lease was cleared,
...
//       .Times(2)  // one in ProcessClientMessage + one in AsyncGet
...
// TEST_F(NodeManagerTest, AsyncGetRegistersGetForDriver) {
