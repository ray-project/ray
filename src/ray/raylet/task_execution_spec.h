...
namespace {
// Use another name for the TaskExecutionSpecification generated by the
// flatbuffer compiler so that we can define the wrapper class with the same
// name.
using TaskExecSpecFlatbuffer = TaskExecutionSpecification;
}
...
class TaskExecutionSpecification {
 ...
 private:
  TaskExecutionSpecificationT execution_spec_;
};
