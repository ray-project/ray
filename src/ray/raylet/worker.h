...
class WorkerInterface {
 public:
  ...
  virtual int64_t GetRuntimeEnvHash() const = 0;
...
class Worker : public WorkerInterface {
 public:
  ...
  Worker(const JobID &job_id, const int64_t runtime_env_hash, const WorkerID &worker_id,
 ...
 private:
  ...
  const int64_t runtime_env_hash_;
