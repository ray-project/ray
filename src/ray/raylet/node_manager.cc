...
void NodeManager::SubmitTask(const Task &task, const Lineage &uncommitted_lineage,
  ...
  if (spec.IsActorTask()) {
    ...
    if (actor_entry != actor_registry_.end()) {
      ...
      // (See design_docs/task_states.rst for task state transitions.)
...
void NodeManager::ProcessPlaceableTask(const Task &task) {
  ...
  // (See design_docs/task_states.rst for the task state transition diagram.)
  ...
  // (See design_docs/task_states.rst for state transitions.)
  if (args_ready) {
