    ...
    : self_node_id_(self_node_id),
      ...
      object_manager_(
          ...
          [this]() {
            ...
            io_service_.post(
                [this]() {
                  if (global_gc_throttler_.AbleToRun()) {
                    TriggerGlobalGC();
                  }
...
rpc::ObjectStoreStats AccumulateStoreStats(
  ...
  for (const auto &reply : node_stats) {
    ...
    store_stats.set_object_store_bytes_referenced(
        store_stats.object_store_bytes_referenced() +
        cur_store.object_store_bytes_referenced());
