        ...
        [this, system_memory = std::move(system_memory_snapshot)]() {
          ...
          if (high_memory_eviction_target_ != nullptr) {
            ...
            if (worker_to_kill == nullptr) {
              RAY_LOG_EVERY_MS(WARNING, 5000)
                  << "Worker killer did not select a worker to "
              ...
              /// TODO: (clarng) expose these strings in the frontend python error as
              /// well.
              ...
              RAY_LOG(INFO) << "Killing worker with task "
                            << worker_to_kill->GetGrantedLease()
