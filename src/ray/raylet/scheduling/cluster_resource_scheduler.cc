...
int64_t ClusterResourceScheduler::GetBestSchedulableNode(
    ...
    rpc::TaskSchedulingPolicy task_scheduling_policy, bool actor_creation,
  ...
  int64_t best_node_id = scheduling_policy_->HybridPolicy(
      resource_request,
      task_scheduling_policy == rpc::TaskSchedulingPolicy::TASK_SCHEDULING_POLICY_SPREAD
          ? 0.0
...
std::string ClusterResourceScheduler::GetBestSchedulableNode(
  ...
  int64_t node_id =
      GetBestSchedulableNode(resource_request, task_scheduling_policy, actor_creation,
