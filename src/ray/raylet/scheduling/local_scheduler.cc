...
void LocalScheduler::FillResourceUsage(
...
void LocalScheduler::RecomputeDebugStats() const {
...
void LocalScheduler::RecordMetrics() const {
...
std::string LocalScheduler::DebugStr() const {
  RecomputeDebugStats();
