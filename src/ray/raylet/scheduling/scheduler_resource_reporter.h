...
class SchedulerResourceReporter {
 public:
  SchedulerResourceReporter(const internal::WorkQueueMap &leases_to_schedule,
 ...
 private:
  ...
  const internal::WorkQueueMap &leases_to_schedule_;

  const internal::WorkQueueMap &leases_to_grant_;

  const internal::WorkQueueMap &infeasible_leases_;
