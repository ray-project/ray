...
namespace ray {
  namespace raylet {
    ...
    std::unique_ptr<std::vector<std::pair<Task, std::shared_ptr<Worker>>>> ClusterTaskManager::GetDispatchableTasks() {

      std::unique_ptr<std::vector<std::pair<Task, std::shared_ptr<Worker>>>> dispatchable {new std::vector<std::pair<Task, std::shared_ptr<Worker>>>()};
