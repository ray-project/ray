...
TEST_F(ClusterTaskManagerTestWithGPUsAtHead, RleaseAndReturnWorkerCpuResources) {
  ...
  ASSERT_EQ(node_resources.available.GetCPU(), 8);
  ASSERT_EQ(node_resources.available.GetGPU(), 4);
  ...
  ASSERT_EQ(node_resources.available.GetCPU(), 7);
  ASSERT_EQ(node_resources.available.GetGPU(), 3);
