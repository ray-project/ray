...
DEFINE_stats(
    operation_run_time_ms,
    "operation execution time",
    ("Method"),
    (),
    ray::stats::GAUGE);
DEFINE_stats(
    operation_queue_time_ms,
...
/// Object Manager.
DEFINE_stats(
    object_manager_received_chunks,
...
DEFINE_stats(
    ...
    ray::stats::GAUGE);
DEFINE_stats(
    pull_manager_requested_bundles,
...
DEFINE_stats(
    ...
    ray::stats::GAUGE);
DEFINE_stats(
    scheduler_unscheduleable_tasks,
    ...
    ray::stats::GAUGE);
DEFINE_stats(
    scheduler_failed_worker_startup_total,
...
DEFINE_stats(
    gcs_new_resource_creation_latency_ms,
