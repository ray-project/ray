...
static Gauge LocalAvailableResource(
    "local_available_resource",
    "The available resources on this node.",
    "",
    {ResourceNameKey});

static Gauge LocalTotalResource(
...
static Gauge ObjectStoreLocalObjects(
    "object_store_num_local_objects",
    "Number of objects currently in the object store.",
    "objects");

static Gauge ObjectManagerPullRequests(
    "object_manager_num_pull_requests",
...
/// Worker Pool
static Histogram ProcessStartupTimeMs(
...
static Sum NumSpilledTasks(
    "internal_num_spilled_tasks",
...
/// Resources
static Histogram OutboundHeartbeatSizeKB(
    "outbound_heartbeat_size_kb",
...
static Gauge
    RestartingActors("restarting_actors", "Number of restarting actors.", "actors");
