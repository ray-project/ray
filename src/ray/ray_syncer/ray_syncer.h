...
struct ReceiverInterface {
  ...
  virtual void ConsumeInnerSyncMessage(
      std::shared_ptr<const InnerRaySyncMessage> message) = 0;
...
class RaySyncer {
 public:
  ...
  std::shared_ptr<const InnerRaySyncMessage> GetInnerSyncMessage(
  ...
  void BroadcastInnerMessage(std::shared_ptr<const InnerRaySyncMessage> message);
