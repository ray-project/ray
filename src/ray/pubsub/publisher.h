...
class Publisher : public PublisherInterface {
 public:
  ...
  /// \param channel_type The type of the channel.
  /// \param key_id The message id to publish.
  void PublishFailure(const rpc::ChannelType channel_type, const std::string &key_id)
      override;
