...
void ObservabilityPublisher::PublishError(std::string id, rpc::ErrorTableData message) {
  rpc::PubMessage msg;
...
std::string ObservabilityPublisher::DebugString() const {
  return publisher_->DebugString();
}
