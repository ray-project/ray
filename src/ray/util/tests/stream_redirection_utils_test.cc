...
class StreamRedirectionUtilsTest : public ::testing::Test {
 public:
  void SetUp() override {
...
TEST(StreamRedirectionUtilsTest, WriteContentWithNewliner) {
...
TEST(StreamRedirectionUtilsTest, WriteContentWithFlush) {
  constexpr std::string_view kLogLine1 = "hello";
  constexpr std::string_view kLogLine2 = "world";
