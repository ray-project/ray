...
TEST_F(MemoryMonitorTest, TestThresholdZeroMonitorAlwaysAboveThreshold) {
  MemoryMonitor monitor(
      ...
      [](bool is_usage_above_threshold, MemorySnapshot system_memory, float usage_threshold) { FAIL() << "Expected monitor to not run"; });
...
TEST_F(MemoryMonitorTest, TestMonitorPeriodSetCallbackExecuted) {
  ...
  MemoryMonitor monitor(
      ...
      [&callback_ran](bool is_usage_above_threshold, MemorySnapshot system_memory, float usage_threshold) {
