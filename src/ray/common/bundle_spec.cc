...
void BundleSpecification::ComputeBundleResourceLabels() {
  ...
  /// Implicit resource label.
  auto bundle_implicit_label_ = FormatPlacementGroupImplicitResource(PlacementGroupId(), Index());
  bundle_resource_labels_.insert(std::make_pair(bundle_implicit_label_, kPlacementGroupImplicitResourceValue));
