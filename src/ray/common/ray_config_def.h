...
/// Maximum size in bytes of buffered messages per pubsub channel.
/// Large applications (1k+ nodes, 100k+ tasks or actors) may see memory
/// pressure in the GCS due to high system-level pubsub traffic. Reducing this
/// config value can help reduce memory pressure, at the cost of some worker
/// logs being dropped from driver stdout.
