...
/// If GCS restarts, before the first heatbeat is sent, initial_num_heartbeats_timeout
/// is used for the threshold of the raylet.
RAY_CONFIG(int64_t, initial_num_heartbeats_timeout, 120)
