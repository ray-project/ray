...
RAY_CONFIG(uint32_t, gcs_server_rpc_server_thread_num, std::thread::hardware_concurrency() / 4)
/// Number of threads used by rpc server in gcs server.
RAY_CONFIG(uint32_t, gcs_server_rpc_client_thread_num, std::thread::hardware_concurrency() / 4)
