...
RAY_CONFIG(uint32_t, gcs_rpc_client_reconnect_timeout_s, 60)
...
RAY_CONFIG(uint32_t, core_worker_rpc_client_reconnect_timeout_base_s, 1)

/// Maximum timeout for core worker grpc server reconnection.
RAY_CONFIG(uint32_t, core_worker_rpc_client_reconnect_timeout_max_s, 60)
...
RAY_CONFIG(uint32_t, raylet_rpc_client_reconnect_timeout_base_s, 1)

/// Maximum timeout for raylet grpc server reconnection.
RAY_CONFIG(uint32_t, raylet_rpc_client_reconnect_timeout_max_s, 60)
