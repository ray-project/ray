...
/// When a worker fails to start (e.g., due to runtime environment issues),
/// the task will be retried up to this many times before being cancelled.
/// 0 means no retry (fail immediately), default is 3.
