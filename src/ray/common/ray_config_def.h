...
/// exhausted, so the default is conservative (~5 minutes with the default
/// interval).
///
...
/// Windows uses a system-fixed probe count.
RAY_CONFIG(int64_t, redis_tcp_keepalive_probes, 9)
