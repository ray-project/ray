...
/// overhead.
RAY_CONFIG(uint64_t, task_events_max_buffer_capacity, 1 * 1000 * 1000)
RAY_CONFIG(uint64_t, task_events_min_buffer_capacity, 10 * 1000)
...
RAY_CONFIG(uint64_t, task_events_send_batch_size, 1 * 1000)
