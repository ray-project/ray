 ...
 */
class MemoryMonitorTestUtils : public ::testing::Test {
 public:
  /// Destroys the mock directories in reverse order of creation.
  ~MemoryMonitorTestUtils() override {
  ...
  MemoryMonitorTestUtils() = default;
  MemoryMonitorTestUtils(const MemoryMonitorTestUtils &) = delete;
  MemoryMonitorTestUtils &operator=(const MemoryMonitorTestUtils &) = delete;
  MemoryMonitorTestUtils(MemoryMonitorTestUtils &&) = delete;
  MemoryMonitorTestUtils &operator=(MemoryMonitorTestUtils &&) = delete;
