...
class CpuMonitorUtils {
 public:
  static constexpr char kCgroupsV1CpuQuotaPath[] = "cpu/cpu.cfs_quota_us";
  static constexpr char kCgroupsV1CpuPeriodPath[] = "cpu/cpu.cfs_period_us";
  static constexpr char kCgroupsV2CpuMaxPath[] = "cpu.max";
  static constexpr char kRootCgroupPath[] = "/sys/fs/cgroup";
 ...
 private:
   ...
   * @return The number of CPUs the cgroup is limited to, or StatusT::NotFound if the
   ...
   * @return The number of CPUs the cgroup is limited to, or StatusT::NotFound if
