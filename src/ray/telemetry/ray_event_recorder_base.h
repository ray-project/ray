...
//
// The derived class should implement the ConvertToRayEvent method to convert the event
// data to RayEvent proto.
//
...
class RayEventRecorderBase {
 ...
 private:
  ...
  std::vector<rpc::events::RayEvent> buffer_ ABSL_GUARDED_BY(mutex_);
