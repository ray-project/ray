...
void RayJobEventRecorder::ConvertToRayEvent(const rpc::JobTableData &data,
  ...
  driver_job_event.mutable_driver_address()->CopyFrom(data.driver_address());
  driver_job_event.mutable_start_time()->CopyFrom(
      AbslTimeNanosToProtoTimestamp(data.start_time()));
  driver_job_event.mutable_end_time()->CopyFrom(
      AbslTimeNanosToProtoTimestamp(data.end_time()));
  ...
  *ray_event.mutable_driver_job_event() = std::move(driver_job_event);
  ...
  ray_event.mutable_timestamp()->CopyFrom(AbslTimeNanosToProtoTimestamp(
