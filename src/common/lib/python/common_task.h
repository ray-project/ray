...
class TaskInterface {
 public:
  ...
  virtual PyObject *to_py_string() = 0;
  ...
  virtual void to_serialized_flatbuf(
      flatbuffers::FlatBufferBuilder &fbb,
      std::vector<ray::ObjectID> execution_dependencies) = 0;
  virtual void to_submit_message(
      flatbuffers::FlatBufferBuilder &fbb,
...
class NonRayletTask : public TaskInterface {
 public:
  NonRayletTask(UniqueID &driver_id,
