...
///     [function_id]]. Function_id is optional for python.
...
class FunctionDescriptor {
 public:
    ...
    FunctionDescriptor(const ray::FunctionID &function_id = ray::FunctionID::nil())
      : string_vec_(3) {
    ...
    /// \param function_id The function_id to use (optional).
    FunctionDescriptor(const std::string &name1, const std::string &name2,
    ...
    void SetDescriptorVector(const std::vector<std::string>& function_descriptor_vec) {
