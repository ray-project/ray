...
if [[ "$PYTHON" == "2.7" ]] && [[ "$platform" == "linux" ]]; then
  ...
  sudo pip install cloudpickle funcsigs click colorama psutil redis tensorflow flatbuffers jupyter
  ...
  pip install numpy cloudpickle funcsigs click colorama psutil redis tensorflow flatbuffers jupyter
  ...
  sudo pip install numpy cloudpickle funcsigs click colorama psutil redis tensorflow flatbuffers jupyter --ignore-installed six
