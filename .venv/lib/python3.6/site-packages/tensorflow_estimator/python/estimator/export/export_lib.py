...
from tensorflow_estimator.python.estimator.export.export_output import ClassificationOutput
from tensorflow_estimator.python.estimator.export.export_output import ExportOutput
from tensorflow_estimator.python.estimator.export.export_output import PredictOutput
from tensorflow_estimator.python.estimator.export.export_output import RegressionOutput
