...
void LocalModeObjectStore::PutRaw(std::shared_ptr<msgpack::sbuffer> data, ObjectID *object_id) {
   PutRaw(data, (const ObjectID)(*object_id));
}

void LocalModeObjectStore::PutRaw(std::shared_ptr<msgpack::sbuffer> data, const ObjectID &object_id) {
