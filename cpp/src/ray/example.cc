...
int main(int argc, char **argv) {
  ...
  std::cout << "task_result4="<< task_result4<<", task_result5=" << task_result5<< std::endl;
  ...
  std::cout << "result11="<<result11<<", result12="<<result12<<", result13="<<result13<<", result14="<<result14<<", result15="<<result15<<", result16="<<result16<<std::endl;
  Ray::Shutdown();
  return 0;
}
