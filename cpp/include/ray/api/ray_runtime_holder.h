...
struct RayRuntimeHolder {
  ...
  void Init(std::shared_ptr<ray::runtime::RayRuntime> runtime) { runtime_ = runtime; }

  std::shared_ptr<ray::runtime::RayRuntime> Runtime() { return runtime_; }
 ...
 private:
  ...
  std::shared_ptr<ray::runtime::RayRuntime> runtime_;
};

inline static std::shared_ptr<ray::runtime::RayRuntime> GetRayRuntime() {
