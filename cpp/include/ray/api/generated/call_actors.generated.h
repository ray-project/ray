...
template <typename R, typename O, typename T1>
static RayObject<R> call(ActorFunc1<O, R, T1> actorFunc, RayActor<O> &actor, RayObject<T1> &arg1);

// 2 args
template <typename R, typename O, typename T1, typename T2>
static RayObject<R> call(ActorFunc2<O, R, T1, T2> actorFunc, RayActor<O> &actor, T1 arg1, T2 arg2);

template <typename R, typename O, typename T1, typename T2>
static RayObject<R> call(ActorFunc2<O, R, T1, T2> actorFunc, RayActor<O> &actor, RayObject<T1> &arg1,
                         T2 arg2);
