...
interface ActorCall<A> {
  ...
  default <T0, T1, R> ActorTaskCaller<R> task(
  ...
  default <T0, T1> VoidActorTaskCaller task(
      RayFuncVoid3<A, T0, T1> f, ObjectRef<T0> t0, ObjectRef<T1> t1) {
    Object[] args = new Object[] {t0, t1};
    return new VoidActorTaskCaller((ActorHandle) this, f, args);
  }

  default <T0, T1, T2, R> ActorTaskCaller<R> task(
  ...
  default <T0, T1, T2> VoidActorTaskCaller task(
  ...
  default <T0, T1, T2, T3, R> ActorTaskCaller<R> task(
  ...
  default <T0, T1, T2, T3> VoidActorTaskCaller task(
  ...
  default <T0, T1, T2, T3, T4, R> ActorTaskCaller<R> task(
  ...
  default <T0, T1, T2, T3, T4> VoidActorTaskCaller task(
