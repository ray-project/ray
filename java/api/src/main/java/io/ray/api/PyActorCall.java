...
interface PyActorCall {
  ...
  default <R> PyActorTaskCaller<R> task(
      PyActorMethod<R> pyActorMethod, Object obj0, Object obj1, Object obj2) {
    Object[] args = new Object[] {obj0, obj1, obj2};
    return new PyActorTaskCaller<>((PyActorHandle) this, pyActorMethod, args);
  }

  default <R> PyActorTaskCaller<R> task(
      PyActorMethod<R> pyActorMethod, Object obj0, Object obj1, Object obj2, Object obj3) {
    Object[] args = new Object[] {obj0, obj1, obj2, obj3};
    return new PyActorTaskCaller<>((PyActorHandle) this, pyActorMethod, args);
  }

  default <R> PyActorTaskCaller<R> task(
      PyActorMethod<R> pyActorMethod,
      Object obj0,
      Object obj1,
      Object obj2,
      Object obj3,
