 ...
 */
public class RayletLocalSchedulerClient implements LocalSchedulerLink {

  public RayletLocalSchedulerClient(String rayletSockName, UniqueID clientId, UniqueID actorId,
      boolean isWorker, long numGpus) {
    _client = _init(rayletSockName, clientId.getBytes(), actorId.getBytes(), isWorker,
        numGpus);
  }
  ...
  native private static long _init(String rayletSockName, byte[] workerId, byte[] actorId,
      boolean isWorker, long numGpus);
