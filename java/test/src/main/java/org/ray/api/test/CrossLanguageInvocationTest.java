...
public class CrossLanguageInvocationTest extends BaseMultiLanguageTest {
  ...
  public void testCallingPythonFunction() {
    RayObject res = Ray.call(
        new PyRemoteFunction(PYTHON_MODULE, "py_func", Object.class),
        "hello".getBytes());
  ...
  public void testPythonCallJavaFunction() {
    RayObject res = Ray.call(
        new PyRemoteFunction(PYTHON_MODULE, "py_func_call_java_function", Object.class),
        "hello".getBytes());
  ...
  public void testCallingPythonActor() {
    ...
    RayObject res = actor.call(new PyActorMethod("increase", Object.class), "1".getBytes());
  ...
  public void testPythonCallJavaActor() {
    RayObject res = Ray.call(
        new PyRemoteFunction(PYTHON_MODULE, "py_func_call_java_actor", Object.class),
        "1".getBytes());
  ...
  public void testPassActorHandleFromPythonToJava() {
    ...
    RayObject res = Ray.call(
        new PyRemoteFunction(PYTHON_MODULE, "py_func_pass_python_actor_handle", Object.class));
