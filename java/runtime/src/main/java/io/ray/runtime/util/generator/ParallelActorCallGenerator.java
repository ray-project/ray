...
public class ParallelActorCallGenerator extends BaseGenerator {
  ...
  private String generateRayCallDotJava() {
    ...
    newLine("");
    newLine("package io.ray.api.utils.parallelactor;");
    newLine("");
    newLine("import io.ray.api.utils.parallelactor.ParallelActor;");
    newLine("import io.ray.api.utils.parallelactor.ParallelActorCreator;");
  ...
  private String generateActorCallDotJava() {
    ...
    newLine("import io.ray.api.ObjectRef;");
    newLine("import io.ray.api.utils.parallelactor.ParallelActor;");
    newLine("import io.ray.api.utils.parallelactor.ParallelActorTaskCaller;");
    newLine("import io.ray.api.utils.parallelactor.VoidParallelActorTaskCaller;");
  ...
  private void buildCalls(
    ...
    String callFunc = forActorCreation ? "parallelActor" : "task";
    String caller;
    if (forActorCreation) {
  ...
  public static void main(String[] args) throws IOException {
    String path = System.getProperty("user.dir") + "/api/src/main/java/io/ray/api/utils/parallelactor/ParallelCall.java";
    FileUtils.write(
        new File(path), new ParallelActorCallGenerator().generateRayCallDotJava(), Charset.defaultCharset());
    path = System.getProperty("user.dir") + "/api/src/main/java/io/ray/api/utils/parallelactor/ParallelActorCall.java";
    FileUtils.write(
        new File(path),
