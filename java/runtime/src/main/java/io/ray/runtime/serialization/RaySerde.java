...
public final class RaySerde {
   ...
   *     `bufferCallback` of a Serde object. If <code>outOfBandBuffers</code> is null (the default),
  ...
  public static final class SerdeBuilder {
    ...
    public SerdeBuilder withClassLoader(ClassLoader classLoader) {
      this.classLoader = classLoader;
      return this;
    }

    public SerdeBuilder withClassVersionCheck(boolean checkClassVersion) {
      this.checkClassVersion = checkClassVersion;
      return this;
    }

    public SerdeBuilder withJdkClassSerializableCheck(boolean jdkClassSerializableCheck) {
