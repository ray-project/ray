...
docker build --progress=plain --build-arg DOCKER_IMAGE_BASE_BUILD=python:3.9 \
    -t "$RAYCI_WORK_REPO":"$RAYCI_BUILD_ID"-run_release_test \
    -f anyscale/ci/release_run_release_test.Dockerfile "$INSTALLATION"
