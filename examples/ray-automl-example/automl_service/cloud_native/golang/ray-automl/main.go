...
import (
	...
	"github.com/ray-automl/controllers"
...
func init() {
	...
	utilruntime.Must(automlv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "82d4c1d3.my.domain",
	...
	if err = (&controllers.TrainerReconciler{
		...
		Log:    mgr.GetLogger().WithName("trainer-controller"),
	...
	if err = (&controllers.ProxyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Log:    mgr.GetLogger().WithName("proxy-controller"),
	}).SetupWithManager(mgr); err != nil {
