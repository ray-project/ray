...
def example_multi_node_deployment():
    ...
    print('  -d \'{"model": "llama-7b-pack", "prompt": "The future of AI is", "max_tokens": 50}\'')
    ...
    print("This deployment prioritizes fault tolerance by spreading workers across nodes.")
...
def example_comparison_with_defaults():
    ...
    print(f"  Strategy: {default_options['placement_group_strategy']}")  # Should be PACK
