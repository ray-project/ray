...
class ComponentFailureTest(unittest.TestCase):
    ...
    def testLocalSchedulerFailed(self):
        ...
        self.check_components_alive(
            ray.services.PROCESS_TYPE_PLASMA_STORE, True
        )
        self.check_components_alive(
            ray.services.PROCESS_TYPE_PLASMA_MANAGER, True
        )
        self.check_components_alive(
            ray.services.PROCESS_TYPE_LOCAL_SCHEDULER, False
        )
    ...
    def testPlasmaManagerFailed(self):
        ...
        self.check_components_alive(
            ray.services.PROCESS_TYPE_PLASMA_MANAGER, False
        )
        self.check_components_alive(
            ray.services.PROCESS_TYPE_LOCAL_SCHEDULER, False
        )
    ...
    def testPlasmaStoreFailed(self):
        ...
        self.check_components_alive(
            ray.services.PROCESS_TYPE_PLASMA_STORE, False
        )
        self.check_components_alive(
            ray.services.PROCESS_TYPE_PLASMA_MANAGER, False
        )
