"""Tensor transport utility functions.

The transport registry stays in Python because tests inspect module-level
globals (transport_manager_info, transport_managers, etc.) directly.
RDTStore is the high-value Rust port (GIL-free blocking waits).
"""
