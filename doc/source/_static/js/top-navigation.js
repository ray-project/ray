...
let is_examples = window.location.href.endsWith("ray-overview/examples.html")
let is_get_started = window.location.href.endsWith("ray-overview/getting-started.html")
let is_use_cases = window.location.href.endsWith("ray-overview/use-cases.html")
let is_libraries = window.location.href.includes("/ray-core/") ||
...
let is_ecosystem = window.location.href.endsWith("ray-overview/ray-libraries.html")
let is_documentation = !(is_get_started || is_use_cases || is_examples || is_libraries || is_ecosystem)
...
examplesLink.setAttribute("href", getNavURL("ray-overview/examples.html"))
