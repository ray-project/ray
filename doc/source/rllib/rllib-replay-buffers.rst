...
A more extensive example is `our implementation <replay-buffers.html#ray-rllib-utils-replay-buffers-reservoir-replay-buffer>`__ of `reservoir sampling <https://www.cs.umd.edu/~samir/498/vitter.pdf>`__, the :py:class:`~ray.rllib.utils.replay_buffers.reservoir_replay_buffer.ReservoirReplayBuffer`.
