...
``ignore_worker_failures``: When set to True, your Algorithm will not crash due to a single worker error, but to continue for as long as there is at least one functional worker remaining.
