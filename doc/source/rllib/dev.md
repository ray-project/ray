...
* Fully integrated Algorithms have the following additional requirements:
    ...
    - should include at least one [tuned hyperparameter example](https://github.com/ray-project/ray/tree/master/rllib/examples/algorithms), testing of which is part of the CI
