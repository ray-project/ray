...
This example utilizes RLlib's
:py:class:`~ray.rllib.utils.metrics.metrics_logger.MetricsLogger` API to log the custom computations
of the injected code. Read :ref:`more about the MetricsLogger API here <rllib-metric-logger-docs>`__.
