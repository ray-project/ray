...
myst:
  html_meta:
    description: "API reference for RLlib's callback APIs, covering the RLlibCallback class and the callbacks invoked in Algorithm and EnvRunner actors."
---

(rllib-callback-reference-docs)=
...
(rllib-callback-reference-algorithm-bound)=
...
(rllib-callback-reference-env-runner-bound)=
