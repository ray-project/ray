...
myst:
  html_meta:
    description: "API reference for RLlib's Algorithm class, the top-level entry point for training, evaluating, checkpointing, and restoring reinforcement learning policies."
---
...
[See here for an example on how to override Algorithm](https://github.com/ray-project/ray/blob/master/rllib/algorithms/ppo/ppo.py).
