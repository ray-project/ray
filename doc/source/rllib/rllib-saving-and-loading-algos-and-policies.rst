...
.. literalinclude:: ../../../rllib/examples/documentation/saving_and_loading_algos_and_rl_modules.py
    :language: python
...
.. literalinclude:: ../../../rllib/examples/documentation/saving_and_loading_algos_and_rl_modules.py
    :language: python
    :start-after: __export-rlm-1-begin__
    :end-before: __export-rlm-1-end__

2) Via the Algorithm (Policy) checkpoint:

.. literalinclude:: ../../../rllib/examples/documentation/saving_and_loading_algos_and_rl_modules.py
    :language: python
    :start-after: __export-rlm-2-begin__
    :end-before: __export-rlm-2-end__
