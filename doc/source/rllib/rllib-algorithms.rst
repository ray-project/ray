...
`SlateQ`_                   tf + torch **Yes** (multi-disr. slates) No                 No                                                                        torch
...
`UCB Bandit on RecSim <https://github.com/ray-project/ray/blob/master/rllib/agents/bandit/tests/tune_lin_ucb_train_recsim.py>`__.
