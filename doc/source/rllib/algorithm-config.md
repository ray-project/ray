...
and then call some of its methods to set various configuration options. RLlib uses the following [black](https://github.com/psf/black)-compliant format
...
If you are working with [Ray Tune](https://docs.ray.io/en/latest/tune/index.html),
...
:::{tip}
Install both [Atari](https://ale.farama.org/environments/) and
[MuJoCo](https://gymnasium.farama.org/environments/mujoco) to be able to run
...
Set the [RL discount factor](https://www.envisioning.io/vocab/discount-factor?utm_source=chatgpt.com)
...
[RLlib's examples folder](https://github.com/ray-project/ray/tree/master/rllib/examples) or take a look at this
