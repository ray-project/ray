...
`examples folder <https://github.com/ray-project/ray/tree/master/python/ray/rllib/examples>`__
...
Folder structure
----------------
The `examples folder <https://github.com/ray-project/ray/tree/master/python/ray/rllib/examples>`__ has
...
- `Auto-regressive actions <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/actions/autoregressive_actions.py>`__:
...
- `Custom action distribution class <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/actions/custom_action_distribution.py>`__:
...
- `Nested Action Spaces <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/actions/nested_action_spaces.py>`__:
...
- `Custom implementation of the Model-Agnostic Meta-Learning (MAML) algorithm <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/maml_lr_supervised_learning.py>`__:
...
- `Custom "vanilla policy gradient" (VPG) algorithm <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/vpg_custom_algorithm.py>`__:
...
- `Custom algorithm with a global, shared data actor for sending manipulated rewards from EnvRunners to Learners <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/appo_custom_algorithm_w_shared_data_actor.py>`__:
...
- `Checkpoint by custom criteria <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/checkpoints/checkpoint_by_custom_criteria.py>`__:
...
- `Continue training from checkpoint <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/checkpoints/continue_training_from_checkpoint.py>`__:
...
- `Restore 1 out of N agents from checkpoint <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/checkpoints/restore_1_of_n_agents_from_checkpoint.py>`__:
...
- `Flatten and one-hot observations <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/flatten_observations_dict_space.py>`__:
...
- `Mean/Std filtering <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/mean_std_filtering.py>`__:
...
- `Multi-agent observation preprocessor enhancing non-Markovian observations to Markovian ones <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/multi_agent_observation_preprocessor.py>`__:
...
- `Prev-actions, prev-rewards connector <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/prev_actions_prev_rewards.py>`__:
...
- `Single-agent observation preprocessor <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/single_agent_observation_preprocessor.py>`__:
...
- `Count-based curiosity <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/curiosity/count_based_curiosity.py>`__:
...
- `Euclidean distance-based curiosity <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/curiosity/euclidian_distance_based_curiosity.py>`__:
...
- `Intrinsic-curiosity-model (ICM) Based Curiosity <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/curiosity/intrinsic_curiosity_model_based_curiosity.py>`__:
...
- `Custom env rendering method <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/curriculum/curriculum_learning.py>`__:
...
- `Curriculum learning for Atari Pong <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/curriculum/pong_curriculum_learning.py>`__:
...
- `Deterministic sampling and training <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/debugging/deterministic_sampling_and_training.py>`__:
...
- `Async gym vectorization, parallelizing sub-environments <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/async_gym_env_vectorization.py>`__:
...
- `Custom env rendering method <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/custom_env_render_method.py>`__:
   Demonstrates how to add a custom `render()` method to a (custom) environment, allowing visualizations of agent interactions.

- `Custom gymnasium env <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/custom_gym_env.py>`__:
...
- `Env connecting to RLlib through a tcp client <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/env_connecting_to_rllib_w_tcp_client.py>`__:
...
- `Env rendering and recording <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/env_rendering_and_recording.py>`__:
...
- `Env with protobuf observations <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/envs/env_w_protobuf_observations.py>`__:
...
- `Custom evaluation <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/evaluation/custom_evaluation.py>`__:
...
- `Evaluation parallel to training <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/evaluation/evaluation_parallel_to_training.py>`__:
...
- `Crashing and stalling env <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/fault_tolerance/crashing_and_stalling_env.py>`__:
...
- `Float16 training and inference <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/gpus/float16_training_and_inference.py>`__:
...
- `Fractional GPUs per Learner <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/gpus/fractional_gpus_per_learner.py>`__:
...
- `Mixed precision training and float16 inference <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/gpus/mixed_precision_training_float16_inference.py>`__:
...
- `Using GPUs on EnvRunners <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/gpus/gpus_on_env_runners.py>`__:
...
- `Hierarchical RL training <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/hierarchical/hierarchical_training.py>`__:
...
- `Policy inference after training <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/inference/policy_inference_after_training.py>`__:
...
- `Policy inference after training, with ConnectorV2 <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/inference/policy_inference_after_training_w_connector.py>`__:
...
- `Custom loss function, simple <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/learners/ppo_with_custom_loss_fn.py>`__:
...
- `Custom torch learning rate schedulers <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/learners/ppo_with_torch_lr_schedulers.py>`__:
...
- `Separate learning rate and optimizer for value function <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/learners/separate_vf_lr_and_optimizer.py>`__:
...
- `Logging custom metrics in Algorithm.training_step <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/metrics/custom_metrics_in_algorithm_training_step.py>`__:
...
- `Logging custom metrics in EnvRunners <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/metrics/custom_metrics_in_env_runners.py>`__:
...
- `Custom heuristic policy <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/custom_heuristic_policy.py>`__:
...
- `Different observation- and action spaces for different agents <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/different_spaces_for_agents.py>`__:
   ...
   `here <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/connectors/multi_agent_observation_preprocessor.py>`__.

- `Grouped agents, two-step game <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/two_step_game_with_grouped_agents.py>`__:
...
- `Multi-agent CartPole <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/multi_agent_cartpole.py>`__:
...
- `Multi-agent Pendulum <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/multi_agent_pendulum.py>`__:
...
- `PettingZoo independent learning <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/pettingzoo_independent_learning.py>`__:
...
- `PettingZoo parameter sharing <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/pettingzoo_parameter_sharing.py>`__:
   Uses `PettingZoo <https://pettingzoo.farama.org/>`__ for an environment where all agents share a single policy.

- `Rock-paper-scissors heuristic vs learned <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/rock_paper_scissors_heuristic_vs_learned.py>`__:
...
- `Rock-paper-scissors learned vs learned <https://github.com/ray-project/ray/tree/master/python/ray/rllib/examples/multi_agent/rock_paper_scissors_learned_vs_learned.py>`__:
...
- `Self-play, league-based, with OpenSpiel <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/self_play_league_based_with_open_spiel.py>`__:
...
- `Self-play with Footsies and PPO algorithm <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/ppo/multi_agent_footsies_ppo.py>`__:
...
- `Self-play with OpenSpiel <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/multi_agent/self_play_with_open_spiel.py>`__:
...
- `Train with behavioral cloning (BC), Finetune with PPO <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/offline_rl/train_w_bc_finetune_w_ppo.py>`__:
...
- `Using Ray Serve with RLlib <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/ray_serve/ray_serve_with_rllib.py>`__:
...
- `Custom experiment <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/ray_tune/custom_experiment.py>`__:
...
- `Custom logger <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/ray_tune/custom_logger.py>`__:
...
- `Custom progress reporter <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/ray_tune/custom_progress_reporter.py>`__:
...
- `Action masking <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/action_masking_rl_module.py>`__:
...
- `Custom CNN-based RLModule <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/custom_cnn_rl_module.py>`__:
...
- `Migrate ModelV2 to RLModule by config <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/migrate_modelv2_to_new_api_stack_by_config.py>`__:
...
- `Migrate ModelV2 to RLModule by Policy Checkpoint <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/migrate_modelv2_to_new_api_stack_by_policy_checkpoint.py>`__:
...
- `Pretrain single-agent policy, then train in multi-agent Env <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/rl_modules/pretraining_single_agent_training_multi_agent.py>`__:
...
The `tuned examples <https://github.com/ray-project/ray/tree/master/python/ray/rllib/examples/algorithms>`__ folder
...
For example, see this `tuned Atari example for PPO <https://github.com/ray-project/ray/blob/master/python/ray/rllib/examples/algorithms/ppo/atari_ppo.py>`__,
