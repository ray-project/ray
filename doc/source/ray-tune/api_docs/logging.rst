...
An example of creating a custom logger can be found in :doc:`/ray-tune/examples/logging_example`.
...
You can see the :doc:`tutorial here </ray-tune/tutorials/tune-mlflow>`.

WandbLogger
-----------

Tune also provides a default logger for `Weights & Biases <https://www.wandb.ai/>`_. You can install Wandb via ``pip install wandb``.
You can see the :doc:`tutorial here </ray-tune/tutorials/tune-wandb>`
