...
If you specify an explicit Search Algorithm, you may not be able to use this functionality, as the algorithm may require a different search space declaration.
