...
-  `Resource-aware scheduling <tune-config.html#resource-allocation>`__, including support for concurrent runs of algorithms that may themselves be parallel and distributed.
