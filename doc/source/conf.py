...
# If we do not set this environment variable, we will copy autogenerated
# gallery files to a target directory. This creates a new file hash,
# which then triggers rebuild.
# If you set this environment variable, building can be faster,
# but
if os.environ.get("SPHINX_BUILD_FAST"):
    print("SPHINX_BUILD_FAST=1 detected. Gallery files may be stale. ")
else:
