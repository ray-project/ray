...
exclude_patterns = [
    ...
    # Exclude README.md for examples that have both .md and .ipynb
    "ray-overview/examples/e2e-audio/README.md",
    "ray-overview/examples/e2e-multimodal-ai-workloads/README.md",
    "ray-overview/examples/e2e-rag/README.md",
    "ray-overview/examples/e2e-timeseries/README.md",
    "ray-overview/examples/e2e-xgboost/README.md",
    "ray-overview/examples/entity-recognition-with-llms/README.md",
    "ray-overview/examples/mcp-ray-serve/README.md",
    "ray-overview/examples/object-detection/README.md",
    "ray-overview/examples/langchain_agent_ray_serve/content/README.md",
    "ray-overview/examples/langchain_agent_ray_serve/README.md",
    # Note: agentic-batch-inference only has README.md (no .ipynb), so it's NOT excluded
    ...
    "ray-overview/examples/llamafactory-llm-fine-tune/README.md",
