...
.. autoclass:: ray.tune.search.searcher.ax.AxSearch
...
.. autoclass:: ray.tune.search.searcher.bayesopt.BayesOptSearch
...
.. autoclass:: ray.tune.search.searcher.bohb.TuneBOHB
...
.. autoclass:: ray.tune.search.searcher.flaml.BlendSearch
...
.. autoclass:: ray.tune.search.searcher.flaml.CFO
...
.. autoclass:: ray.tune.search.searcher.dragonfly.DragonflySearch
  :members: save, restore
...
.. autoclass:: ray.tune.search.searcher.hebo.HEBOSearch
  :members: save, restore
...
.. autoclass:: ray.tune.search.searcher.hyperopt.HyperOptSearch
  :members: save, restore
...
.. autoclass:: ray.tune.search.searcher.nevergrad.NevergradSearch
  :members: save, restore
...
.. autoclass:: ray.tune.search.searcher.optuna.OptunaSearch
...
.. autoclass:: ray.tune.search.searcher.sigopt.SigOptSearch
...
.. autoclass:: ray.tune.search.searcher.skopt.SkOptSearch
  :members: save, restore
...
.. autoclass:: ray.tune.search.searcher.zoopt.ZOOptSearch
  :members: save, restore
...
Use ``ray.tune.search.searcher.Repeater`` to average over multiple evaluations of the same
...
.. autoclass:: ray.tune.search.searcher.Repeater
...
Use ``ray.tune.search.searcher.ConcurrencyLimiter`` to limit the amount of concurrency when using a search algorithm.
This is useful when a given optimization algorithm does not parallelize very well (like a naive Bayesian Optimization).

.. autoclass:: ray.tune.search.searcher.ConcurrencyLimiter
...
.. autoclass:: ray.tune.search.searcher.Searcher
    :members:
    :private-members:
    :show-inheritance:
