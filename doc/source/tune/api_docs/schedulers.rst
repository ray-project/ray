...
An example of this can be found here: :doc:`/tune/examples/async_hyperband_example`.
...
You can run this :doc:`toy PBT example </tune/examples/pbt_function>` to get an idea of how how PBT operates.
...
With that in mind, you can run this :doc:`PB2 PPO example </tune/examples/pb2_ppo_example>` to compare PB2 vs. PBT,
