...
- :doc:`/ray-air/examples/dolly_v2_deepspeed_instruction_fine_tuning`: How to use Ray AIR to run Hugging Face Transformers with DeepSpeed for instruction fine-tuning a large model.
