...
For further information about complex observation spaces, see:
  ...
  * The pydoc of the `Repeated space <https://github.com/ray-project/ray/blob/master/rllib/models/extra_spaces.py>`__.
