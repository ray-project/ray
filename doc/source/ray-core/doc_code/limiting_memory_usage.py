...
first_actor = MemoryHogger.options(
    max_restarts=1, max_task_retries=1, name="first_actor", num_cpus=2
).remote()
second_actor = MemoryHogger.options(
    max_restarts=0, max_task_retries=0, name="second_actor", num_cpus=2
).remote()
...
first_actor = MemoryHogger.options(
    max_restarts=1, max_task_retries=1, name="first_actor", memory=allocate_bytes
).remote()
second_actor = MemoryHogger.options(
    max_restarts=0, max_task_retries=0, name="second_actor", memory=allocate_bytes
).remote()
