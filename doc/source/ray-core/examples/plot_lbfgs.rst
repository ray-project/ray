...
.. _`code for this example`: https://github.com/ray-project/ray/tree/master/doc/source/ray-core/examples/lbfgs

Then you can run the example as follows.

.. code-block:: bash

  python ray/doc/source/ray-core/examples/lbfgs/driver.py
