...
Ray also provides several mechanisms to automatically recover from internal system-level failures.
...
and in the :ref:`global control service <fault-tolerance-gcs>`, which handles cluster-wide metadata.
