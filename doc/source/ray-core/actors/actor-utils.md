...
Sometimes just using one signal to synchronize is not enough. If you need to send data among many tasks or actors, you can use {class}`ray.util.queue.Queue <ray.util.queue.Queue>`.
