...
`{session_dir}/{port_name}_{node_id_hex}` (see [port_persistence.h](https://github.com/ray-project/ray/blob/master/src/ray/util/port_persistence.h)).
...
[NodeManager::HandleClientConnectionError](https://github.com/ray-project/ray/blob/10869d565047ae02b398802e1efaf04109f27249/src/ray/raylet/node_manager.h), which returns the port to the queue and starts a new worker.
...
is registered to GCS via [GcsActorManager::HandleRegisterActor](https://github.com/ray-project/ray/blob/10869d565047ae02b398802e1efaf04109f27249/src/ray/gcs/gcs_actor_manager.h).
