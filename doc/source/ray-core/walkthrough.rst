...
.. note::
  ...
  In recent versions of Ray (>=1.5), ``ray.init()`` is automatically called on the first use of a Ray remote API, though it's still considered a best practice to call it explicitly.
