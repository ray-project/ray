.. _ray-dashboard-legacy:

Ray Dashboard (Legacy)
======================

.. note::

    This is the documentation for the legacy ray dashboard. To view the docs for the new ray dashboard, visit :ref:`here<ray-dashboard>`.
