...
You can also configured trainers with :ref:`Datasets <training_ingest_home>` and :ref:`Preprocessors <air-preprocessors>` for scalable data ingest and preprocessing.
