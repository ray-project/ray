...
Trainers can also be configured with :ref:`Datasets <training_ingest_home>` and :ref:`Preprocessors <air-preprocessors>` for scalable data ingest and preprocessing.
