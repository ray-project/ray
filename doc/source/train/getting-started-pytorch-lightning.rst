...
3. Configure :ref:`scaling <train-overview-scaling-config>` and CPU, GPU, or :ref:`other accelerator <using-gpus-or-other-accelerators>` resource requirements for a training job.
