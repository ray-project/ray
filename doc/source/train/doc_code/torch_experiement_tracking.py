...
# __native_experiment_tracking_wandb_start__
...
trainer.fit()
# __native_experiment_tracking_wandb_end__

# __native_experiment_tracking_mlflow_file_start__
...
trainer.fit()
# __native_experiment_tracking_mlflow_file_end__
