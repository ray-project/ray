...
Distributed training jobs can fail for a number of reasons, including
node failure (for instance when spot instances get preempted) or
network errors.

Ray Train comes with utilities and configurations to deal with such errors.
