...
[Plan TPUs in GKE](https://cloud.google.com/kubernetes-engine/docs/concepts/plan-tpus).
...
PyTorch Distributed supports multiple [backends](https://pytorch.org/docs/stable/distributed.html#backends)
...
[NCCL_SOCKET_IFNAME](https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/env.html#nccl-socket-ifname)
