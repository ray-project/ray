...
The Ray Train dashboard also displays several metrics exported by Ray Core. For more information on these metrics, see the :ref:`System Metrics docs<system-metrics>`.
