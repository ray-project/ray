...
.. list-table::
    ...
    * - :class:`TransformersTrainer <ray.train.huggingface.transformers.TransformersTrainer>`
      - :class:`TransformersCheckpoint <ray.train.huggingface.transformers.TransformersCheckpoint>`
      - :class:`TransformersPredictor <ray.train.huggingface.transformers.TransformersPredictor>`
