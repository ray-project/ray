...
.. list-table::
    ...
    * - :class:`TransformersTrainer <ray.train.transformers.TransformersTrainer>`
      - :class:`TransformersCheckpoint <ray.train.transformers.TransformersCheckpoint>`
      - :class:`TransformersPredictor <ray.train.transformers.TransformersPredictor>`
