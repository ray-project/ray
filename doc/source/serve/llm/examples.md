...
- {doc}`Deploy NVIDIA Nemotron Super 120B </_collections/serve/tutorials/deployment-serve-llm/nemotron-3-super-120b/README>`: deploy NVIDIA's 120B-total, 12B-active hybrid model for agentic and long-context reasoning workloads.
