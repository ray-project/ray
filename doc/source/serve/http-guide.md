...
```{literalinclude} doc_code/proxy_guide/http_guide.py
...
```{literalinclude} doc_code/proxy_guide/websockets_example.py
...
```{literalinclude} doc_code/proxy_guide/streaming_example.py
