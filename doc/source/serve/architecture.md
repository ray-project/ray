...
- When using Kuberay ({ref}`kuberay-index`), the Kuberay Operator will recover crashed nodes or a crashed cluster.  Cluster crashes can be avoided using the [GCS HA feature](https://ray-project.github.io/kuberay/guidance/gcs-ha/).
