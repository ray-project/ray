...
To see an example of deploying a purely reasoning model like *QwQ-32&nbsp;B*, see [Deploying a reasoning LLM](https://docs.ray.io/en/master/serve/tutorials/deployment-serve-llm/reasoning-llm/README.html).
