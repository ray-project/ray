...
| `ray_serve_replica_reconfigure_latency_ms` | Histogram | `deployment`, `replica`, `application` | Time for replica to complete reconfigure in milliseconds. Useful for debugging slow reconfiguration and model loading time. |
