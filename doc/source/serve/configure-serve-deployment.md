...
- `autoscaling_config` - Parameters to configure autoscaling behavior. If this is set, `num_replicas` cannot be set. For more details on configurable parameters for autoscaling - [Ray Serve Autoscaling](serve-autoscaling). 
