...
For example, to install kubectl plugin version 1.5.1 on Linux amd64:
...
See https://github.com/ray-project/kuberay/blob/v1.5.1/kubectl-plugin/config/samples/create-cluster.complete.yaml for the complete list of parameters that you can set in the config file.
