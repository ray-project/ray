...
# rayservice-no-ray-serve-replica   Running          1
...
Update the price of Mango from `3` to `4` for the fruit stand app in [ray-service.no-ray-serve-replica.yaml](https://github.com/ray-project/kuberay/blob/v1.3.0/ray-operator/config/samples/ray-service.no-ray-serve-replica.yaml). 
