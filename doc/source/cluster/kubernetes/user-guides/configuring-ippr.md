...
* **Kubernetes 1.35 or later.** In-Place Pod Resize graduated to GA in Kubernetes 1.35. See [kubernetes/enhancements#5562](https://github.com/kubernetes/enhancements/pull/5562).
