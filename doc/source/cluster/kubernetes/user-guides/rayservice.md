...
```sh
curl -O https://raw.githubusercontent.com/ray-project/kuberay/v1.4.0/ray-operator/config/samples/ray-service.sample.yaml
...
Update the price of Mango from `3` to `4` for the fruit stand app in [ray-service.sample.yaml](https://github.com/ray-project/kuberay/blob/v1.4.0/ray-operator/config/samples/ray-service.sample.yaml). 
