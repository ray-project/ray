...
### Instructions
```sh
# Step 1: Install KubeRay operator and CRDs
...
curl -LO https://raw.githubusercontent.com/ray-project/kuberay/v1.4.0/ray-operator/config/samples/ray-cluster.separate-ingress.yaml
