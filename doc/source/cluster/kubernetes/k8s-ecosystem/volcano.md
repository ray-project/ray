...
helm install kuberay-operator kuberay/kuberay-operator --version 1.4.0 --set batchScheduler.name=volcano
```
...
curl -LO https://raw.githubusercontent.com/ray-project/kuberay/v1.4.0/ray-operator/config/samples/ray-cluster.volcano-scheduler.yaml
...
curl -LO https://raw.githubusercontent.com/ray-project/kuberay/v1.4.0/ray-operator/config/samples/ray-cluster.volcano-scheduler-queue.yaml
