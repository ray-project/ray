...
* Ray job configuration
  ...
  * `backoffLimit` (Optional, added in version 1.2.0): Specifies the number of retries before marking this job failed. Each retry creates a new RayCluster. The default value is 0.
