...
.. code-block:: shell
 ...
 $ kubectl -n ray apply -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/operator.yaml
...
.. code-block:: shell
 ...
 $ kubectl -n ray apply -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/example_cluster.yaml
...
.. code-block:: shell
 ...
 $ kubectl -n ray apply -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/example_cluster2.yaml
...
.. code-block:: shell
 ...
 # OR
 $ kubectl -n ray delete -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/example_cluster2.yaml
...
.. code-block:: shell
 ...
 $ kubectl -n ray delete -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/operator.yaml
...
.. code-block:: shell
 ...
 # OR
 $ kubectl delete -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/operator_configs/cluster_crd.yaml
...
.. code-block:: yaml
  ...
  $ kubectl create -f https://github.com/ray-project/ray/raw/master/python/ray/autoscaler/kubernetes/job-example.yaml
