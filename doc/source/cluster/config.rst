...
* **Importance:** High
* **Type:** Integer
* **Default:** cluster-wide :ref:`max_workers <cluster-configuration-max-workers>` (0 if <node_type_name> matches thee cluster's :ref:`head_node_type <cluster-configuration-head-node-type>`)
* **Minimum:** ``0``
