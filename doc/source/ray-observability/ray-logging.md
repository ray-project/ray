...
It is often useful to distinguish between log messages from different actors.
...
When starting a local cluster via the CLI or when starting nodes in a multi-node
