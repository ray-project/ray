...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import summarize_tasks
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_actors 
        print(list_actors())
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import get_actor
        # In this case, 31405554844820381c2f0f8501000000
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import summarize_actors
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import summarize_objects
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_nodes() 
        list_nodes()
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_placement_groups 
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_objects 
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_tasks 
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import get_task 
        get_task(id=<TASK_ID>)
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import get_node 
        get_node(id=<NODE_ID>)
...
.. tabbed:: Python SDK
    ...
    .. code-block:: python
        ...
        from ray.state import list_logs 
