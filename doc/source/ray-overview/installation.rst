...
.. code-block:: bash
    ...
    # Install Ray with support for the dashboard + cluster launcher
    pip install "ray[default] @ https://s3-us-west-2.amazonaws.com/ray-wheels/master/{COMMIT_HASH}/ray-{RAY_VERSION}-{PYTHON_VERSION}-{PYTHON_VERSION}m-{OS_VERSION}.whl"
...
.. code-block:: bash
    ...
    # Install Ray with support for the dashboard + cluster launcher
    pip install "ray[default] @ https://s3-us-west-2.amazonaws.com/ray-wheels/master/ba6cebe30fab6925e5b2d9e859ad064d53015246/ray-3.0.0.dev0-cp37-cp37m-macosx_10_15_intel.whl"
