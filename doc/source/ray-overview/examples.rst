...
.. grid:: 1 2 3 4
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/dragonfly.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/hyperopt.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/bayesopt.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/nevergrad.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/optuna.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
    ...
    .. grid-item-card::
        :class-item: gallery-item sd-shadow-md sd-animate-grow50
        :img-top: /tune/images/sigopt.png
        :class-img-top: pt-2 w-75 d-block mx-auto fixed-height-img
