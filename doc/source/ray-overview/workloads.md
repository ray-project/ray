...
|Using Ray AIR's `BatchPredictor` for batch inference.|
 ...
 See [batch inference examples](../ray-overview/use-cases.html#batch-inference) for use cases.

### Model serving

[Ray Serve](../serve/index.html) supports complex [model deployment patterns](https://www.youtube.com/watch?v=mM4hJLelzSw) requiring the orchestration of multiple Ray actors, where different actors provide inference for different models. Serve handles both batch and online inference and can scale to thousands of models in production.

|<img src="../images/multi_model_serve.png" width="70%" loading="lazy">|
|:--:|
|Deployment patterns with Ray Serve. (Click image to enlarge.)|

See [model serving examples](../ray-overview/use-cases.html#model-serving) for use cases.
...
|Data parallelism pattern for distributed training on large datasets.|
 ...
 See [many model examples](../ray-overview/use-cases.html#many-model-training) for use cases.
...
|Model parallelism pattern for distributed large model training.|
 ...
 See [distributed training examples](../ray-overview/use-cases.html#distributed-training) for use cases.
...
|Distributed tuning with distributed training per trial.|
 ...
 See [hyperparameter tuning examples](../ray-overview/use-cases.html#hyperparameter-tuning) for use cases.
...
|Decentralized distributed proximal polixy optimiation (DD-PPO) architecture.|
 ...
 See [reinforcement learning examples](../ray-overview/use-cases.html#reinforcement-learning) for use cases.
...
See [ML platform examples](../ray-overview/use-cases.html#ml-platform) for use cases.
