...
---------------
Latest ray java release can be found in `ray-api <https://mvnrepository.com/artifact/io.ray>`__. To use latest ray java release in your application, use following entries in your ``pom.xml``:
.. code-block:: xml
    <dependency>
...
Latest ray java snapshot can be found in `sonatype <https://oss.sonatype.org/#nexus-search;quick~io.ray>`__. To use latest ray java snapshot in your application, use following entries in your ``pom.xml``:
.. code-block:: xml
