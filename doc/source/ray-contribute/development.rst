...
<<<<<<< HEAD
- bazel 4.2 (https://github.com/bazelbuild/bazel/releases/tag/4.2.2)
=======
- Bazel 4.2 (https://github.com/bazelbuild/bazel/releases/tag/4.2.1)
>>>>>>> e8440cf52b5d55769e423ca62b8a60ccb9100e3e
...
bazel-4.2.2-windows-x86_64.exe. Copy the exe into the directory of your choice.
=======
4. Bazel 4.2 installation. Go to Bazel 4.2 release web page and download
