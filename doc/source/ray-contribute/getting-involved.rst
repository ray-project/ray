...
To edit the Ray source code, you'll want to fork the repository, clone it and build Ray from source. Follow :ref:`these instructions for building <building-ray>` a local copy of Ray to easily make changes.
