...
* When the tasks section contains the label `[backpressure]`, it indicates that the operator is *backpressured*, meaning that the operator will not submit more tasks until the downstream operator is ready to accept more data.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Depending on your use case, you may not be interested in the full progress bar output, or wish to disable it altogether. Ray Data provides several ways to accomplish this:
...
For operator names longer than a threshold of 100 characters, Ray Data truncates the names by default.
