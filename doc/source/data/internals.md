...
:::{note}
Shuffle v2 (`ShuffleStrategy.SHUFFLE_V2`) is the default shuffle strategy for
...
:::{note}
Hash-shuffle (`ShuffleStrategy.HASH_SHUFFLE`) was the default shuffle strategy for
