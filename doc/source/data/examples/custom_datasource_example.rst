...
natively supported. Images are already supported with the :func:`~ray.data.read_images` 
...
Blocks are PyArrow tables, pandas DataFrames, or dictionaries of NumPy arrays. Don't 
create a block directly. Instead, add rows of data to a  ``DelegatingBlockBuilder``.
