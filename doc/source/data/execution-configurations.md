...
* `verbose_progress`: Whether to report progress individually per operator. By default, Ray Data reports only global progress and progress for AllToAll operators. Use this option for performance debugging. On by default.
