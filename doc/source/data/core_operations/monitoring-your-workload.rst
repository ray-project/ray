...
.. image:: images/dataset-progress-bar.png
   :alt: Ray Data progress bar showing execution progress with operator-level metrics
   :align: center
...
Ray Data emits Prometheus metrics continuously while a Dataset is executing. These metrics are tagged by both dataset and operator, and are displayed in multiple views across the Ray dashboard.
...
.. image:: images/data-overview-table.png
   :alt: Data overview table showing dataset statistics and execution metrics
   :align: center
...
.. image:: images/data-overview-table-expanded.png
   :alt: Expanded data overview table showing detailed operator-level execution statistics
   :align: center
...
.. image:: images/data-dashboard.png
   :alt: Ray Data dashboard showing comprehensive monitoring and observability metrics
   :align: center
