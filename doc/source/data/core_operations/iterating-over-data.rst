...
Data iteration enables you to consume Ray Dataset contents for analysis, model training, or further processing. This guide shows you how to efficiently iterate over dataset rows and batches.

What is data iteration?
-----------------------

Data iteration involves:

* **Row-by-row processing**: Access individual records for detailed analysis
* **Batch processing**: Process multiple records together for efficiency
* **Distributed consumption**: Split datasets across multiple workers
* **Memory-efficient streaming**: Iterate over large datasets without loading everything into memory
* **Framework integration**: Convert data for consumption by ML frameworks

Why iterate over data with Ray Data?
------------------------------------

* **Memory efficiency**: Stream large datasets without memory constraints
* **Flexible consumption**: Choose between row-level and batch-level processing
* **Performance optimization**: Optimize iteration patterns for your specific use case
* **Framework compatibility**: Seamless integration with PyTorch, TensorFlow, and other frameworks
* **Distributed processing**: Automatically distribute iteration across cluster workers

How to iterate over Ray Data
-----------------------------

Choose your iteration approach based on your use case:

1. **Row iteration**: Use for record-level processing and analysis
2. **Batch iteration**: Use for vectorized operations and ML framework integration
3. **Distributed iteration**: Use for parallel processing across multiple workers
4. **Shuffled iteration**: Use for ML training with randomized data access
