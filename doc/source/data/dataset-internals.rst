...
:meth:`ray.data.context.DatasetContext.get_current().scheduling_strategy <ray.data.context.DatasetContext.get_current>`. This scheduling strategy will schedule these tasks and actors outside any present
